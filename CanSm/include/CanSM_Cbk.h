...
# define CCL_ASR4SMCAN_CALLBACK_HEADER_VERSION                                        0x0212u   /* BCD coded version number */
 ...
 *  \reentrant   TRUE for different ID
 *  \synchronous FALSE
 *  \config      CANSM_TRANSCEIVERIDOFCHANNELCONFIG
 *  \pre         -
 *  \trace       SPEC-646
 **********************************************************************************************************************/
...
#if ( STD_ON == CANSM_PARTIAL_NETWORK_TRCV_SUPPORTOFCHANNELCONFIG )
...
#endif /* end   else if ( STD_ON == CANSM_PARTIAL_NETWORK_TRCV_SUPPORTOFCHANNELCONFIG ) */
