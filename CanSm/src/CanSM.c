...
#if ( ( 0x02u != CANSM_SW_MAJOR_VERSION ) || ( 0x12u != CANSM_SW_MINOR_VERSION ) || ( 0x00u != CANSM_SW_PATCH_VERSION ) )
...
#if ( CANSM_PRODERRORDETECTOFCHANNELCONFIG == STD_ON )
# if ( CANSM_ISDEF_PRODERRORDETECTOFCHANNELCONFIG == STD_ON )
  CanSM_Dem_ReportErrorEvent( CanSM_GetDemEventIdOfChannelConfig( CanSM_CanNetworkIdx ), DEM_EVENT_STATUS_PREFAILED );  /* PRQA S 3109 */ /* MD_MSR_14.3 */
# else /* CANSM_ISDEF_PRODERRORDETECTOFCHANNELCONFIG */
  if ( CanSM_IsProdErrorDetectOfChannelConfig( CanSM_CanNetworkIdx ) )
  {
    CanSM_Dem_ReportErrorEvent( CanSM_GetDemEventIdOfChannelConfig( CanSM_CanNetworkIdx ), DEM_EVENT_STATUS_PREFAILED );  /* PRQA S 3109 */ /* MD_MSR_14.3 */
  }
# endif /* CANSM_ISDEF_PRODERRORDETECTOFCHANNELCONFIG */
#endif /* ( CANSM_PRODERRORDETECTOFCHANNELCONFIG == STD_ON ) */
...
#if ( CANSM_PRODERRORDETECTOFCHANNELCONFIG == STD_ON )
# if ( CANSM_ISDEF_PRODERRORDETECTOFCHANNELCONFIG == STD_ON )
  CanSM_Dem_ReportErrorEvent( CanSM_GetDemEventIdOfChannelConfig( CanSM_CanNetworkIdx ), DEM_EVENT_STATUS_PASSED );  /* PRQA S 3109 */ /* MD_MSR_14.3 */
# else /* CANSM_ISDEF_PRODERRORDETECTOFCHANNELCONFIG */
  if ( CanSM_IsProdErrorDetectOfChannelConfig( CanSM_CanNetworkIdx ) )
  {
    CanSM_Dem_ReportErrorEvent( CanSM_GetDemEventIdOfChannelConfig( CanSM_CanNetworkIdx ), DEM_EVENT_STATUS_PASSED );  /* PRQA S 3109 */ /* MD_MSR_14.3 */
...
{ /* Context: CanSM_Init or Mainfunc, NW SM, SD RAM check */
  ...
  switch ( (*CanSM_CurrentChannelVarPtr).CanSM_RamCheckState )
  {
    ...
    case CANSM_DISABLE_COMMUNICATION_REPEAT: /* PRQA S 2003 */ /* MD_CANSM_15.2 */
    {
    ...
    default: /* PRQA S 2003 */ /* MD_CANSM_15.2 */ /* COV_CANSM_SWITCHDEFAULT */
    {
      /* illegal value */
      break;
    }
...
} /* end  Func CanSM_NetworkStatemachine */  /* PRQA S 6030 */  /* MD_MSR_STCYC */  /* PRQA S 6050 */ /* MD_MSR_STCYC   */
...
} /* end CanSM_StartWakeupSources */ /* PRQA S 2006 */ /* MD_MSR_14.7 */ /* PRQA S 6080 */ /* MD_MSR_STMIF   */
...
} /* end CanSM_StopWakeupSources */ /* PRQA S 2006 */ /* MD_MSR_14.7 */ /* PRQA S 6080 */ /* MD_MSR_STMIF   */
...
/* COV_JUSTIFICATION_BEGIN
   ...
   \ID COV_CANSM_SWITCHDEFAULT
   \ACCEPT XX
   \REASON The switch default is unused.
