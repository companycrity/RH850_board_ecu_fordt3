...
# ifndef SELNCASEST_FCENTR
#  define SELNCASEST_FCENTR (0U)
# endif

# ifndef SELNCASEST_VEHDYN
#  define SELNCASEST_VEHDYN (1U)
# endif

# ifndef SELNCASEST_WHLSPD
#  define SELNCASEST_WHLSPD (2U)
# endif

# ifndef SELNCASEST_STORDLSTPOSN
#  define SELNCASEST_STORDLSTPOSN (3U)
# endif

# ifndef SELNCASEST_CORRDPINIONAG
#  define SELNCASEST_CORRDPINIONAG (4U)
# endif
...
#   if RTE_MAGIC_NUMBER != 1490627847
#    error "The magic number of the generated file <C:/component/SF042A_HwAgSnsrls_Impl/tools/contract/Rte_HwAgSnsrls_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1490627847
