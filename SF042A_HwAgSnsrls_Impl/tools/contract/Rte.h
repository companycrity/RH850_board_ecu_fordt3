...
#    error "The magic number of the generated file <C:/component/SF042A_HwAgSnsrls_Impl/tools/contract/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
