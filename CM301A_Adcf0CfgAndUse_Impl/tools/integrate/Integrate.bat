...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CM301A_Adcf0CfgAndUse_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CM301A_Adcf0CfgAndUse_Impl
...
XCOPY ..\..\autosar\CDD_Adcf0CfgAndUse_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
