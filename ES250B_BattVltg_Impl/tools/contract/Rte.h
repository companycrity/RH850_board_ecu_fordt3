...
#    error "The magic number of the generated file <C:/Component/ES250B_BattVltg_Impl/tools/contract/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
