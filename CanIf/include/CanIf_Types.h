...
#define CANIF_TYPES_MINOR_VERSION             0x12u
...
typedef struct sCanIf_RxSearchParamsType
{
  ...
  CanIf_MsgType eRxMsgType;
    ...
    || ((CANIF_J1939_DYN_ADDR_SUPPORT != CANIF_J1939_DYN_ADDR_DISABLED) && (CANIF_EXTENDEDID_SUPPORT == STD_ON)) \
    || ((CANIF_WAKEUP_VALIDATION == STD_ON) && (CANIF_WAKEUP_VALID_ALL_RX_MSGS == STD_ON))) /* COV_CANIF_UNSUPPORTED_J1939_DYN_ADDR */
