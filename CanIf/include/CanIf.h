...
#define IF_ASRIFCAN_VERSION               0x0612u
#define IF_ASRIFCAN_RELEASE_VERSION       0x02u
 ...
 ***********************************************************************************************************/
/*! \brief         This API sets the CanIf to the state: uninitialized.
...
/************************************************************************************************************
 | NAME:  CanIf_Init
 ***********************************************************************************************************/
/*! \brief         This API initializes the CanIf module.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This API requests a mode transition of a CAN channel.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This API returns the current mode of a CAN channel.
 *  \details       -
 *  \param[in]     ControllerId      : Index of the CAN channel to which API call has to be applied.
...
/************************************************************************************************************
 | NAME:  CanIf_Transmit
 ***********************************************************************************************************/
/*! \brief         This API initiates transmission of a Tx-message.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This API sets PDU mode of a CAN channel.
 *  \details       -
 *  \param[in]     ControllerId : Index of the CAN channel to which API call has to be applied.
 ...
 ***********************************************************************************************************/
/*! \brief         This API returns the current PDU mode of a CAN channel.
 *  \details       -
 *  \param[in]     ControllerId : Index of the CAN channel to which API call has to be applied.
 ...
 ***********************************************************************************************************/
/*! \brief         This API returns version information: vendor ID, AUTOSAR module ID and SW version of the component.
 ...
 ***********************************************************************************************************/
/*! \brief         By this API the mode of a transceiver channel can be set.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This API returns the current transceiver mode of a transceiver channel.
 *  \details       -
 *  \param[in]     TransceiverId: Index of the transceiver channel to which API call has to be applied.
 ...
 ***********************************************************************************************************/
/*! \brief         This API returns the wake-up reason of a transceiver channel.
 *  \details       -
 *  \param[in]     TransceiverId: Index of the transceiver channel to which API call has to be applied.
 ...
 ***********************************************************************************************************/
/*! \brief         By this API the transceiver wake-up mode can be set.
 ...
 ***********************************************************************************************************/
/*! \brief         This service indicates a transceiver mode transition.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This API indicates that transceiver channel is running in PN communication mode.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This API indicates that the transceiver has cleared the wake-up events.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This API indicates that the transceiver channel has checked wake-up events.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This API requests a transceiver channel to clear the wake-up events.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This API requests a transceiver channel to check for wake-up events.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This service requests the underlying CAN / transceiver channels to check for wake-up events.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This service checks if a Rx-message was received since the last wake-up event.
 ...
 ***********************************************************************************************************/
/*! \brief         This service reconfigures the CAN identifier of the requested Tx-message.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This API initiates the cancellation of a Tx-message.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This API notifies a mode state transition of a CAN channel.
 *  \details       -
 ...
 ***********************************************************************************************************/
/*! \brief         This API reports if any Tx-confirmation has occurred for a CAN channel since it's last start.
 *  \details       -
 *  \param[in]     ControllerId: Index of the CAN channel to which API call has to be applied.
 ...
 ***********************************************************************************************************/
/*! \brief         This API checks if a CAN channel supports a certain baudrate.
 *  \details       -
 *  \param[in]     ControllerId: Index of the CAN channel to which API call has to be applied
 ...
 ***********************************************************************************************************/
/*! \brief         This API requests to change the baudrate of a CAN channel.
 ...
 ***********************************************************************************************************/
/*! \brief         This API requests to set the baudrate configuration a CAN channel.
 *  \details       -
 *  \param[in]     ControllerId: Index of the CAN channel to which API call has to be applied
 ...
 ***********************************************************************************************************/
/*! \brief         This API is called to set up the relation between internal and external address.
 ...
 ***********************************************************************************************************/
/*! \brief         The API resets one relation between internal and external address.
 *  \details       This API is used in a J1939 environment.
 *  \param[in]     ControllerId: Index of the CAN channel to which API call has to be applied
 *  \param[in]     intAddr: J1939 internal address
 *  \pre           -
 ...
 ***********************************************************************************************************/
/*! \brief         The API is called by CAN driver if RAM check detects a corrupt mailbox.
 ...
 ***********************************************************************************************************/
/*! \brief         The API is called by CAN driver if RAM check detects a corrupt CAN channel.
 ...
 ***********************************************************************************************************/
/*! \brief         API called by application to execute the RAM check.
 *  \details       -
 *  \param[in]     ControllerId: Index of the CAN channel to which API call has to be applied
 *  \pre           -
 *  \context       ANY
 ...
 ***********************************************************************************************************/
/*! \brief         API called by application to reactivate a mailbox after it was deactivated by RAM check.
 *  \details       -
 *  \param[in]     ControllerId: Index of the CAN channel to which API call has to be applied
 *  \param[in]     HwHandle: Index of the hardware object to which the API call has to be applied
 *  \pre           -
 ...
 ***********************************************************************************************************/
/*! \brief         API called by application to reactivate a controller after it was deactivated by RAM check.
 *  \details       -
 *  \param[in]     ControllerId: Index of the CAN channel to which API call has to be applied
 *  \pre           -
 *  \context       ANY
 ...
 ***********************************************************************************************************/
/*! \brief         API called by CanIf before transmission of a data checksum Tx-PDU in order to add a checksum 
 *                 to data of it.
 ...
 ***********************************************************************************************************/
/*! \brief         API called by CanIf in case of a data checksum PDU was received in order to verify the correctness
 *                 of it.
 ...
 ***********************************************************************************************************/
/*! \brief         Via this API the reception mode of a Rx-PDU can be set.
