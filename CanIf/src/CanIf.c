...
#if (CANIF_TYPES_MINOR_VERSION != 0x12u)
# error "Source and Header files are inconsistent!"
#endif
...
#if (CANIF_API_MINOR_VERSION != 0x12u)
# error "Source and Header files are inconsistent!"
#endif

#if (CANIF_API_PATCH_VERSION != 0x02u)
# error "Source and Header files are inconsistent!"
#endif
...
#define CANIF_GENDATA_COMPATIBILITY_VERSION     0x0210u
...
#define CANIF_CFG_CTRLJ1939DYNADDRSUPPORT(index)           CanIf_GetCtrlJ1939DynAddrSupport(index)
...
#define CANIF_CFG_CTRLID2J1939DYNADDROFFSET(index)         CanIf_GetCtrlId2J1939DynAddrOffset(index)
...
#define CANIF_CFG_RX_MASK(index)                           CanIf_GetRxPduMask(index)
#define CANIF_CFG_RX_CANID(index)                          CanIf_GetRxPduCanId(index)
...
#define CANIF_CFG_RXPDUID2INTRXPDUID(index)                CanIf_GetRxPduConfigIdxOfUlRxPduId2InternalRxPduId(index)
...
#define CANIF_CFG_RXDHRANDOMNUMBER1(index)                 CanIf_GetRxDHRandomNumber1(index)
#define CANIF_CFG_RXDHRANDOMNUMBER2(index)                 CanIf_GetRxDHRandomNumber2(index)
...
#define CANIF_CFG_ISFEATUREPNWUTXPDUFILTERENABLED(index)   CanIf_IsFeaturePnWuTxPduFilterEnabled(index)
 ...
 **********************************************************************************************************************/
/*! \brief       This API checks if queued PDUs have to be transmitted.
 *  \details     Called out of CanIf_TxConfirmation(), CanIf_CancelTxConfirmation(), CanIf_CancelTxNotification().
 *  \param[in]   hth: Index of the hardware transmit handle to which API call has to be applied.
 ...
 **********************************************************************************************************************/
/*! \brief       This API transmits a Tx-PDU and removes it from the Tx-queue.
 *  \details     Called out of CanIf_TxQueueTreatment().
 *  \param[in]   PduId: Internal ID of basic CAN Tx-PDU which shall be transmitted.
 ...
 **********************************************************************************************************************/
/*! \brief       This API initializes and resets the Tx-queue.
 ...
 *  \param[in]   CANIF_CHANNEL_CANTYPE_ONLY: Index of the selected CAN channel to which API call has to be applied.
 ...
 **********************************************************************************************************************/
/*! \brief       This API sets the flag "is buffered".
 ...
 *  \param[in]   PduId: TxPduId for which the "is buffered" flag is set.
 ...
 **********************************************************************************************************************/
/*! \brief       This API resets the flag "is buffered".
 ...
 *  \param[in]   PduId: TxPduId for which the "is buffered" flag is reset.
 *  \return      E_OK: PduId was not already buffered.
 *               E_NOT_OK: PduId was already buffered.
 *  \pre         Check if a PrioByCanId transmit buffer is assigned to the TxPdu.
 *  \context     ANY
 ...
 **********************************************************************************************************************/
/*! \brief       This API checks if the FIFO corresponding to the Tx PDU ID is empty.
 ...
 **********************************************************************************************************************/
/*! \brief       This API reports a received message to upper layer.
 ...
 *               PduId:  internal ID of found PDU
 *               CanSduPtr: pointer to Rx-data
 *               CanDlc: length of Rx-data
 *               CanId: CAN identifier (only if configuration 2.)
 *  \pre         -
 *  \context     ANY
 *  \reentrant   FALSE
 *  \synchronous TRUE
 ...
 **********************************************************************************************************************/
/*! \brief       This API reports the confirmation for a successful transmission.
 *  \details     Called out of CanIf_TxConfirmation(), CanIf_Transmit().
 *  \param[in]   CanTxPduId: Internal ID of successful transmitted PDU, callee must secure that the parameter is in range.
 *  \pre         -
 *  \context     ANY
 ...
 **********************************************************************************************************************/
/*! \brief       This API verifies whether the requested Tx-PDU may be transmitted or NOT.
 *  \details     While the PN filter is active only dedicated Tx PDUs are transmitted. Called out of CanIf_Transmit().
 *  \param[in]   PduInfoPtr: Includes the payload incl. the meta data.
 *               localPduPtr: Pointer to Tx-PDU data (length, CAN identifier, handle ID) to be transmitted.
 ...
 **********************************************************************************************************************/
/*! \brief       This API extracts for a meta data Tx-PDU the meta data from passed payload and adapts the CAN identifier accordingly.
 *  \details     Called out of CanIf_Transmit().
 *  \param[in]   PduInfoPtr: Includes the payload incl. the meta data.
 *               localPduPtr: Pointer to Tx-PDU data (length, CAN identifier, handle ID) to be transmitted.
 ...
 **********************************************************************************************************************/
/*! \brief       This API modifies the CAN identifier according to J1939 specification.
 *  \details     Called out of CanIf_Transmit().
 *  \param[in]   CANIF_CHANNEL_CANTYPE_FIRST: CAN channel
 *               localPduPtr: Pointer to PDU data.
 ...
 **********************************************************************************************************************/
/*! \brief       This API handles the Tx-queue.
 *  \details     Called out of CanIf_Transmit().
 *  \param[in]   CANIF_CHANNEL_CANTYPE_FIRST: CAN channel
 *               localPduPtr: Pointer to PDU data.
 *               basicCanPduId: The BasicCAN handle ID of corresponding Tx-PDU in order to determine whether the Tx-PDU is a BasicCAN or FullCAN one.
 ...
 *  \param[in]   CanId: Pointer to CAN identifier of received message.
 *  \return      E_OK: Modification of CAN identifier succeeded.
 *               E_NOT_OK: Modification of CAN identifier failed. In this case the processing of PDU must be cancelled.
 *  \pre         -
 *  \context     ANY
 ...
 **********************************************************************************************************************/
/*! \brief       This API searches for a matched Rx-message according to binary search algorithm.
 *  \details     Called out of CanIf_RxIndication().
 ...
 **********************************************************************************************************************/
/*! \brief       This API checks the message type for a matched Rx-message according to binary search algorithm.
 ...
 **********************************************************************************************************************/
/*! \brief       This API searches for a matched Rx-message according to double-hash search algorithm.
 *  \details     Called out of CanIf_RxIndication().
 *  \param[in]   rxSearchParams: Parameters needed for search.
 *  \pre         -
 *  \context     ANY
 ...
 **********************************************************************************************************************/
/*! \brief       This API searches for a matched Rx-message according to linear search algorithm.
 *  \details     Called out of CanIf_RxIndication().
 *  \param[in]   rxSearchParams: Parameters needed for search.
 *  \pre         -
 *  \context     ANY
 ...
 **********************************************************************************************************************/
/*! \brief       This API checks if FD format and PDU reception mode match.
 ...
 **********************************************************************************************************************/
/*! \brief       This API searches for a matched Rx-range.
 ...
 **********************************************************************************************************************/
/*! \brief       This API handles the wake-up validation state.
 *  \details     Called out of CanIf_RxIndication().
...
# if ((CANIF_MULTIPLE_CANDRV_SUPPORT == STD_ON) && (CANIF_POSTBUILD_VARIANT_SUPPORT == STD_ON))
    ...
    else if (!CANIF_CFG_IS_CANDRVINDEXVALID(CanIf_Controller_Value)) /* COV_CANIF_EXCELLIST */
    {
      errorId = CANIF_E_PARAM_CONTROLLERID;
    }
# endif
...
#endif
      {
        ...
        switch (ControllerMode)
        {
          case CANIF_CS_STOPPED:
            ...
            /* \trace SPEC-3763 */
            if (CanIf_GetCtrlMode(CanIf_Controller_Value) == CANIF_CS_SLEEP)
            {
              ...
              if (canSetCtrlModeFct(CANIF_CFG_CTRLUPTOLOWMAP_CHANNELINDEX(CanIf_Controller_Value), CAN_T_WAKEUP) == CAN_OK) /* SBSW_CANIF_41 */ /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
              {
                  retval = E_OK;
              }
            }
            /* \trace SPEC-5124 */
            else if (CanIf_GetCtrlMode(CanIf_Controller_Value) == CANIF_CS_STARTED)
            {
              /* \trace SPEC-1845, SPEC-1996 */
              /* #220 Request CAN driver to STOP if currently in START mode */
              if (canSetCtrlModeFct(CANIF_CFG_CTRLUPTOLOWMAP_CHANNELINDEX(CanIf_Controller_Value), CAN_T_STOP) == CAN_OK) /* SBSW_CANIF_41 */ /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
              {
                /* \trace SPEC-3764 */
            ...
            /* \trace SPEC-3753 */
            else if (CanIf_GetCtrlMode(CanIf_Controller_Value) == CANIF_CS_STOPPED)
            {
              /* \trace SPEC-1845, SPEC-1996 */
          ...
          case CANIF_CS_STARTED:
            ...
            /* \trace SPEC-3757 */
            if (CanIf_GetCtrlMode(CanIf_Controller_Value) == CANIF_CS_STOPPED)
            {
              /* \trace SPEC-1845, SPEC-1996 */
              /* #320 Request CAN driver to START if currently in STOP mode */
              if (canSetCtrlModeFct(CANIF_CFG_CTRLUPTOLOWMAP_CHANNELINDEX(CanIf_Controller_Value), CAN_T_START) == CAN_OK) /* SBSW_CANIF_41 */ /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
              {
                retval = E_OK;
              }
            }
            ...
            {
              /* \trace SPEC-1845, SPEC-1996 */
              /* #330 Request CAN driver to START if currently in START mode */
              if (canSetCtrlModeFct(CANIF_CFG_CTRLUPTOLOWMAP_CHANNELINDEX(CanIf_Controller_Value), CAN_T_START) == CAN_OK) /* SBSW_CANIF_41 */ /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
              {
                retval = E_OK;
              }
          ...
          case CANIF_CS_SLEEP:
            ...
            if (CanIf_GetCtrlMode(CanIf_Controller_Value) == CANIF_CS_STOPPED)
            {
              ...
              if (canSetCtrlModeFct(CANIF_CFG_CTRLUPTOLOWMAP_CHANNELINDEX(CanIf_Controller_Value), CAN_T_SLEEP) == CAN_OK) /* SBSW_CANIF_41 */ /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
              {
#if (CANIF_WAKEUP_VALIDATION == STD_ON)
            ...
            /* \trace SPEC-3762 */
            else if (CanIf_GetCtrlMode(CanIf_Controller_Value) == CANIF_CS_SLEEP)
            {
              /* \trace SPEC-1845, SPEC-1996 */
              /* #430 Request CAN driver to SLEEP if currently in SLEEP mode */
              if (canSetCtrlModeFct(CANIF_CFG_CTRLUPTOLOWMAP_CHANNELINDEX(CanIf_Controller_Value), CAN_T_SLEEP) == CAN_OK)  /* SBSW_CANIF_41 */ /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
              {
                retval = E_OK;
              }
...
#  endif
          {
            ...
            /* store the DLC (length of the CAN-message) */
            CANIF_VAR_TXBUFFERPRIOBYCANID_QUEUE(CANIF_CFG_TX_QUEUEINDEX(localPduPtr->swPduHandle), eQueueParams.eBaseParams.eSduLength) = localPduPtr->length;  /* SBSW_CANIF_6 */
...
#  if((CANIF_SETDYNAMICTXID_API == STD_ON) || (CANIF_J1939_DYN_ADDR_SUPPORT != CANIF_J1939_DYN_ADDR_DISABLED) || (CANIF_META_DATA_TX_SUPPORT == STD_ON)) /* COV_CANIF_UNSUPPORTED_J1939_DYN_ADDR */
            /* store the CAN ID */
            CANIF_VAR_TXBUFFERPRIOBYCANID_QUEUE(CANIF_CFG_TX_QUEUEINDEX(localPduPtr->swPduHandle), eQueueParams.eBaseParams.eCanId) = localPduPtr->id; /* SBSW_CANIF_6 */
#  endif
#  if (CANIF_USES_VSTDLIB_COPY == STD_ON)
#   if(CANIF_STATIC_FD_TXQUEUE == STD_ON)
            VStdMemCpyRamToRam(CANIF_ADDR_VAR_TXBUFFERPRIOBYCANID_STATFDQUEUE_QUEUEDATA(CANIF_CFG_TXBUFFERPRIOBYCANID_STATFDQUEUE_DATASTARTIDX(localPduPtr->swPduHandle)), localPduPtr->sdu, localPduPtr->length); /* SBSW_CANIF_18 */
#   else
            VStdMemCpyRamToRam(CANIF_VAR_TXBUFFERPRIOBYCANID_QUEUE(CANIF_CFG_TX_QUEUEINDEX(localPduPtr->swPduHandle), eQueueParams.eSdu), localPduPtr->sdu, localPduPtr->length); /* SBSW_CANIF_7 */
#   endif
#  else
            /* store PDU (CAN-data) in the queue */
            for (i = 0u; i < localPduPtr->length; i++)
            {
#   if(CANIF_STATIC_FD_TXQUEUE == STD_ON)
              CanIf_SetTxQueueData((CANIF_CFG_TXBUFFERPRIOBYCANID_STATFDQUEUE_DATASTARTIDX(localPduPtr->swPduHandle))+i, localPduPtr->sdu[i]);    /* SBSW_CANIF_40 */
#   else
              CANIF_VAR_TXBUFFERPRIOBYCANID_QUEUE(CANIF_CFG_TX_QUEUEINDEX(localPduPtr->swPduHandle), eQueueParams.eSdu[i]) = localPduPtr->sdu[i]; /* SBSW_CANIF_6 */
#   endif
            }
#  endif
...
#  if (CANIF_POSTBUILD_VARIANT_SUPPORT == STD_ON) 
        ...
        if (!CANIF_CFG_IS_CANDRVINDEXVALID(CanIf_Controller_Value_Local)) /* COV_CANIF_EXCELLIST */
        {
          errorId = CANIF_E_PARAM_CONTROLLERID;
        }
        else
        ...
        CanIf_TransmitStateType pnTxState;
...
#endif
          {
            ...
            if (CanIf_GetCtrlMode(CanIf_Controller_Value_Local) == CANIF_CS_STARTED)
            {
              ...
              {
                Can_ReturnType txResult = CAN_BUSY; /* PRQA S 3197 */ /* MD_MSR_14.2 */
                /* \trace SPEC-1227 */
...
# endif
#endif
                {
...
#if (CANIF_TRANSMIT_BUFFER_FIFO == STD_ON)
                  {
                    ...
                    if( CANIF_CFG_MAILBOX_TXBUFFERHANDLINGTYPE(CANIF_CFG_TX_HTH(CanTxPduId)) == CANIF_TXBUFFER_HANDLINGTYPE_FIFO)
                    {
                      /* #200 Only if the queue is empty, the PDU can be written directly, otherwise it must be buffered */
                      doCanWrite = CanIf_TransmitSubCheckFiFoQueueEmpty(CanTxPduId);
                    }
                    if (doCanWrite == TRUE)
#endif  
                    {
                      /* #210 Pass the request to the CAN driver */
#if (CANIF_MULTIPLE_CANDRV_SUPPORT == STD_ON)
                      {
                        CanIf_Can_WriteFctType canWriteFct;
                        Can_HwHandleType canDrvHth;
                      
                        canWriteFct = CanIf_GetCan_WriteFctMap(CANIF_CFG_CTRLUPTOLOWMAP_DRIVERINDEX(CanIf_Controller_Value_Local));
                        canDrvHth = (Can_HwHandleType)(CANIF_CFG_TX_HTH(CanTxPduId) - CANIF_CFG_MULTIPLECANDRV_HXHOFFSET(CANIF_CFG_CTRLUPTOLOWMAP_DRIVERINDEX(CanIf_Controller_Value_Local)));
                      
                        txResult = canWriteFct(canDrvHth, (P2CONST(Can_PduType, AUTOMATIC, CANIF_VAR_STACK))&localPdu); /* SBSW_CANIF_43 */
                      }
#else
                      txResult = Can_Write((CanIf_HwHandleType)CANIF_CFG_TX_HTH(CanTxPduId), (P2CONST(Can_PduType, AUTOMATIC, CANIF_VAR_STACK))&localPdu); /* SBSW_CANIF_5 */
#endif
                    }
                    if ((txResult == CAN_BUSY)   /* COV_CANIF_EXCELLIST */
#if (CANIF_TRANSMIT_BUFFER_FIFO == STD_ON)
                        || (doCanWrite == FALSE) /* COV_CANIF_EXCELLIST */
#endif              
                      )
                    {
#if ((CANIF_TRANSMIT_BUFFER_PRIO_BY_CANID == STD_ON) || (CANIF_TRANSMIT_BUFFER_FIFO == STD_ON))
                      /* #300 PrioByCanId queue: If CAN driver is busy ### FIFO queue: If queue is not empty -> queue the data */
                      /* \trace SPEC-3668 */
                      retval = CanIf_TransmitSubHandleTxResBusy(&localPdu); /* SBSW_CANIF_5 */
#else
                    ...
                    else
                    {
                      ...
                      /* call of can_write() was successful */
                      ...
                      if( CANIF_CFG_MAILBOX_TXBUFFERHANDLINGTYPE(CANIF_CFG_TX_HTH(CanTxPduId)) == CANIF_TXBUFFER_HANDLINGTYPE_PRIOBYCANID) /* COV_CANIF_NO_TX_BUFFER */
                      {
                      ...
                      (CanIf_GetChannelMode(CanIf_Controller_Value_Local) == CANIF_GET_OFFLINE_ACTIVE_RX_ONLINE))
              {
                retval = E_OK;
                /* \trace SPEC-5215 */
                /* #600 If current mode is Tx-passive call the Tx-confirmation */
            ...
            /* \trace SPEC-5339 */
            else if (CanIf_GetCtrlMode(CanIf_Controller_Value_Local) == CANIF_CS_STOPPED) /* COV_CANIF_EXCELLIST */
            {
...
#  if (CANIF_POSTBUILD_VARIANT_SUPPORT == STD_ON) 
    /* #40 Check if corresponding CanDrv is available in current identity */
    else if (!CANIF_CFG_IS_CANDRVINDEXVALID(CANIF_CFG_TX_CONTROLLER(CanTxPduId))) /* COV_CANIF_EXCELLIST */
    {
      errorId = CANIF_E_PARAM_CONTROLLERID;
    }
#  endif  
...
# if (CANIF_RX_SEARCH_CONSIDER_MSG_TYPE == STD_ON)
      if ((CANIF_CFG_RX_MSGTYPE(rxSearchParams->eRxPduId) == CANIF_MSG_TYPE_CAN) || (CANIF_CFG_RX_MSGTYPE(rxSearchParams->eRxPduId) == rxSearchParams->eRxMsgType)) /* COV_CANIF_EXCELLIST */
# endif
      {
...
# if (CANIF_RX_SEARCH_CONSIDER_MSG_TYPE == STD_ON)
      else
      {
        ...
        if(rxSearchParams->eRxPduId > CANIF_CFG_MAILBOX_PDUIDFIRST(rxSearchParams->eHrh)) /* COV_CANIF_EXCELLIST */
        {
          ...
          if ((CANIF_CFG_RX_CANID(rxSearchParams->eRxPduId) & (~CANIF_FDFLAG)) == rxSearchParams->eCanId) /* Fix of ESCAN00092931 */ /* COV_CANIF_EXCELLIST */
          {
...
CANIF_LOCAL_INLINE FUNC(CanIf_NotifStatusType, CANIF_CODE) CanIf_RxIndicationSubReceptionPduMode(P2VAR(CanIf_RxSearchParamsType, AUTOMATIC, AUTOMATIC) rxSearchParams)
{
...
#endif
  {
    ...
    if (CANIF_CFG_RX_ISRECEPTIONMODEPDU(rxSearchParams->eRxPduId)) /* COV_CANIF_EXCELLIST */
    {
      if (CANIF_VAR_GET_PDU_RECEPTION_MODE(CANIF_CFG_RX_PDURECEPTIONMODEIDX(rxSearchParams->eRxPduId)) == CANIF_RMT_RECEIVE_STOP) /* COV_CANIF_EXCELLIST */
#endif
      {
...
#if (CANIF_RX_SEARCH_CONSIDER_MSG_TYPE == STD_ON)
    if ((CanId & CANIF_FDFLAG) == CANIF_FDFLAG) /* COV_CANIF_EXCELLIST */
    {
...
# endif
    ...
    else if (Hrh >= CANIF_CFG_MAX_MAILBOXES) /* COV_CANIF_EXCELLIST */
    {
      /* \trace SPEC-3697 */
...
#endif      
#if ((CANIF_SEARCH_ALGORITHM == CANIF_BINARY) \
    || (CANIF_SEARCH_ALGORITHM == CANIF_DOUBLE_HASH) \
    || (CANIF_WAKEUP_VALID_ALL_RX_MSGS == STD_ON))
...
#endif
      {
        ...
        if (CANIF_CFG_MAX_RXPDUS != 0u)  /* COV_CANIF_CONFLICTS_TESTENVIROMENT_FAILURE */
        {
          ...
          if (rxSearchParams.eRxPduId != CanIf_RxPduHnd_INVALID) /* PRQA S 3355, 3358 */ /* MD_CanIf_13.7 */ /* COV_CANIF_GENDATA_FAILURE */
          {
            ...
            if (CANIF_RxFullCANMailbox == CANIF_CFG_MAILBOX_MAILBOXTYPE(Hrh)) /* COV_CANIF_FULLCAN */
            {
            ...
            /* #360 If BasicCAN search for matching using: linear, binary or double hash algorithm (dependent on configuration) */
            {
              ...
              if((CANIF_CFG_RX_MASK(rxSearchParams.eRxPduId) & CANIF_RANGE_FLAG) != CANIF_RANGE_FLAG) /* not only ranges configured */ /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
              {
#if (CANIF_SEARCH_ALGORITHM == CANIF_BINARY)
...
#endif /* CANIF_SEARCH_ALGORITHM == CANIF_LINEAR */
#if (CANIF_SET_PDU_RECEPTION_MODE_SUPPORT == STD_ON)
                /* #370 search had a match */
                if(rxSearchParams.eRxPduIdMatch != CanIf_RxPduHnd_INVALID)
                {
                  /* #380 Check the PDU reception mode */
                  if (CANIF_CFG_RX_ISRECEPTIONMODEPDU(rxSearchParams.eRxPduIdMatch))
                  {
                    /* #390 If Pdu reception mode for matched PDU is CANIF_RMT_IGNORE_CONTINUE, match will be discarded */
                    ...
                    {
                      rxSearchParams.eRxPduIdMatch = CanIf_RxPduHnd_INVALID;
                      /* #400 If ranges are defined at all, range search will continue */
                      if((CANIF_CFG_RX_MASK(CANIF_CFG_MAILBOX_PDUIDFIRST(Hrh)) & CANIF_STOP_FLAG) == 0u) /* COV_CANIF_EXCELLIST */
                      {
                        rxSearchParams.eContinueSearch = TRUE;
                      }
                    }
                ...
                /* for doubleHash/binary search the RxPduId is still set on CANIF_CFG_MAILBOX(Hrh, ePduIdLast) */
                /* RxPduId needs to be set on CANIF_CFG_MAILBOX_PDUIDFIRST(Hrh) - 1 if Ranges are available */
                rxSearchParams.eRxPduId = CANIF_CFG_MAILBOX_PDUIDFIRST(Hrh);
                if((CANIF_CFG_RX_MASK(rxSearchParams.eRxPduId) & CANIF_STOP_FLAG) == 0u) /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
                {
                ...
                {
                  rxSearchParams.eContinueSearch = FALSE; /* no ranges defined */
                }
#endif /* CANIF_SEARCH_ALGORITHM != CANIF_LINEAR */
              } /* ESCAN00079651 */

              /* #410 Search for Rx-ranges separately */
            ...
            if (rxSearchParams.eRxPduIdMatch != CanIf_RxPduHnd_INVALID) /* COV_CANIF_NOT_APPLICABLE_FOR_EACH_CONFIG */
            {
              ...
              if (CANIF_CFG_RX_ISDATACHECKSUMPDU(rxSearchParams.eRxPduIdMatch))
              {
                ...
                localRetVal = CanIf_RxIndicationSubDataChecksumRxVerify(rxSearchParams.eRxPduIdMatch, CanId, CanDlc, CanSduPtr); /* SBSW_CANIF_5 */
              }
              else
              {
...
#if ((CANIF_DLC_CHECK == STD_OFF) && (CANIF_META_DATA_RX_SUPPORT == STD_OFF))
  CANIF_DUMMY_STATEMENT(CanDlc); /* PRQA S 3112, 3199 */ /* MD_MSR_14.2 */ /* lint -e{438} */
#endif
...
# endif
         )
      {
...
#endif
        {
          ...
          uint8_least i;
          uint8_least j;
          if ((CANIF_CFG_RX_RXMETADATALENGTH(PduId) > 0) && (CanDlc + CANIF_CFG_RX_RXMETADATALENGTH(PduId) > CANIF_CFG_MAXRXDLC_PLUS_MAXMETADATA)) /* COV_CANIF_EXCELLIST */
          {
...
# endif
# if (CANIF_J1939_DYN_ADDR_SUPPORT != CANIF_J1939_DYN_ADDR_DISABLED) /* COV_CANIF_UNSUPPORTED_J1939_DYN_ADDR */
#  if (CANIF_EXTENDEDID_SUPPORT == STD_ON)  /* COV_CANIF_EXCELLIST */
...
# endif
...
#endif
            {
              ...
              if (CANIF_CFG_RXINDICATION_FUNCTIONLAYOUT(index) == CanIf_SimpleRxIndicationLayout) /* COV_CANIF_GENDATA_FAILURE */
              {
                ...
                if (rxIndicationFct != NULL_PTR) /* COV_CANIF_CONFLICTS_TESTENVIROMENT_FAILURE */
                {
                  /* \trace SPEC-1885 */
              ...
              if (CANIF_CFG_RXINDICATION_FUNCTIONLAYOUT(index) == CanIf_NmOsekRxIndicationLayout) /* COV_CANIF_GENDATA_FAILURE */
              {
...
#endif
              if (CANIF_CFG_RXINDICATION_FUNCTIONLAYOUT(index) == CanIf_AdvancedRxIndicationLayout)  /* PRQA S 2004 */ /* MD_CanIf_14.4 */ /* COV_CANIF_GENDATA_FAILURE */
              {
              ...
              /* Considered and NO ELSE required. See MD_CanIf_14.4 */
            }
#if (CANIF_META_DATA_RX_SUPPORT == STD_ON)
          }  
#endif
...
#     if ((CANIF_MULTIPLE_CANDRV_SUPPORT == STD_ON) && (CANIF_POSTBUILD_VARIANT_SUPPORT == STD_ON))
    /* #50 Check if corresponding CanDrv is available in current identity */
    else if (!CANIF_CFG_IS_CANDRVINDEXVALID(CANIF_CFG_TX_CONTROLLER(PduInfoPtr->swPduHandle))) /* COV_CANIF_EXCELLIST */
    {
      errorId = CANIF_E_PARAM_CONTROLLERID;
    }
#     endif
...
#    endif
        {
          ...
          {
            /* #130 Tx-PDU is NOT buffered, store the cancelled one */
#    if((CANIF_SETDYNAMICTXID_API == STD_ON) || (CANIF_J1939_DYN_ADDR_SUPPORT != CANIF_J1939_DYN_ADDR_DISABLED) || (CANIF_META_DATA_TX_SUPPORT == STD_ON)) /* COV_CANIF_UNSUPPORTED_J1939_DYN_ADDR */
...
#    if (CANIF_USES_VSTDLIB_COPY == STD_ON)  /* COV_CANIF_VSTD_RAMMEMCPY_ALWAYSTRUE */
#     if (CANIF_STATIC_FD_TXQUEUE == STD_ON)
...
#    else
            {
              PduLengthType len;
              for (len = 0; len < PduInfoPtr->length; len++) /* COV_CANIF_VSTD_RAMMEMCPY_ALWAYSTRUE */
              {
#     if (CANIF_STATIC_FD_TXQUEUE == STD_ON)
...
#    endif /* (CANIF_USES_VSTDLIB_COPY == STD_ON) */
          ...
          {
            /* #140 Newer Tx-PDU is already buffered, discard the cancelled one */
          }
          CanIf_LeaveCritical(CANIF_EXCLUSIVE_AREA_1);  /* PRQA S 3109 */ /* MD_CanIf_14.03 */
        }
...
#    endif
        /* #150 Trigger the transmission of the queue */
        CanIf_EnterCritical(CANIF_EXCLUSIVE_AREA_2); /* PRQA S 3109 */ /* MD_CanIf_14.03 */
...
# if (CANIF_MULTIPLE_CANDRV_SUPPORT == STD_ON)
              ...
              if (canCancelTxFct != NULL_PTR) /* COV_CANIF_EXCELLIST */
# endif
              {
# if ((CANIF_TRANSMIT_BUFFER_PRIO_BY_CANID == STD_ON) || (CANIF_TRANSMIT_BUFFER_FIFO == STD_ON))
...
#   if (CANIF_POSTBUILD_VARIANT_SUPPORT == STD_ON) 
    /* #40 Check if corresponding CanDrv is available in current identity */
    else if (!CANIF_CFG_IS_CANDRVINDEXVALID(CANIF_CFG_TX_CONTROLLER(PduId))) /* COV_CANIF_EXCELLIST */
    {
      errorId = CANIF_E_PARAM_CONTROLLERID;
    }
#   endif 
...
# if (CANIF_PN_WU_TX_PDU_FILTER == STD_ON)
           ...
           || (CanIf_GetChannelMode(CANIF_CFG_TX_CONTROLLER(PduId)) == CANIF_GET_TX_ONLINE_WAKF) /* COV_CANIF_EXCELLIST */
# endif
         )
        {
#if ((CANIF_TRANSMIT_BUFFER_PRIO_BY_CANID == STD_ON) || (CANIF_TRANSMIT_BUFFER_FIFO == STD_ON))
...
# if (CANIF_TRCV_MAPPING == STD_ON)
        ...
        if (lowFct != NULL_PTR) /* COV_CANIF_EXCELLIST */
        {
          /* \trace SPEC-1967 */
...
#  endif /* CANIF_ONE_CONTROLLER_OPTIMIZATION == STD_OFF */
      ...
      if (CanIf_GetCtrlMode(CanIf_Controller_Value_Local) == CANIF_CS_UNINIT) /* COV_CANIF_EXCELLIST */
      {
        errorId = CANIF_E_UNINIT;
      }
      else
...
# if (CANIF_TRCV_MAPPING == STD_ON)
        ...
        if (lowFct != (CanIf_CanTrcv_ClearTrcvWufFlagFctType)NULL_PTR) /* COV_CANIF_EXCELLIST */
        {
          /* #110 Pass the request to the transceiver driver */
...
# if (CANIF_TRCV_MAPPING == STD_ON)
        ...
        if (lowFct != (CanIf_CanTrcv_CheckWakeFlagFctType)NULL_PTR)  /* COV_CANIF_EXCELLIST */
        {
          /* #110 Pass the request to the transceiver driver */
          localRetVal = lowFct(TrcvChannelId);  /* SBSW_CANIF_22 */
        }
...
# endif /* CANIF_DEV_ERROR_DETECT == STD_ON */
        {
          ...
          if ((WakeupSource & wuSrc) != 0) /* COV_CANIF_EXCELLIST */
          {
            /* \trace SPEC-5284 */
            /* #170 Process only if CAN channel is either in SLEEP or in STOP */
            if ((CanIf_GetCtrlMode(CanIf_WU_Controller_Value_Local) == CANIF_CS_SLEEP) || (CanIf_GetCtrlMode(CanIf_WU_Controller_Value_Local) == CANIF_CS_STOPPED)) /* COV_CANIF_EXCELLIST */
            {
...
#   if(CANIF_POSTBUILD_VARIANT_SUPPORT == STD_ON)
                ...
                if (!CANIF_CFG_IS_CANDRVINDEXVALID(wuTrgtaddress)) /* COV_CANIF_EXCELLIST */
                {
                  errorId = CANIF_E_PARAM_WAKEUPSOURCE;
                  retval = E_NOT_OK;
                }
...
#  endif
                {
                  ...
                  if (canCheckWakeupFct != NULL_PTR) /* COV_CANIF_EXCELLIST */
                  {
...
# endif /* CANIF_TRCV_HANDLING == STD_ON */
              ...
              if (localRetval == E_OK) /* COV_CANIF_EXCELLIST */
              {
...
# if (CANIF_MULTIPLE_CANDRV_SUPPORT == STD_ON)
      ...
      if (canCheckBaudrateFct != NULL_PTR) /* COV_CANIF_EXCELLIST */
      {
...
# if (CANIF_MULTIPLE_CANDRV_SUPPORT == STD_ON)
      ...
      if (canChangeBaudrateFct != NULL_PTR) /* COV_CANIF_EXCELLIST */
      {
...
# if (CANIF_MULTIPLE_CANDRV_SUPPORT == STD_ON)
      ...
      if (canSetBaudrateFct != NULL_PTR) /* COV_CANIF_EXCELLIST */
      {
...
# if (CANIF_MULTIPLE_CANDRV_SUPPORT == STD_ON)
      ...
      if (can_RamCheckExecuteFct != NULL_PTR) /* COV_CANIF_EXCELLIST */
      {
...
# if (CANIF_MULTIPLE_CANDRV_SUPPORT == STD_ON)
      ...
      if (can_RamCheckEnableMailboxFct != NULL_PTR) /* COV_CANIF_EXCELLIST */
      {
...
# if (CANIF_MULTIPLE_CANDRV_SUPPORT == STD_ON)
      ...
      if (can_RamCheckEnableControllerFct != NULL_PTR) /* COV_CANIF_EXCELLIST */
      {
...
# if ((CANIF_CONFIG_VARIANT == CANIF_CFGVAR_POSTBUILDTIME) || (CANIF_POSTBUILD_VARIANT_SUPPORT == STD_ON))
      ...
      CanIfRxPduId = CANIF_CFG_RXPDUID2INTRXPDUID(id);
# else
      CanIfRxPduId = id;
# endif
# if (CANIF_DEV_ERROR_DETECT == STD_ON)
      /* #30 Check if parameter CanIfRxPduId is valid */
      if (CanIfRxPduId >= CANIF_CFG_MAX_RXPDUS) /* COV_CANIF_EXCELLIST */
      {
        /* \trace SPEC-2007 */
        errorId = CANIF_E_INVALID_RXPDUID;
      }
      /* #40 Check if parameter mode is valid */
      else if ((mode != CANIF_RMT_RECEIVE_STOP) && (mode != CANIF_RMT_IGNORE_CONTINUE)) /* PRQA S 3356, 3359 */ /* MD_CanIf_13.7 */ /* COV_CANIF_EXCELLIST */
      { /* PRQA S 3201 */ /* MD_CanIf_14.1 */
...
\COUNTERMEASURE \S For the generated function list CanIf_TxConfirmationFctList, it must be secured that a valid function callout is provided with valid signature
...
\COUNTERMEASURE \S For the generated function list CanIf_RxIndicationFctList, it must be secured that a valid function callout is provided with the vailid signature.
                   The assurance to get a valid function pointer is a qualified use-case CSL03 of ComStackLib
...
\COUNTERMEASURE \S  For the generated functions CanIf_BusOffNotificationFctPtr, CanIf_CtrlModeIndicationFctPtr, CanIf_TrcvModeIndicationFctPtr, CanIf_ConfirmPnAvailabilityFctPtr,
                    ...
                    CanIf_RamCheckCorruptMailboxIndFctPtr it must be secured that a valid function callout is provided with the valid signature.
...
\ID COV_CANIF_VSTD_RAMMEMCPY_ALWAYSTRUE
  \ACCEPT TX
  \ACCEPT XF
  \REASON The feature is mandatory in conjunction with SafeBSW. A MSSV plug-in enforces this configuration.   
...
\ID COV_CANIF_EXCELLIST
  ...
  \REASON see tab: CoverageAnalysis within ReviewLogSheet_TestSummaryReport.xlsm  
