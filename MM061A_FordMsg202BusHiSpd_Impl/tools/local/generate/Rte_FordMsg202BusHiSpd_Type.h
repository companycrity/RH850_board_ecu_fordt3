 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg202BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg202BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG202BUSHISPD_TYPE_H
# define _RTE_FORDMSG202BUSHISPD_TYPE_H
...
# ifndef Cx0_Inactive_not_confirmed
#  define Cx0_Inactive_not_confirmed (0U)
# endif

# ifndef Cx1_Inactive_confirmed
#  define Cx1_Inactive_confirmed (1U)
# endif

# ifndef Cx2_Active_not_confirmed
#  define Cx2_Active_not_confirmed (2U)
# endif

# ifndef Cx3_Active_confirmed
#  define Cx3_Active_confirmed (3U)
# endif

# ifndef Cx4_NotUsed_1
#  define Cx4_NotUsed_1 (4U)
# endif

# ifndef Cx5_NotUsed_2
#  define Cx5_NotUsed_2 (5U)
# endif

# ifndef Cx6_NotUsed_3
#  define Cx6_NotUsed_3 (6U)
# endif
...
# ifndef Cx0_Faulty
#  define Cx0_Faulty (0U)
# endif

# ifndef Cx1_No_Data_Exists
#  define Cx1_No_Data_Exists (1U)
# endif

# ifndef Cx2_Not_Within_Specifications
#  define Cx2_Not_Within_Specifications (2U)
# endif
...
#endif /* _RTE_FORDMSG202BUSHISPD_TYPE_H */
