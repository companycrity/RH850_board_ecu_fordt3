 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg091BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg091BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG091BUSHISPD_TYPE_H
# define _RTE_FORDMSG091BUSHISPD_TYPE_H
...
#endif /* _RTE_FORDMSG091BUSHISPD_TYPE_H */
