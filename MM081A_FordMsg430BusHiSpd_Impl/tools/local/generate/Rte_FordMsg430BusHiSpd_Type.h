 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg430BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg430BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG430BUSHISPD_TYPE_H
# define _RTE_FORDMSG430BUSHISPD_TYPE_H
...
# ifndef CxFFFFFF_Invalid
#  define CxFFFFFF_Invalid (16777215U)
# endif
...
#endif /* _RTE_FORDMSG430BUSHISPD_TYPE_H */
