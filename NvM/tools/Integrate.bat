...
:CopyCommon
xcopy ..\autosar\NvM_bswmd.arxml					%INTPJTDIR%\tools\SIP\Generators\Components\_Schemes\%SWC%\bswmd /s
xcopy ..\autosar\NvM_bswmd.arxml					%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
