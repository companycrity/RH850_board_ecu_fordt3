 ...
 *
 *   Description:  Application types header file for SW-C <ImcSigArbn> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_IMCSIGARBN_TYPE_H
# define _RTE_IMCSIGARBN_TYPE_H
