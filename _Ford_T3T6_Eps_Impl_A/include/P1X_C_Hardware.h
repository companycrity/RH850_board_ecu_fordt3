...
#define P1X_C_HARDWARE_TYPES_H    /* Patch for RenesasMcalSuprt hot fix */
...
__IOREG( UCFDERSTCLR, 0xFFC62008ul, __READ_WRITE, unsigned long );
                                                                 /*UCFDERSTCLR*/
__IOREG( UCFDERSTR  , 0xFFC62030ul, __READ_WRITE, unsigned long );/*UCFDERSTR */
