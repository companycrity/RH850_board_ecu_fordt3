 ...
 *   Generation Time: 2017-05-19 13:04:16
...
/* TODO remove latter */
volatile VAR(Os_ErrorInformationType, AUTOMATIC) OSErr_Cnt_D_str;
 ...
 *********************************************************************************************************************/
//TODO: BDO - OS debugging code. Enters endless loop on error to gather error details
  volatile uint8 endless = 1u;
  Os_ErrorInformationType ErrorInfo;
  volatile Os_ErrorInformationRefType ErrorRef = &ErrorInfo;
  
  /* TODO temporary patch for reactivation error during shutdown */
  if (E_OS_LIMIT == Error)
  {
	/* do nothing */
  }
  ...
  {
    Os_GetDetailedError(ErrorRef);
    OSErr_Cnt_D_str = ErrorInfo;
...
//END TODO: BDO - OS debugging code. Enters endless loop on error to gather error details
