...
{
	Rte_Write_FordVehLatCtrlLimSts_Ford_LatCtlLim_D_Stat((Ford_LatCtlLim_D_Stat)LatCtlLim_D_Stat);
	Rte_Write_FordVehLatCtrlSteerSts_Ford_LatCtlSte_D_Stat((Ford_LatCtlSte_D_Stat)LatCtlSte_D_Stat);
