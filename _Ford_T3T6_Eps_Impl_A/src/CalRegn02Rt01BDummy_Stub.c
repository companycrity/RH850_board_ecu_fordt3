...
*
* Module File Name  : CalRegn02Rt01BDummy_Stub.c
...
/**********************************************************************************************************************
  * Name:        CalRegn02Rt01GroupBDummyInit1
  ...
  * Usage Notes: NONE
  ********************************************************************************************************************/
FUNC(void, AAACalRegn02Rt01GroupB_Dummy_CODE) CalRegn02Rt01GroupBDummyInit1(P2CONST(struct Rte_CDS_AAACalRegn02Rt01GroupB_Dummy, AUTOMATIC, RTE_CONST) self)
{
