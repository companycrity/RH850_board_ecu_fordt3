%%-----------------------------------------------------------------------%
%% EA4 Component Data Dictionary - Created on 19-Jul-2017 12:54:26       %
...
MotAndThermProtnLoaMod.ReadIn = {'MotCurrRegCfgPer1'};
...
MotInduDaxEstimd.LongName = 'Motor Inductance D Axis Estimated';
...
MotInduQaxEstimd.LongName = 'Motor Inductance Q Axis Estimated';
...
MotAgElecDly.LongName = 'Motor Angle Electrical Delay';
...
MotCurrRegCfgCtrlrDynGainVehSpdCutOff.LongName = 'Controller Dynamic Gain Vehicle Speed Cutoff';
...
MotCurrRegCfgCurrLoopSecOrderTrfFctEna.LongName = 'Current Loop Second Order Transfer Function Enable';
...
MotCurrRegCfgMotAgCompuDly.LongName = 'Motor Angle Computation Delay';
MotCurrRegCfgMotAgCompuDly.Description = [...
  'Calibration used to estimate Computation delay angle'];
...
MotCurrRegCfgMotRVirtDax.LongName = 'Motor Resitance Virtual D Axis';
...
MotCurrRegCfgMotRVirtQax.LongName = 'Motor Resistance Virtual Q Axis';
...
MotVelMrfFild.EngMin = [struct('FilSt',-1350,'FilGain',0.012487743)];
MotVelMrfFild.EngMax = [struct('FilSt',1350,'FilGain',0.918997408)];
