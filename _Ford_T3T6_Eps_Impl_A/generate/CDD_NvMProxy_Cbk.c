...
#define NVMPROXY_RTE_NVMBLOCK_CDD_NVMPROXY_SHTDWNCLSCHK_IDX_CNT_U08 96U
...
FUNC(Std_ReturnType, AUTOMATIC) CDD_NvMProxy_ClsChkReadCallBack( const void * NvMBuffer )
{
    ...
    for(Idx_Cnt_T_u16 = 0u; Idx_Cnt_T_u16 < NvM_BlockDescriptorTable_at[NVMPROXY_RTE_NVMBLOCK_CDD_NVMPROXY_SHTDWNCLSCHK_IDX_CNT_U08].NvBlockLength_u16; Idx_Cnt_T_u16++)
    {
        ((uint8 *)(NvM_BlockDescriptorTable_at[NVMPROXY_RTE_NVMBLOCK_CDD_NVMPROXY_SHTDWNCLSCHK_IDX_CNT_U08].RamBlockDataAddr_t))[Idx_Cnt_T_u16] = ((uint8 *)NvMBuffer)[Idx_Cnt_T_u16];
    }
...
FUNC(Std_ReturnType, AUTOMATIC) CDD_NvMProxy_ClsChkWrCallBack( void * NvMBuffer )
{
    ...
    for(Idx_Cnt_T_u16 = 0u; Idx_Cnt_T_u16 < NvM_BlockDescriptorTable_at[NVMPROXY_RTE_NVMBLOCK_CDD_NVMPROXY_SHTDWNCLSCHK_IDX_CNT_U08].NvBlockLength_u16; Idx_Cnt_T_u16++)
    {
        ((uint8 *)NvMBuffer)[Idx_Cnt_T_u16] = ((uint8 *)(NvM_BlockDescriptorTable_at[NVMPROXY_RTE_NVMBLOCK_CDD_NVMPROXY_SHTDWNCLSCHK_IDX_CNT_U08].RamBlockDataAddr_t))[Idx_Cnt_T_u16];
    }
