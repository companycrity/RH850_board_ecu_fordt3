...
CONST(Os_Hal_TimerFrtConfigType, OS_CONST) OsCfg_Hal_TimerFrt_OsCounter =
{
  /* Timer Base Address  = */ (uint32)OS_HAL_TIMER_STM0_BASE,
  /* Timer Hardware Type = */ (uint32)OS_HAL_TIMER_STM,
