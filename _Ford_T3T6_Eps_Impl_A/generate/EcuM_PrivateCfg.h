...
**********************************************************************************************************************/
/** 
  \defgroup  EcuMPCGetRootDataMacros  EcuM Get Root Data Macros (PRE_COMPILE)
  \brief  These are used to get data pointers of root data.
  \{
*/ 
#define EcuM_GetDriverInitOneOfPCConfig()                             EcuM_ConfigDataPtr->DriverInitOneOfPCConfig
/** 
  \}
*/ 
...
#define EcuM_GetEcuM_CRCHash_LowerOfPCConfig()                        0x62011F3CUL
#define EcuM_GetEcuM_CRCHash_UpperOfPCConfig()                        0x21C18A0EUL
...
#define EcuM_HasDriverInitOne()                                       (EcuM_GetDriverInitOneOfPCConfig() != NULL_PTR)
...
/**********************************************************************************************************************
  EcuM_DriverInitOneECU1
**********************************************************************************************************************/
/** 
  \var    EcuM_DriverInitOneECU1
  \details
  Element     Description
  Function
*/ 
...
/*lint -restore */
extern CONST(EcuM_DriverInitOneType, ECUM_CONST) EcuM_DriverInitOneECU1[1];
...
/**********************************************************************************************************************
  EcuM_DriverInitOneECU2
**********************************************************************************************************************/
/** 
  \var    EcuM_DriverInitOneECU2
  \details
  Element     Description
  Function
*/ 
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(EcuM_DriverInitOneType, ECUM_CONST) EcuM_DriverInitOneECU2[1];
#define ECUM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
extern FUNC(void, ECUM_CODE) EcuM_AL_DriverInitOne_ECU1(void) ;
#if (ECUM_SLEEPMODELIST == STD_ON)
extern FUNC(void, ECUM_CODE) EcuM_AL_DriverRestartList_ECU1(void) /* COV_ECUM_CALLOUT */;
#endif
extern FUNC(void, ECUM_CODE) EcuM_AL_DriverInitOne_ECU2(void) ;
#if (ECUM_SLEEPMODELIST == STD_ON)
extern FUNC(void, ECUM_CODE) EcuM_AL_DriverRestartList_ECU2(void) /* COV_ECUM_CALLOUT */;
#endif
