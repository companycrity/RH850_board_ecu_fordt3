 ...
 *
 *   Description:  Application types header file for SW-C <FordVltgIf>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDVLTGIF_TYPE_H
# define _RTE_FORDVLTGIF_TYPE_H
