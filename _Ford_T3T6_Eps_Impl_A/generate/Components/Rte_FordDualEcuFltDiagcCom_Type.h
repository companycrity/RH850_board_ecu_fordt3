 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordDualEcuFltDiagcCom_Type.h
 *        Config:  EPS.dpa
 *   ECU-Project:  PSCM_FD
 *
 ...
 *
 *   Description:  Application types header file for SW-C <FordDualEcuFltDiagcCom>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDDUALECUFLTDIAGCCOM_TYPE_H
# define _RTE_FORDDUALECUFLTDIAGCCOM_TYPE_H
...
#endif /* _RTE_FORDDUALECUFLTDIAGCCOM_TYPE_H */
