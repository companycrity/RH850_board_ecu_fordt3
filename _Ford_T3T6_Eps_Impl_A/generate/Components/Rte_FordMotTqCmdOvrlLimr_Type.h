 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMotTqCmdOvrlLimr_Type.h
 *        Config:  EPS.dpa
 *   ECU-Project:  PSCM_FD
 *
 ...
 *
 *   Description:  Application types header file for SW-C <FordMotTqCmdOvrlLimr>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMOTTQCMDOVRLLIMR_TYPE_H
# define _RTE_FORDMOTTQCMDOVRLLIMR_TYPE_H
...
#endif /* _RTE_FORDMOTTQCMDOVRLLIMR_TYPE_H */
