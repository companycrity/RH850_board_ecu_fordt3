 ...
 *
 *   Description:  Application types header file for SW-C <DiagSrv>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DIAGSRV_TYPE_H
# define _RTE_DIAGSRV_TYPE_H
