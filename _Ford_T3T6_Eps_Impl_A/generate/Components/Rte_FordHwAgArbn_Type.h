 ...
 *
 *   Description:  Application types header file for SW-C <FordHwAgArbn>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDHWAGARBN_TYPE_H
# define _RTE_FORDHWAGARBN_TYPE_H
...
#endif /* _RTE_FORDHWAGARBN_TYPE_H */
