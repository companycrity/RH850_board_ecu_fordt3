 ...
 *
 *   Description:  Application types header file for SW-C <CustDiag>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CUSTDIAG_TYPE_H
# define _RTE_CUSTDIAG_TYPE_H
...
typedef uint8 Rte_ModeType_BswMEcuResetMod;
# endif
