...
#  define Rte_Pim_dMcuCoreCfgAndDiagcBistRunCmpl() \
  (&Rte_CDD_McuCoreCfgAndDiagc_dMcuCoreCfgAndDiagcBistRunCmpl) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, CDD_McuCoreCfgAndDiagc_CODE) McuCoreCfgAndDiagcInit2(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
