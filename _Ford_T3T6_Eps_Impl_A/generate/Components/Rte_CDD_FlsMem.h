...
#  define Rte_Pim_dFlsMemVrfyCrcInitCmpl() \
  (&Rte_CDD_FlsMem_dFlsMemVrfyCrcInitCmpl) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
FUNC(void, CDD_FlsMem_CODE) FlsMemPer1(void); /* PRQA S 0850, 3451 */ /* MD_MSR_19.8, MD_Rte_3451 */
