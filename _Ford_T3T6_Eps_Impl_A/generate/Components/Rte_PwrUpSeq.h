...
#  define Rte_Read_PwrUpSeq_MotDrvr1IninTestCmpl_Logl(data) (*(data) = Rte_CDD_FordT3T6McuCfg_MotDrvr1IninTestCmpl_Logl, ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
