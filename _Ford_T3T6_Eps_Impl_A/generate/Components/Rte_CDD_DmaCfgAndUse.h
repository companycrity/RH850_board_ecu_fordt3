 ...
 *********************************************************************************************************************/
#  define RTE_START_SEC_ADCF1CFGANDUSE_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */
FUNC(void, RTE_ADCF1CFGANDUSE_APPL_CODE) Adcf1EnaCnvn_Oper(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
#  define RTE_STOP_SEC_ADCF1CFGANDUSE_APPL_CODE
#  include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

#  define Rte_Call_Adc1CfgAndUseAdc1EnaCnvn_Oper() (Adcf1EnaCnvn_Oper(), ((Std_ReturnType)RTE_E_OK)) /* PRQA S 3453 */ /* MD_MSR_19.7 */
