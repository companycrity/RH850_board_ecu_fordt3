 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: CanNm_Cfg.h
 *   Generation Time: 2018-01-25 18:31:44
...
#define CanNmConf_CanNmTxPdu_CanNmTxPdu                               0       /**< [InvariantValuesModelView] */
/**\} */
...
/* Handle IDs active in a single predefined variant */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define CanNmConf_CanNmRxPdu_CanNmRxPdu                               0       /**< [InvariantValuesModelView] */
/**\} */
...
#define CANNM_DISABLE_TX_ERR_REPORT                     STD_ON
...
#define CANNM_EXPECTED_GENERATOR_COMPATIBILITY_VERSION  0x0701U
...
#define CANNM_DUMMY_STATEMENT(v) (v)=(v) /* PRQA S 3453 */ /* MD_MSR_19.7 */  /* /MICROSAR/EcuC/EcucGeneral/DummyStatementKind */
#endif
#ifndef CANNM_DUMMY_STATEMENT_CONST
#define CANNM_DUMMY_STATEMENT_CONST(v) (void)(v) /* PRQA S 3453 */ /* MD_MSR_19.7 */  /* /MICROSAR/EcuC/EcucGeneral/DummyStatementKind */
#endif
...
#endif
#ifndef CANNM_PROCESSOR_RH850_1373
#define CANNM_PROCESSOR_RH850_1373
#endif
#ifndef CANNM_COMP_GREENHILLS
#define CANNM_COMP_GREENHILLS
#endif
...
{
  CanNm_CommStateType FD1_CAN_f26020e5[1];
...
{
  CanNm_CoordReadyToSleepStateType FD1_CAN_f26020e5[1];
...
{
  CanNm_MsgConfirmationFlagType FD1_CAN_f26020e5[1];
...
{
  CanNm_MsgIndicationFlagType FD1_CAN_f26020e5[1];
...
{
  CanNm_MsgTimeoutTimerType FD1_CAN_f26020e5[1];
...
{
  CanNm_MsgTimerType FD1_CAN_f26020e5[1];
...
{
  CanNm_NetworkRestartFlagType FD1_CAN_f26020e5[1];
} CanNm_NetworkRestartFlagStructSType;

/**   \brief  type to be used as symbolic data element access to CanNm_RemoteSleepIndState */
typedef struct CanNm_RemoteSleepIndStateStructSTag
{
  CanNm_RemoteSleepIndStateType FD1_CAN_f26020e5[1];
} CanNm_RemoteSleepIndStateStructSType;

/**   \brief  type to be used as symbolic data element access to CanNm_RemoteSleepTimer */
typedef struct CanNm_RemoteSleepTimerStructSTag
{
  CanNm_RemoteSleepTimerType FD1_CAN_f26020e5[1];
} CanNm_RemoteSleepTimerStructSType;
...
{
  CanNm_RepeatMsgTimerType FD1_CAN_f26020e5[1];
...
{
  CanNm_TimeoutTimerType FD1_CAN_f26020e5[1];
...
{
  CanNm_TxControlStateType FD1_CAN_f26020e5[1];
...
{
  CanNm_TxControlStateRequestType FD1_CAN_f26020e5[1];
...
{
  CanNm_WaitBusSleepTimerType FD1_CAN_f26020e5[1];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  ...
  CanNm_RemoteSleepIndStateStructSType str;
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  ...
  CanNm_RemoteSleepTimerStructSType str;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(CanNm_RemoteSleepIndStateUType, CANNM_VAR_NOINIT) CanNm_RemoteSleepIndState;  /* PRQA S 0759 */  /* MD_CSL_18.4 */
#define CANNM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(CanNm_RemoteSleepTimerUType, CANNM_VAR_NOINIT) CanNm_RemoteSleepTimer;  /* PRQA S 0759 */  /* MD_CSL_18.4 */
#define CANNM_STOP_SEC_VAR_NOINIT_16BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
