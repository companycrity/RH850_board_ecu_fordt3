 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg2FDBusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg2FDBusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG2FDBUSHISPD_TYPE_H
# define _RTE_FORDMSG2FDBUSHISPD_TYPE_H
...
#endif /* _RTE_FORDMSG2FDBUSHISPD_TYPE_H */
