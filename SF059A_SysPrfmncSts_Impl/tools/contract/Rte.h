...
#    error "The magic number of the generated file <C:/Component/SF059A_SysPrfmncSts_Impl/tools/contract/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
