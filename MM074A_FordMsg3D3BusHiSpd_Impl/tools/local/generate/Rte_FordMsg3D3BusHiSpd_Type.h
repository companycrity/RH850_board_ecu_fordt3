 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg3D3BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg3D3BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG3D3BUSHISPD_TYPE_H
# define _RTE_FORDMSG3D3BUSHISPD_TYPE_H
...
# ifndef Cx0_Comfortable
#  define Cx0_Comfortable (0U)
# endif

# ifndef Cx1_Precise
#  define Cx1_Precise (1U)
# endif
...
# ifndef Cx3_Immediately
#  define Cx3_Immediately (3U)
# endif

# ifndef Cx0_NoLateralControl
#  define Cx0_NoLateralControl (0U)
# endif

# ifndef Cx1_ContinuousPathFollowing
#  define Cx1_ContinuousPathFollowing (1U)
# endif

# ifndef Cx2_InterventionLeft
#  define Cx2_InterventionLeft (2U)
# endif

# ifndef Cx3_InterventionRight
#  define Cx3_InterventionRight (3U)
# endif

# ifndef Cx4_NotUsed1
#  define Cx4_NotUsed1 (4U)
# endif

# ifndef Cx5_NotUsed2
#  define Cx5_NotUsed2 (5U)
# endif

# ifndef Cx6_NotUsed3
#  define Cx6_NotUsed3 (6U)
# endif

# ifndef Cx7_NotUsed4
#  define Cx7_NotUsed4 (7U)
# endif
...
#endif /* _RTE_FORDMSG3D3BUSHISPD_TYPE_H */
