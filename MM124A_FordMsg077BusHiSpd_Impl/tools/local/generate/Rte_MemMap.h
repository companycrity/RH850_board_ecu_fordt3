...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_STOP_SEC_FORDMSG3CABUSHISPD_APPL_CODE)  */
...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_START_SEC_FORDMSG3CABUSHISPD_APPL_CODE)  */
