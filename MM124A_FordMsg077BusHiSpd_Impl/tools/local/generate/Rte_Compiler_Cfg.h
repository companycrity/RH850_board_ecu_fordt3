...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:FordMsg3CABusHiSpd_CONST)  ***********/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:RTE_FORDMSG3CABUSHISPD_APPL)  ********/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:FordMsg3CABusHiSpd_CODE)  ************/
...
#if 0
/***  Start of saved code (symbol: compiler abstraction implementation:FordMsg3CABusHiSpd_VAR)  *************/
