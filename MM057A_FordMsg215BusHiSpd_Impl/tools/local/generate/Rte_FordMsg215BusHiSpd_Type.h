 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg215BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg215BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG215BUSHISPD_TYPE_H
# define _RTE_FORDMSG215BUSHISPD_TYPE_H
...
# ifndef Cx0_NoRequest
#  define Cx0_NoRequest (0U)
# endif

# ifndef Cx1_Mode_1
#  define Cx1_Mode_1 (1U)
# endif

# ifndef Cx2_Mode_2
#  define Cx2_Mode_2 (2U)
# endif

# ifndef Cx3_Mode_3
#  define Cx3_Mode_3 (3U)
# endif
...
#endif /* _RTE_FORDMSG215BUSHISPD_TYPE_H */
