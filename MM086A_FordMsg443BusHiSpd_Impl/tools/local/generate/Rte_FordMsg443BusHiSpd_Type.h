 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg443BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg443BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG443BUSHISPD_TYPE_H
# define _RTE_FORDMSG443BUSHISPD_TYPE_H
...
#endif /* _RTE_FORDMSG443BUSHISPD_TYPE_H */
