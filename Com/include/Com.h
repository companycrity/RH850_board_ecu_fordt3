...
/**
  ...
  \details  -
    \{
*/
# define COM_SW_MAJOR_VERSION                 11U    /**< Major version */
...
# define COM_E_INIT_FAILED                 4U /**< the API service has been when COM was already initialized.r */
/**
  \}
*/
...
/*! \brief    This method starts the cyclic transmission of an I-PDU.
    ...
    \return   none
    \context  The function can be called on interrupt and task level,
              but must not interface with Com_TxModeHdlr_MainFunction.
    \synchronous TRUE
    \reentrant   TRUE, for different Handles
**********************************************************************************************************************/
...
/*! \brief    This method stops the cyclic transmission of an I-PDU and cancels outstanding transmission requests of
    ...
    \param    ComTxPduId    ID of Tx I-PDU.
    \return   none
    \context  This is a Com private function and is only called by the Com module
