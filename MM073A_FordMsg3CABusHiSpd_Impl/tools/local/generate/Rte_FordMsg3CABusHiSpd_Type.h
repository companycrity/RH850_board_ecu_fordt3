 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg3CABusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg3CABusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG3CABUSHISPD_TYPE_H
# define _RTE_FORDMSG3CABUSHISPD_TYPE_H
...
# ifndef Cx0_LDW_Idle
#  define Cx0_LDW_Idle (0U)
# endif

# ifndef Cx1_Not_Used1
#  define Cx1_Not_Used1 (1U)
# endif

# ifndef Cx2_LDW_Warning_Left
#  define Cx2_LDW_Warning_Left (2U)
# endif

# ifndef Cx3_LDW_Suppress_Left
#  define Cx3_LDW_Suppress_Left (3U)
# endif

# ifndef Cx4_LDW_Warning_Right
#  define Cx4_LDW_Warning_Right (4U)
# endif

# ifndef Cx5_LDW_Suppress_Right
#  define Cx5_LDW_Suppress_Right (5U)
# endif

# ifndef Cx6_Not_Used2
#  define Cx6_Not_Used2 (6U)
# endif

# ifndef Cx7_LDW_Suppress_Right_Left
#  define Cx7_LDW_Suppress_Right_Left (7U)
# endif

# ifndef Cx0_LkaNoInterv
#  define Cx0_LkaNoInterv (0U)
# endif

# ifndef Cx1_LkaIncrIntervLeft
#  define Cx1_LkaIncrIntervLeft (1U)
# endif

# ifndef Cx2_LkaStandIntervLeft
#  define Cx2_LkaStandIntervLeft (2U)
# endif

# ifndef Cx3_LkaSupprLeft
#  define Cx3_LkaSupprLeft (3U)
# endif

# ifndef Cx4_LkaStandIntervRight
#  define Cx4_LkaStandIntervRight (4U)
# endif

# ifndef Cx5_LkaSupprRight
#  define Cx5_LkaSupprRight (5U)
# endif

# ifndef Cx6_LkaIncrIntervRight
#  define Cx6_LkaIncrIntervRight (6U)
# endif
...
#endif /* _RTE_FORDMSG3CABUSHISPD_TYPE_H */
