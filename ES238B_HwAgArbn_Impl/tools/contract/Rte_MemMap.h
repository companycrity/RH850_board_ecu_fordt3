...
#   error "The magic number of the generated file <C:/component/ES238B_HwAgArbn_Impl/tools/contract/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
