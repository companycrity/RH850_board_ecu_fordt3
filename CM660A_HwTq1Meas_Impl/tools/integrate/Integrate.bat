...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CM660A_HwTq1Meas_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CM660A_HwTq1Meas_Impl
...
XCOPY ..\..\autosar\HwTq1Meas_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
