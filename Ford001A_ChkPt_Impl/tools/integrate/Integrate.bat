...
REM * Module Description: Copies component files to an integration project.
REM * Project:            CBD
REM * Author:             Lucas Wendling
REM *******************************************************************************************************************
...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ChkPt
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ChkPt
...
XCOPY ..\..\autosar\ChkPt_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
