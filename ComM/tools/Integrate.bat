...
:CopyCommon
xcopy ..\autosar\ComM_bswmd.arxml					%INTPJTDIR%\tools\SIP\Generators\Components\_Schemes\%SWC%\bswmd /s
xcopy ..\autosar\ComM_bswmd.arxml					%INTPJTDIR%\tools\SIP\BSWMD\%SWC% /s
