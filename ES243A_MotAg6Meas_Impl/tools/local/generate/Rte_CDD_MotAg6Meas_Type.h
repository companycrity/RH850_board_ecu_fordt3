 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CDD_MotAg6Meas_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <CDD_MotAg6Meas> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CDD_MOTAG6MEAS_TYPE_H
# define _RTE_CDD_MOTAG6MEAS_TYPE_H
...
#endif /* _RTE_CDD_MOTAG6MEAS_TYPE_H */
