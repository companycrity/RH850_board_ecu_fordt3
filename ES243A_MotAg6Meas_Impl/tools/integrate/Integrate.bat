...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES243A_MotAg6Meas_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES243A_MotAg6Meas_Impl
...
XCOPY ..\..\autosar\MotAg6Meas_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
