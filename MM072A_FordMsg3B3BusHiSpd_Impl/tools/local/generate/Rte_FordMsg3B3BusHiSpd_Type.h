 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg3B3BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg3B3BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG3B3BUSHISPD_TYPE_H
# define _RTE_FORDMSG3B3BUSHISPD_TYPE_H
...
#endif /* _RTE_FORDMSG3B3BUSHISPD_TYPE_H */
