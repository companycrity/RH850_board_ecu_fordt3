...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CM690D_HwTq8Meas_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CM690D_HwTq8Meas_Impl
...
XCOPY ..\..\autosar\HwTq8Meas_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
