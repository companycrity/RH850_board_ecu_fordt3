 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg4B0BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg4B0BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG4B0BUSHISPD_TYPE_H
# define _RTE_FORDMSG4B0BUSHISPD_TYPE_H
...
#endif /* _RTE_FORDMSG4B0BUSHISPD_TYPE_H */
