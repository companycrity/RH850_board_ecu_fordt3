...
struct Rte_CDS_Rtn
{
  ...
  P2VAR(float32, TYPEDEF, RTE_VAR_DEFAULT_RTE_PIM_GROUP) Pim_dRtnAbsltHwAg; /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# define Rte_Pim_dRtnAbsltHwAg() (Rte_Inst_Rtn->Pim_dRtnAbsltHwAg) /* PRQA S 3453 */ /* MD_MSR_19.7 */
