...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\CM670A_HwAg1Meas_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\CM670A_HwAg1Meas_Impl
...
XCOPY ..\..\autosar\HwAg1Meas_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
