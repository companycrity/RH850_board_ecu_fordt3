...
This resource.gpj contains three example linker directives files:
** threadx_ram.ld     -- For programs that are linked into and run
                         out of RAM. 
** threadx_romcopy.ld -- For programs that are linked into ROM, but
                         run out of RAM.
** threadx_romrun.ld  -- For programs that are linked into and run
                         out of ROM. 
