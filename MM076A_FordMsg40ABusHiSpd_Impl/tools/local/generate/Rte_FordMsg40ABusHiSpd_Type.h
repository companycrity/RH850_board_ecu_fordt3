 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg40ABusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg40ABusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG40ABUSHISPD_TYPE_H
# define _RTE_FORDMSG40ABUSHISPD_TYPE_H
...
#endif /* _RTE_FORDMSG40ABUSHISPD_TYPE_H */
