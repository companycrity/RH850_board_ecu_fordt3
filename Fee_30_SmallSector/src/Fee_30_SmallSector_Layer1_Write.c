 ...
 * \reentrant  FALSE
 */
FEE_30_SMALLSECTOR_LOCAL FUNC (void, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_Wr_InitiateDatasetErase(MemIf_JobResultType InstanceFinderResult);
...
FEE_30_SMALLSECTOR_LOCAL FUNC (void, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_Wr_ProcessInstanceFinderState(void)
{
  MemIf_JobResultType InstanceFinderResult = Fee_30_SmallSector_If_GetJobResult();
  ...
  default: /* #50 Finish job due to failed InstanceFinder job: MEMIF_JOB_FAILED */
    Fee_30_SmallSector_Wr_FinishJob(InstanceFinderResult);
    break;
  }
}
