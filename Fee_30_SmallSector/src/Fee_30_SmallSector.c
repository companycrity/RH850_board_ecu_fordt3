...
#if (   (FEE_30_SMALLSECTOR_SW_MAJOR_VERSION != (1u)) \
...
#if (   (FEE_30_SMALLSECTOR_CBK_MAJOR_VERSION != (1u)) \
...
FEE_30_SMALLSECTOR_LOCAL FUNC(void, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_InitDataHandler(void)
{
  ...
  Fee_30_SmallSector_Dh_Init(Fee_30_SmallSector_UserJobParameter.BlockNumber, Fee_30_SmallSector_Bh_GetDataLength(Fee_30_SmallSector_UserJobParameter.BlockNumber), 
          Fee_30_SmallSector_Bh_GetNumberOfInstances(), Fee_30_SmallSector_Bh_GetBlockStartAddress(), Fee_30_SmallSector_Ph_GetPartitionAddressAlignment());
...
/* Justification for module-specific MISRA deviations:
 ...
 MD_FEE_30_SMALLSECTOR_5.1: rule 5.1
     Reason:      Infixes for all names are necessary in order to make a difference to Standard FEE.
     Risk:        No risk.
     Prevention:  There is none. Infixes are necessary, because there might be projects with both Standard Fee and SmallSector Fee.
