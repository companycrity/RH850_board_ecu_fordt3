...
FEE_30_SMALLSECTOR_LOCAL uint8 Fee_30_SmallSector_Dh_TempBuffer[FEE_30_SMALLSECTOR_MAX_WRITE_ALIGNMENT];
        ...
        uint8 NumberOfInstances, Fee_30_SmallSector_AddressType BlockStartAddress, uint16 AddressAlignment)
{
  ...
  /* #20 DatasetSize: align( WriteAlignment + (InstanceSize * NrOfInstances), AddressAlignment) */
  Fee_30_SmallSector_Dh_DatasetInfo.DatasetSize = (uint16) Fee_30_SmallSector_AlignValue((uint32) (WriteAlignment + (Fee_30_SmallSector_Dh_DatasetInfo.AlignedInstanceSize * NumberOfInstances)), AddressAlignment);
  ...
  /* #40 First instance starts in second page of dataset */
 ...
 *
 */
FUNC (Std_ReturnType, FEE_30_SMALLSECTOR_PUBLIC_CODE) Fee_30_SmallSector_Dh_WriteErasePattern(void)
{
  ...
  /* #20 Write initialized buffer to first page of dataset */
  return Fee_30_SmallSector_Fls_Write(Fee_30_SmallSector_Dh_DatasetInfo.DatasetStartAddress, Fee_30_SmallSector_Dh_TempBuffer, Fee_30_SmallSector_Ph_GetPartitionWriteAlignment()); /* SBSW_FEE_30_SMALLSECTOR_27 */
}
...
FUNC (Std_ReturnType, FEE_30_SMALLSECTOR_PUBLIC_CODE) Fee_30_SmallSector_Dh_CheckErasePattern(void)
{
  ...
  if (Fee_30_SmallSector_Ph_GetBlankCheckApi() == TRUE)
  {
    ...
    retVal = Fee_30_SmallSector_Fls_BlankCheck(Fee_30_SmallSector_Dh_DatasetInfo.DatasetStartAddress, Fee_30_SmallSector_Ph_GetPartitionWriteAlignment());
  }
  else
  {
    /* #30 Read content of first page, which contains the ErasePattern */
    retVal = Fee_30_SmallSector_Fls_Read(Fee_30_SmallSector_Dh_DatasetInfo.DatasetStartAddress, Fee_30_SmallSector_Dh_TempBuffer, Fee_30_SmallSector_Ph_GetPartitionWriteAlignment()); /* SBSW_FEE_30_SMALLSECTOR_27 */
  }
  return retVal;
}
