...
FEE_30_SMALLSECTOR_LOCAL FUNC(void, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_RdMgmt_ProcessWaitForReadLastPage(void)
{
  if (Fee_30_SmallSector_Fls_GetJobResult() == MEMIF_JOB_OK){
    ...
    Fee_30_SmallSector_Ih_SetLastPageState(Fee_30_SmallSector_RdMgmt_Instance, Fee_30_SmallSector_Ih_GetLastPageFromBuffer(Fee_30_SmallSector_RdMgmt_Instance)); /* SBSW_FEE_30_SMALLSECTOR_51 */ /* SBSW_FEE_30_SMALLSECTOR_51 */
