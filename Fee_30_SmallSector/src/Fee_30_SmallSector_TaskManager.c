...
FEE_30_SMALLSECTOR_LOCAL VAR(Fee_30_SmallSector_Tm_FctPtrType, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_Tm_ExecuteServiceStack[FEE_30_SMALLSECTOR_NUMBER_OF_LAYERS];

/* Variable which represents cancel stack */
FEE_30_SMALLSECTOR_LOCAL VAR(Fee_30_SmallSector_Tm_FctPtrType, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_Tm_CancelServiceStack[FEE_30_SMALLSECTOR_NUMBER_OF_LAYERS];
...
{
  sint8 LoopCounter;
  VAR (Fee_30_SmallSector_Tm_FctPtrType, FEE_30_SMALLSECTOR_PRIVATE_CODE) returnValue = NULL_PTR;
...
FUNC (void, FEE_30_SMALLSECTOR_PUBLIC_CODE) Fee_30_SmallSector_Tm_ExecuteTask (void)
{
  ...
  VAR (Fee_30_SmallSector_Tm_FctPtrType, FEE_30_SMALLSECTOR_PRIVATE_CODE) currentExecuteService;
  currentExecuteService = Fee_30_SmallSector_Tm_GetActiveTask();
