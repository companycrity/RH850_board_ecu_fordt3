...
FEE_30_SMALLSECTOR_LOCAL uint8 Fee_30_SmallSector_Ih_ReadBuffer[FEE_30_SMALLSECTOR_MAX_READ_SIZE];
FEE_30_SMALLSECTOR_LOCAL uint8 Fee_30_SmallSector_Ih_WriteBuffer[FEE_30_SMALLSECTOR_MAX_WRITE_ALIGNMENT];
...
FEE_30_SMALLSECTOR_LOCAL const uint8 Fee_30_SmallSector_Ih_ValidManagementValue = 0xF0u;
FEE_30_SMALLSECTOR_LOCAL const uint8 Fee_30_SmallSector_Ih_InvalidManagementValue = 0x0Fu;
 ...
 *
 */
FUNC(boolean, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_Ih_IsLastPageNecessary(Fee_30_SmallSector_Ih_InstanceConstPointerType Instance)
{
 ...
 *
 */
FUNC(uint8, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_Ih_GetMgmtValue(Fee_30_SmallSector_Ih_InstanceConstPointerType Instance)
{
 ...
 *
 */
FUNC(void, FEE_30_SMALLSECTOR_PRIVATE_CODE) Fee_30_SmallSector_Ih_StoreMgmtValueFromBuffer(Fee_30_SmallSector_Ih_InstanceVarPointerType Instance)
{
...
/**********************************************************************************************************************
 *  Fee_30_SmallSector_Ih_GetLastPageFromBuffer()
 *********************************************************************************************************************/
/*!
 * Internal comment removed.
 *
 ...
 *
 */
FUNC (Fee_30_SmallSector_StaticPatternState, FEE_30_SMALLSECTOR_PUBLIC_CODE) Fee_30_SmallSector_Ih_GetLastPageFromBuffer(Fee_30_SmallSector_Ih_InstanceConstPointerType Instance)
{
  uint16 LoopCounter;
  Fee_30_SmallSector_StaticPatternState retVal = FEE_30_SMALLSECTOR_PATTERN_INIT;
  boolean isPageBlank = FALSE;
  boolean isPageInconsistent = FALSE;

  /* #10 Get status of last page: */
  /* #11 If entire last page is equal to erase value of flash, status PATTERN_BLANK is returned */
  /* #12 Otherwise PATTERN_INCONSISTENT is returned */
  /* #13 It is sufficient to check whether the last page is blank or not (inconsistent) */
  for (LoopCounter = 0; LoopCounter < Fee_30_SmallSector_Ph_GetPartitionWriteAlignment(); LoopCounter++)
  {
    /* #20 Check if current value matches with erase value of FLS */
    ...
    {
      isPageInconsistent = TRUE;
      retVal = FEE_30_SMALLSECTOR_PATTERN_INCONSISTENT;
    }
  }

  /* #30 Last page contains both blank and not blank bytes, thus it's inconsistent */
  if ((isPageInconsistent ^ isPageBlank) == FALSE)
  {
    retVal = FEE_30_SMALLSECTOR_PATTERN_INCONSISTENT;
  }
