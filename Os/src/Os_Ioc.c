 ...
 *
 *  \param[in,out]  Ioc             IOC to query.
 *  \param[in]      InterruptState  The parameter from Os_IocLock.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE for different objects.
 ...
 *  \details        --no details--
 *
 *  \param[in]      Callbacks             The callbacks to query.
 *
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type Ioc08MultiReceive.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type Ioc16MultiReceive.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type Ioc32MultiReceive.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type IocRefMultiReceive.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type IocWrite.
 **********************************************************************************************************************/
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type Ioc08Receive.
 **********************************************************************************************************************/
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type Ioc16Receive.
 **********************************************************************************************************************/
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type Ioc32Receive.
 **********************************************************************************************************************/
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type IocRefReceive.
 **********************************************************************************************************************/
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type Ioc08Send.
 **********************************************************************************************************************/
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type Ioc16Send.
 **********************************************************************************************************************/
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type Ioc32Send.
 **********************************************************************************************************************/
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The caller has to ensure, that the Ioc is in fact of type IocRefSend.
 **********************************************************************************************************************/
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  Task  The object to query.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Std_ReturnType, OS_CODE,
OS_ALWAYS_INLINE, Os_IocEmptyMultiQueue,
(
  P2CONST(Os_IocMultiReceiveConfigType, TYPEDEF, OS_CONST) Ioc,
  Os_IocSubClassType SubClass
  ...
  /* #10 Initialize Data. */
{
  ...
  if(Ioc->InitValue != NULL_PTR)
  {
    Ioc->CopyCbk(Ioc->InitValue, Ioc->Data);                                                                            /* SBSW_OS_IOC_IOCWRITECOPYCBK_001 */
  }
}
...
)
{
  ...
  else
  {
    ...
    Ioc->CopyCbk(Data, Ioc->Data);                                                                                      /* SBSW_OS_IOC_IOCWRITECOPYCBK_002 */
...
\ID SBSW_OS_IOC_IOCWRITECOPYCBK_001
  \DESCRIPTION    CopyCbk function pointer call with arguments InitValue and Data. CopyCbk, InitValue and Data are
                  derived from an Ioc object. The Ioc object is passed as parameter to the calling
                  function. The correctness of the parameters is ensured by precondition. The compliance of the
                  precondition is check during review.
  \COUNTERMEASURE \M [CM_OS_IOCWRITE_COPYCBK_M]
                  \R [CM_OS_IOCWRITE_INITVALUE_R]
                  \M [CM_OS_IOCWRITE_DATA_M]

\ID SBSW_OS_IOC_IOCWRITECOPYCBK_002
...
\CM CM_OS_IOCWRITE_INITVALUE_R
      Implementation ensures, that InitValue is a non NULL_PTR.
