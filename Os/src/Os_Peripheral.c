 ...
 *  \details        --no details--
 *
 *  \param[in]      PeripheralID        The ID of the searched peripheral.
 *
 ...
 *
 *  \param[in]      PeripheralID      The ID of the searched core.
 *
 *  \return         The peripheral belonging to the given ID.
 *
 *  \context        ANY
 ...
 *  \details        --no details--
 *
 *  \param[in]      Peripheral        The peripheral to query.
 *  \param[in]      Address           The address to check.
 *
...
Os_PeripheralCheckAddressRange08,
(
  P2CONST(Os_PeripheralConfigType, TYPEDEF, OS_CONST) Peripheral,
  uint32 Address
));
...
))
{
  ...
  /*! \note Add a pointer alignment check here */
}
...
{
  return (Os_StdReturnType) (   (Address >=  Peripheral->AddressStart)
                             && (Address <= (Peripheral->AddressEnd - (Size - 1) )));
}
...
)
{
  ...
  Os_PeripheralCheck08(PeripheralID, Address);

  /* #20 Read the target address value. */
  result = *((P2CONST(uint8, AUTOMATIC, OS_APPL_DATA))Address);                                                         /* PRQA S 0306 */ /* MD_Os_0306_Interface */
...
)
{
  ...
  /* #10 Perform error checks. */
  Os_PeripheralCheck16(PeripheralID, Address);

  /* #20 Read the target address value. */
  result = *((P2CONST(uint16, AUTOMATIC, OS_APPL_DATA))Address);                                                        /* PRQA S 0306 */ /* MD_Os_0306_Interface */
...
)
{
  ...
  /* #10 Perform error checks. */
  Os_PeripheralCheck32(PeripheralID, Address);

  /* #20 Read the target address value. */
  result = *((P2CONST(uint32, AUTOMATIC, OS_APPL_DATA))Address);                                                        /* PRQA S 0306 */ /* MD_Os_0306_Interface */
...
)
{
  ...
  *((P2VAR(uint8, AUTOMATIC, OS_APPL_DATA))Address) = Value;                                                            /* PRQA S 0306 */ /* MD_Os_0306_Interface */ /* SBSW_OS_PP_PERIPHERAL_ADDRESS_001 */
}
...
)
{
  ...
  /* #20 Modify the target address value. */
  *((P2VAR(uint16, AUTOMATIC, OS_APPL_DATA))Address) = Value;                                                           /* PRQA S 0306 */ /* MD_Os_0306_Interface */ /* SBSW_OS_PP_PERIPHERAL_ADDRESS_001 */
}
...
)
{
  ...
  /* #20 Modify the target address value. */
  *((P2VAR(uint32, AUTOMATIC, OS_APPL_DATA))Address) = Value;                                                           /* PRQA S 0306 */ /* MD_Os_0306_Interface */ /* SBSW_OS_PP_PERIPHERAL_ADDRESS_001 */
}
...
{
  P2VAR(uint8, AUTOMATIC, OS_APPL_DATA) address8;

  /* #10 Perform error checks. */
  Os_PeripheralCheck08(PeripheralID, Address);

  /* #20 Modify the target address value. */
  address8 = (P2VAR(uint8, AUTOMATIC, OS_APPL_DATA))Address;                                                            /* PRQA S 0306 */ /* MD_Os_0306_Interface */

  /* As the result of a bitwise operation is a word, casts are required. */
  *address8 = (uint8)(((uint8)((*address8)) & ClearMask) | SetMask);                                                    /* SBSW_OS_PP_PERIPHERAL_ADDRESS_001 */
}
...
{
  P2VAR(uint16, AUTOMATIC, OS_APPL_DATA) address16;

  /* #10 Perform error checks. */
  Os_PeripheralCheck16(PeripheralID, Address);

  /* #20 Modify the target address value. */
  address16 = (P2VAR(uint16, AUTOMATIC, OS_APPL_DATA))Address;                                                          /* PRQA S 0306 */ /* MD_Os_0306_Interface */

  /* As the result of a bitwise operation is a word, casts are required. */
  *address16 = (uint16)(((uint16)(*address16) & ClearMask) | SetMask);                                                  /* SBSW_OS_PP_PERIPHERAL_ADDRESS_001 */
}
...
{
  P2VAR(uint32, AUTOMATIC, OS_APPL_DATA) address32;

  /* #10 Perform error checks. */
  Os_PeripheralCheck32(PeripheralID, Address);

  /* #20 Modify the target address value. */
  address32 = (P2VAR(uint32, AUTOMATIC, OS_APPL_DATA))Address;                                                          /* PRQA S 0306 */ /* MD_Os_0306_Interface */

  /* As the result of a bitwise operation is a word, casts are required. */
  *address32 = (uint32)((uint32)((*address32) & ClearMask) | SetMask);                                                  /* SBSW_OS_PP_PERIPHERAL_ADDRESS_001 */
}
