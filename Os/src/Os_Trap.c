 ...
 *  \details        --no details--
 *
 *  \param[in]      CallerAccessRights  Access rights to switch to.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 *  \synchronous    TRUE
 *
 *  \pre            Given object pointer(s) are valid, if memory protection is enabled trusted applications.
 **********************************************************************************************************************/
...
))
{
  ...
  /* #20 Call the API. */
  result = Os_Api_ReadPeripheral8(PeripheralID, Address);
...
))
{
  ...
  /* #20 Call the API. */
  result = Os_Api_ReadPeripheral16(PeripheralID, Address);
...
))
{
  ...
  /* #20 Call the API. */
  result = Os_Api_ReadPeripheral32(PeripheralID, Address);
...
))
{
  ...
  /* #20 Call the API. */
  Os_Api_WritePeripheral8(PeripheralID, Address, Value);
...
))
{
  ...
  /* #20 Call the API. */
  Os_Api_WritePeripheral16(PeripheralID, Address, Value);
...
))
{
  ...
  /* #20 Call the API. */
  Os_Api_WritePeripheral32(PeripheralID, Address, Value);
...
))
{
  ...
  /* #20 Call the API. */
  Os_Api_ModifyPeripheral8(PeripheralID, Address, ClearMask, SetMask);
...
))
{
  ...
  /* #20 Call the API. */
  Os_Api_ModifyPeripheral16(PeripheralID, Address, ClearMask, SetMask);
...
))
{
  ...
  /* #20 Call the API. */
  Os_Api_ModifyPeripheral32(PeripheralID, Address, ClearMask, SetMask);
...
)
{
  ...
  /*! \note Consider Memory protection for trusted (when ESCAN00088830 shall be supported).
   *        Data shall only be written to places where the caller has write access!         */
...
{
  /* #10 If a trap is needed: */
  if(Os_TrapIsNeeded() != 0)                                                                                            /* COV_OS_TRAPSUPPORTEDWITHMEMPROTONLY */
  {
    Os_TrapPacketType packet;
...
)
{
  ...
  if(OS_UNLIKELY(Os_ErrCheckPointerIsNotNull(InterruptSource) == OS_CHECK_FAILED))                                      /* SBSW_OS_TRAP_ERRCHECKPOINTERISNOTNULL_001 */
  {
...
)
{
  ...
  /* #10 Check that the given pointer is valid. */
  if(OS_UNLIKELY(Os_ErrCheckPointerIsNotNull(ExceptionSource) == OS_CHECK_FAILED))                                      /* SBSW_OS_TRAP_ERRCHECKPOINTERISNOTNULL_001 */
  {
    status = OS_STATUS_PARAM_POINTER_1;
  }
  else
...
)
{
  ...
  if(Os_TrapIsNeeded() != 0)                                                                                            /* COV_OS_HALPLATFORMTRAPALWAYSNEEDED */
  {
    ...
    packet.Parameters[OS_TRAPPARAMINDEX_2].ParamUint32Type = Address;                                                   /* SBSW_OS_PWA_LOCAL */
  ...
  else
  {
    ...
    /* #70 Call the API directly. */
    result = Os_TrapCallReadPeripheral8(PeripheralID, Address);
...
)
{
  ...
  else
  {
    ...
    /* #70 Call the API directly. */
    result = Os_TrapCallReadPeripheral16(PeripheralID, Address);
...
)
{
  ...
  else
  {
    ...
    /* #70 Call the API directly. */
    result = Os_TrapCallReadPeripheral32(PeripheralID, Address);
...
)
{
  ...
  else
  {
    ...
    /* #60 Call the API directly. */
    Os_TrapCallWritePeripheral8(PeripheralID, Address, Value);
...
)
{
  ...
  else
  {
    ...
    /* #60 Call the API directly. */
    Os_TrapCallWritePeripheral16(PeripheralID, Address, Value);
...
)
{
  ...
  else
  {
    ...
    /* #60 Call the API directly. */
    Os_TrapCallWritePeripheral32(PeripheralID, Address, Value);
...
)
{
  ...
  else
  {
    ...
    /* #60 Call the API directly. */
    Os_TrapCallModifyPeripheral8(PeripheralID, Address, ClearMask, SetMask);
...
)
{
  ...
  else
  {
    ...
    /* #60 Call the API directly. */
    Os_TrapCallModifyPeripheral16(PeripheralID, Address, ClearMask, SetMask);
...
)
{
  ...
  else
  {
    ...
    /* #60 Call the API directly. */
    Os_TrapCallModifyPeripheral32(PeripheralID, Address, ClearMask, SetMask);
 ...
 **********************************************************************************************************************/
FUNC(TrustedFunctionParameterRefType, OS_CODE) OSError_CallTrustedFunction_FunctionParams(void)
{
 ...
 **********************************************************************************************************************/
FUNC(Os_NonTrustedFunctionParameterRefType, OS_CODE) OSError_CallNonTrustedFunction_FunctionParams(void)
{
 ...
 *  OSError_IocSend_IN()
 **********************************************************************************************************************/
FUNC(void const*, OS_CODE) OSError_IocSend_IN(void)                                                                     /* COV_OS_TRAPLIBFUNCTIOC */
{
  return Os_ErrorGetParameter_VoidRefType(OS_ERRORPARAMINDEX_1);
}

/***********************************************************************************************************************
 *  OSError_IocWrite_IN()
 **********************************************************************************************************************/
FUNC(void const*, OS_CODE) OSError_IocWrite_IN(void)                                                                    /* COV_OS_TRAPLIBFUNCTIOC */
{
  return Os_ErrorGetParameter_VoidRefType(OS_ERRORPARAMINDEX_1);
}
 ...
 **********************************************************************************************************************/
FUNC(void const*, OS_CODE) OSError_IocSendGroup_IN(void)                                                                /* COV_OS_TRAPLIBFUNCTIOC */
{
  return Os_ErrorGetParameter_VoidRefType(OS_ERRORPARAMINDEX_1);
}
 ...
 **********************************************************************************************************************/
FUNC(void const*, OS_CODE) OSError_IocWriteGroup_IN(void)                                                               /* COV_OS_TRAPLIBFUNCTIOC */
{
  return Os_ErrorGetParameter_VoidRefType(OS_ERRORPARAMINDEX_1);
}
 ...
 **********************************************************************************************************************/
FUNC(void const*, OS_CODE) OSError_IocReceive_OUT(void)                                                                 /* COV_OS_TRAPLIBFUNCTIOC */
{
  return Os_ErrorGetParameter_VoidRefType(OS_ERRORPARAMINDEX_1);
}
 ...
 *  OSError_IocRead_OUT()
 **********************************************************************************************************************/
FUNC(void const*, OS_CODE) OSError_IocRead_OUT(void)                                                                    /* COV_OS_TRAPLIBFUNCTIOC */
{
  return Os_ErrorGetParameter_VoidRefType(OS_ERRORPARAMINDEX_1);
}
 ...
 **********************************************************************************************************************/
FUNC(void const*, OS_CODE) OSError_IocReceiveGroup_OUT(void)                                                            /* COV_OS_TRAPLIBFUNCTIOC */
{
  return Os_ErrorGetParameter_VoidRefType(OS_ERRORPARAMINDEX_1);
}
 ...
 **********************************************************************************************************************/
FUNC(void const*, OS_CODE) OSError_IocReadGroup_OUT(void)                                                               /* COV_OS_TRAPLIBFUNCTIOC */
{
  return Os_ErrorGetParameter_VoidRefType(OS_ERRORPARAMINDEX_1);
}
 ...
 **********************************************************************************************************************/
FUNC(AppModeType, OS_CODE) OSError_StartOS_Mode(void)                                                                   /* COV_OS_TRAPLIBFUNCTSTARTOS */
{
  return Os_ErrorGetParameter_AppModeType(OS_ERRORPARAMINDEX_1);
}
...
)
{
  ...
  switch(Packet->TrapId)
  {
    ...
    case OS_TRAPID_SHUTDOWNALLCORES:
      Os_TrapCallShutdownAllCores(
          Packet->Parameters[OS_TRAPPARAMINDEX_1].ParamApiType.ParamStatusType
      );
      break;
    ...
    case OS_TRAPID_IOCREFEMPTYQUEUE:
      Packet->ReturnValue.ReturnStd_ReturnType =                                                                        /* SBSW_OS_PWA_PRECONDITION */
    ...
    case OS_TRAPID_GETUNHANDLEDIRQ:
      Packet->ReturnValue.ReturnOs_StatusType =                                                                         /* SBSW_OS_PWA_PRECONDITION */
    ...
    case OS_TRAPID_GETUNHANDLEDEXC:
      Packet->ReturnValue.ReturnOs_StatusType =                                                                         /* SBSW_OS_PWA_PRECONDITION */
...
\ID COV_OS_TRAPLIBFUNCTIOC
   \ACCEPT XX
   \REASON These functions are library functions. They are meant as an API to retrieve error information of the
           caller function within the ErrorHook. As the ErrorHook is currently not called from IOC-functions,
           the error retrieve functions are useless and may become useful or removed in future versions. The
...
\ID COV_OS_TRAPLIBFUNCTSTARTOS
   \ACCEPT XX
   \REASON This function is a library function. It is meant as an API to retrieve error information of the
           caller function StartOS within the ErrorHook. As the ErrorHook is currently not called from StartOS,
           the error retrieve function is useless and may become useful or removed in future versions. The
           risk of keeping the code now is low as it is unit tested and code inspected and only returns read
           values (no write instructions at all).

\ID COV_OS_TRAPSUPPORTEDWITHMEMPROTONLY
   \ACCEPT TX
   \REASON The function is currently supported with memory protection only. Therefore, the code could not be
           covered. However, very similar code has successfully been covered in many similar functions. A
           feature to support this function even without memory protections may be added later. The risk of
           keeping the code is considered to be low.

\ID COV_OS_TRAPNONPRIVILEGEDTRUSTED
   \ACCEPT XF
   \REASON This code branch is required, if trusted applications may be configured non-privileged. As this feature is
           currently not supported, code may not be covered. The risk of keeping the code is considered to be low.
