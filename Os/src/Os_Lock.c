...
\ID SBSW_OS_LOCK_LOCKLISTNEXT_001
 \DESCRIPTION    Os_LockListNext is called within a loop. The passed pointer is change on every iteration.
 \COUNTERMEASURE \R Loop condition ensures that the passed pointer is valid.
