 ...
 *  \pre              The given NodeIdx is valid.
 ...
 *
 */
FUNC_P2CONST(Os_JobConfigType, AUTOMATIC, OS_CODE) Os_PriorityQueuePop                                                  /* COV_OS_PRIOQUEUELIBFUNCT */
(
  P2CONST(Os_PriorityQueueConfigType, AUTOMATIC, OS_CONST) PriorityQueue
)                                                                                                                       /* COV_OS_PRIOQUEUELIBFUNCT */
{
  ...
  else
  {
    ...
    /* #60 Copy the data pointer of the last node into the root node. */
    ...
    /* #70   Restore the shape property by calling Os_PriorityQueueHeapDown(rootIdx). */
