 ...
 *  \details        --no details--
 *
 *  \param[in,out]  ScheduleTable The schedule table to be started.
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  ScheduleTable   The schedule table to be queried.
 *  \param[out]     ScheduleStatus  Contains the current state on successful return.
 *
 *  \retval         OS_STATUS_OK              No error.
 *  \retval         OS_STATUS_NOTACCESSIBLE_1 (Service Protection:) Given object's owner application is not accessible.
 *
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  ScheduleTable_From  The schedule table to be stopped.
 *  \param[in,out]  ScheduleTable_To    The schedule table to be stopped.
 *
 *  \retval         OS_STATUS_OK              No error.
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  ScheduleTable The schedule table to be stopped.
 *
 *  \retval         OS_STATUS_OK              No error.
 ...
 *
 *  \pre            Given object pointer(s) are valid.
 *  \pre            The given Job is a schedule table job.
 **********************************************************************************************************************/
 ...
 *  \details        --no details--
 *
 *  \param[in]      ExPo    An expiry point object.
 *
 ...
 *
 *  \pre            Given object pointer(s) are valid.
 *  \pre            The given ExPo is a synchronous ExPo.
 **********************************************************************************************************************/
 ...
 *  \details        --no details--
 *
 *  \param[in]      ScheduleTable   The schedule table to query.
 *
 ...
 *
 *  \pre            Given object pointer(s) are valid.
 *  \pre            The given schedule table is a synchronous schedule table.
 **********************************************************************************************************************/
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  ScheduleTable   The schedule table to modify.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  ScheduleTable   The schedule table to query.
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  ScheduleTable   The schedule table to sync.
 *  \param[in]      SyncTimeNow     The current value of the SyncTime.
 *
 *  \context        OS_INTERNAL
 *
 ...
 *  \details        --no details--
 *
 *  \param[in]      ScheduleTableSync   The schedule table to query.
 *
 ...
 *
 *  \param[in,out]  ScheduleTable  The schedule table to switch from.
 *
 ...
 *  \pre            Given object pointer(s) are valid.
 *  \pre            Concurrent access to given object is prevented by caller.
 *  \pre            The given schedule table has a valid Next schedule table.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE P2CONST(Os_SchTConfigType, AUTOMATIC, OS_CONST), OS_CODE,
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  ScheduleTableSync  The schedule table to query.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in,out]  ExPo  The exipry point, whose action shall be performed.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *                  the middle of a schedule table
 *
 *  \param[in,out]  ScheduleTableSync     The schedule table to modify.
 *  \param[out]     RelativeOffsetToNext  Returns the relative offset to the next schedule table.
 *
 *  \context        OS_INTERNAL
 *
 ...
 *                                        schedule table, parameter is unchanged.
 *
 ...
 *
 *  \pre            Given object pointer(s) are valid.
 *  \pre            Lhs are Rhs in range 0 .. Duration-1.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE Os_TickType, OS_CODE, OS_ALWAYS_INLINE,
Os_SchTSyncSub,
(
 ...
 *
 *  \pre            Given object pointer(s) are valid.
 *  \pre            Lhs is in range -DurationHalf .. DurationHalf-1
 *  \pre            Rhs is in range -DurationHalf .. DurationHalf-1
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE Os_TickType, OS_CODE, OS_ALWAYS_INLINE,
Os_SchTSyncSubAndModHalfRange,
(
 ...
 *
 *  \pre            Given object pointer(s) are valid.
 *  \pre            Operand is in range 0 .. Duration-1.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE Os_TickType, OS_CODE, OS_ALWAYS_INLINE,
Os_SchTSyncFull2HalfRange,
(
 ...
 *  \pre            Given object pointer(s) are valid.
 *  \pre            Concurrent access to given object is prevented by caller.
 *  \pre            Given schedule table is not scheduled.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,
Os_SchTStartRelative,
(
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(OS_LIKELY(Os_AppIsMemberOfCore(scheduleTable->OwnerApplication, callerCore) != 0))                             /* SBSW_OS_SCHT_APPISMEMBEROFCORE_001 */
      {
...
)
{
  ...
  else
  {
    ...
    else
    {
      ...
      if(OS_LIKELY(Os_AppIsMemberOfCore(scheduleTable_From->OwnerApplication, callerCore) != 0))                        /* SBSW_OS_SCHT_APPISMEMBEROFCORE_001 */
      {
        Os_IntStateType interruptState;
...
)
{
  ...
  else
  {
    ...
    else if(OS_UNLIKELY(Os_AppCheckIsCoreLocal                                                                          /* SBSW_OS_SCHT_APPCHECKISCORELOCAL_001 */ /* SBSW_OS_SCHT_THREADGETCORE_001 */
...
)
{
  ...
  else
  {
    ...
    else if(OS_UNLIKELY(Os_AppCheckIsCoreLocal(scheduleTable->OwnerApplication, Os_ThreadGetCore(currentThread))        /* SBSW_OS_SCHT_APPCHECKISCORELOCAL_001 */ /* SBSW_OS_SCHT_THREADGETCORE_001 */
                          == OS_CHECK_FAILED))
    {
      status = OS_STATUS_CORE;
    }
