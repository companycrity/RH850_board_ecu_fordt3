...
struct Os_Hal_STMType_Tag
{
  ...
  uint32 osSTMnCNT1;        /*!< +70h Timer counter register.              (32/8 bit write ) */
  uint32 osSTMnUnused10;    /*!< +74h No mapped hardware register. */
  uint32 osSTMnUnused11;    /*!< +78h No mapped hardware register. */
  uint32 osSTMnUnused12;    /*!< +7Ch No mapped hardware register. */
  uint32 osSTMnCMP1A;       /*!< +80h Timer compare register.              (32/8 bit write ) */
  uint32 osSTMnCMP1B;       /*!< +84h Timer compare register.              (32/8 bit write ) */
  uint32 osSTMnCMP1C;       /*!< +88h Timer compare register.              (32/8 bit write ) */
  uint32 osSTMnCMP1D;       /*!< +8Ch Timer compare register.              (32/8 bit write ) */
  uint32 osSTMnCNT2;        /*!< +90h Timer counter register.              (32/8 bit write ) */
  uint32 osSTMnUnused13;    /*!< +94h No mapped hardware register. */
  uint32 osSTMnUnused14;    /*!< +98h No mapped hardware register. */
  uint32 osSTMnUnused15;    /*!< +9Ch No mapped hardware register. */
  uint32 osSTMnCMP2A;       /*!< +A0h Timer compare register.              (32/8 bit write ) */
  uint32 osSTMnCMP2B;       /*!< +A4h Timer compare register.              (32/8 bit write ) */
  uint32 osSTMnCMP2C;       /*!< +A8h Timer compare register.              (32/8 bit write ) */
  uint32 osSTMnCMP2D;       /*!< +ACh Timer compare register.              (32/8 bit write ) */
  uint32 osSTMnCNT3;        /*!< +B0h Timer counter register.              (32/8 bit write ) */
  uint32 osSTMnUnused16;    /*!< +B4h No mapped hardware register. */
  uint32 osSTMnUnused17;    /*!< +B8h No mapped hardware register. */
  uint32 osSTMnUnused18;    /*!< +BCh No mapped hardware register. */
  uint32 osSTMnCMP3A;       /*!< +C0h Timer compare register.              (32/8 bit write )*/
  uint32 osSTMnCMP3B;       /*!< +C4h Timer compare register.              (32/8 bit write )*/
  uint32 osSTMnCMP3C;       /*!< +C8h Timer compare register.              (32/8 bit write )*/
  uint32 osSTMnCMP3D;       /*!< +CCh Timer compare register.              (32/8 bit write )*/
};
