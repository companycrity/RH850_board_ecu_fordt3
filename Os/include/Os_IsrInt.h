 ...
 *
 *  \param[in,out]  Isr  The ISR which shall be initialized.
 *
 *  \context        ANY
 *
 ...
 *
 *  \pre            Given object pointer(s) are valid.
 *  \pre            The given thread is an ISR thread.
 **********************************************************************************************************************/
 ...
 *  \details        --no details--
 *
 *  \param[in]      IsrId        The id of the searched ISR.
 *
 ...
 *  \details        --no details-
 *
 *  \param[in,out]  Level        The core level.
 *  \param[in]      HalLevel     The HAL level.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in,out]  Isr   ISR which shall be killed.
 *
 *  \context        ISR2
 *
 *  \reentrant      TRUE for different ISRs.
 ...
 *
 *  \param[in,out]  Isr   Category 2 ISR which shall be disabled.
 *
 ...
 *  \details        The kernel uses this function to implement TerminateApplication().
 *
 *  \param[in,out]  Isr   Category 1 ISR which shall be disabled.
 *
 *  \context        TASK|ISR2|ERRHOOK
 *
 *  \reentrant      TRUE for different ISRs.
 ...
 *
 *  \param[in,out]  Isr   ISR which shall be executed.
 *
 *  \context        TASK|ISR2
 *
 *  \reentrant      TRUE for different ISRs.
 ...
 *  \details        --no details--
 *
 *  \param[in]      Isr     The ISR which shall be checked.
 ...
 *  \retval       INVALID_ISR    If called from
 ...
 *  \trace          CREQ-106183
 *
 *  \pre            Interrupt source is disabled.
 **********************************************************************************************************************/
