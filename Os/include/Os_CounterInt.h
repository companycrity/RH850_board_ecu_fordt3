 ...
 *                Init-Step4.
 *
 *  \param[in,out]  Counter   The counter to be initialized.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 ...
 *
 *  \param[in,out]  Counter   The counter to start.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 ...
 *  \details        --no details--
 *
 *  \param[in]    Counter  Counter to query.
 *
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  Counter  The object to query.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in]    Counter         The Counter which defines the MaxAllowedValue.
 ...
 *
 *  \pre            Given object pointer(s) are valid.
 *  \pre            Parameter Reduce <= MAXALLOWEDVALUE configured for the counter
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE,
    Os_CounterCheckValueLeReducedMaxAllowed,
(
 ...
 *  \details        --no details--
 *
 *  \param[in]      Counter   The counter to query.
 *
 ...
 *  \synchronous    TRUE
 *  \pre            Given object pointer(s) are valid.
 *  \pre            Operand has to be in range 0 <= Operand <= MaxCountingValue.
 **********************************************************************************************************************/
 ...
 *
 *  \pre            Given object pointer(s) are valid.
 *  \pre            Value has to be in range 0..MaxAllowedValue
 *  \pre            Sub has to be in range 0..MaxAllowedValue
 **********************************************************************************************************************/
 ...
 *                  next future job.
 *
 *  \param[in,out]  Counter         The counter, which shall work of its jobs.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in,out]  Counter    The counter, which shall work of the job.
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 *  \pre            Counter belongs to the local core.
 *  \pre            Given value of Offset is in range 1..MaxAllowedValue of the respective counter configuration.
 ...
 *  \pre            Concurrent access to given object is prevented by caller.
 *  \pre            Counter belongs to the local core.
 *  \pre            Given value of Start is in range 0..MaxAllowedValue of the respective counter configuration.
 *  \pre            Given job is not scheduled.
 **********************************************************************************************************************/
 ...
 *
 *  \param[in,out]  Counter  The counter, which shall delete the job from its queue.
 *  \param[in]      Job      Job to delete.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in]      Counter   The counter.
 *  \param[out]     Value     Contains the returned counter value on successful return.
 *
 ...
 *                SPEC-63752, SPEC-63887, SPEC-63980
 **********************************************************************************************************************/
 ...
 *                SPEC-64017, SPEC-63752, SPEC-63797, SPEC-63980
 **********************************************************************************************************************/
