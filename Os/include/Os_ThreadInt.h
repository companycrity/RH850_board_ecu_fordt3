...
struct Os_ThreadConfigType_Tag
{
   ...
   *  \note Consider creating an own IntApiState per thread, not per core. */
 ...
 *  \details      --no details--
 *
 *  \param[in,out]  Thread        Thread to query.
 *  \param[in]      ServiceCalls  Linked list of service calls.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 ...
 *  Os_ThreadSetLocks()
 **********************************************************************************************************************/
/*! \brief        Set list of locks, which are currently occupied by the given thread.
 *  \details      --no details--
 *
 *  \param[in,out]  Thread  Thread to modify.
 *  \param[in]      Locks   List of occupied locks.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
...
OS_ALWAYS_INLINE, Os_ThreadSetLocks,
(
  P2CONST(Os_ThreadConfigType, AUTOMATIC, OS_CONST) Thread,
  P2CONST(Os_LockConfigType, AUTOMATIC, OS_CONST) Locks
));
 ...
 *
 *  \param[in]    Thread                The thread to check.
 *  \param[in]    App                   The application to check.
 *
 ...
 *  \synchronous  TRUE
 *
 *  \pre          The given object pointer is valid.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE, OS_ALWAYS_INLINE,
Os_ThreadCheckIsCurrentApplication,
(
 ...
 *
 *  \param[in]    Thread  Thread to query.
 *  \param[in]    App     Application which shall be the new current application.
 *
 *  \return       Current application of the given thread.
 *
 *  \context      ANY
 ...
 *
 *  \param[in]    Thread      The thread to be queried.
 *
 ...
 *
 *  \param[in,out]  Thread  The thread whose locks shall be released.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in,out]  Thread  The thread which shall be initialized.
 *
 *  \context        ANY
 *
 ...
 *
 *  \param[in,out]  Next  The thread which shall be resumed.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE for different threads.
 ...
 *
 *  \note           This function is candidate for 'OS_NORETURN'.
 **********************************************************************************************************************/
 ...
 *
 *  \param[in,out]  Thread  Thread to kill.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE for different threads.
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  Current The thread which shall be suspended.
 *  \param[in,out]  Next    The thread which shall be resumed.
 *
 *  \context        ANY
 *
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  Thread        The thread to modify.
 ...
 *  \synchronous    TRUE
 *
 *  \pre            Given Thread pointer(s) are valid.
 *  \pre            Given AccessRights pointer(s) are valid, if Memory protection is enabled.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(
 ...
 *
 *  \param[in,out]  Thread         The thread to modify.
 *  \param[in]      InterruptState The interrupt state to set.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *
 *  \pre            Given Thread pointer(s) are valid.
 *  \pre            Given InterruptState pointer(s) are valid.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(
OS_LOCAL_INLINE void,
