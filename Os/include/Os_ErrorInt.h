 ...
 *
 *  \param[in]    Error            The error to initialize.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 ...
 *
 *  \param[in]    Status            The result of the API execution.
 *  \param[in]    Error             The first API parameter.
 *
 *  \context      OS_INTERNAL
 *
 *  \return       See \ref ShutdownAllCores().
 *
 *  \reentrant    TRUE
 *  \synchronous  TRUE
 *
 ...
 *
 *  \note         Optimization: In case of standard status, it may be hard for the compiler to optimize this function
 *                away, if it is not marked as side effect free. Same for assertions.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *                SPEC-63718, SPEC-63920, SPEC-63941, SPEC-63832
 **********************************************************************************************************************/
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
FUNC(AppModeType, OS_CODE) Os_ErrorGetParameter_AppModeType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
FUNC(Os_ExceptionSourceIdType, OS_CODE) Os_ErrorGetParameter_ExceptionSourceIdType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
FUNC(Os_InterruptSourceIdType, OS_CODE) Os_ErrorGetParameter_InterruptSourceIdType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
FUNC(MemorySizeType, OS_CODE) Os_ErrorGetParameter_MemorySizeType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
FUNC(MemoryStartAddressType, OS_CODE) Os_ErrorGetParameter_MemoryStartAddressType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
FUNC(StatusType const*, OS_CODE) Os_ErrorGetParameter_StatusRefType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
FUNC(StatusType, OS_CODE) Os_ErrorGetParameter_StatusType(Os_ErrorParmIndexType ParamIndex);
 ...
 *  \trace        CREQ-97
 **********************************************************************************************************************/
FUNC(void const*, OS_CODE) Os_ErrorGetParameter_VoidRefType(Os_ErrorParmIndexType ParamIndex);
 ...
 **********************************************************************************************************************/
/*! \brief        OS service Os_OSErrorGetServiceId().
