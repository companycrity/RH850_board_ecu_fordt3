 ...
 *
 *  \param[in,out]  Alarm  The alarm which shall be initialized.
 ...
 *
 *  \param[in,out]  Alarm  Alarm to kill.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE for different alarms.
 ...
 *  \details        --no details--
 *
 *  \param[in]      AlarmId     The ID to convert.
 *
 ...
 *  \details        --no details--
 *
 *  \param[in]      Alarm  The object to query.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in,out]  Job    The job which contains the alarm data.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *                SPEC-64361, SPEC-63714, SPEC-64048, SPEC-64017, SPEC-63980, SPEC-63709, SPEC-63752
 **********************************************************************************************************************/
 ...
 *                SPEC-64314, SPEC-64333, SPEC-64337, SPEC-64340, SPEC-64348, SPEC-64358
 **********************************************************************************************************************/
