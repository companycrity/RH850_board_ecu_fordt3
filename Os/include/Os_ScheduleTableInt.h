 ...
 *  \details        If the given application mode is on of the autostart modes, this function activates
 *                  the given schedule table. It sets all dynamic data of the given schedule table to its configured
 *                  startup settings.
 *
 *  \param[in,out]  SchT    The schedule table which shall be initialized.
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  SchT    Schedule table to kill.
 *
 *  \context        OS_INTERNAL
 *
 ...
 *  \details        --no details--
 *
 *  \param[in]      SchTId   A schedule table id.
 *
 *  \return         Returns the schedule table of the given dd.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *  \details        --no details--
 *
 *  \param[in]      SchT        Schedule table to query.
 *
 ...
 *  \details        --no details--
 *
 *  \param[in]    SchT  The object to query.
 *
 *  \context      ANY
 *
 *  \reentrant    TRUE
 ...
 *                SPEC-63980, SPEC-64017, SPEC-63752, SPEC-63709
 **********************************************************************************************************************/
 ...
 *                SPEC-63955, SPEC-63979, SPEC-63982, SPEC-64046, SPEC-63980, SPEC-64017, SPEC-63752,
 *                SPEC-63709
 **********************************************************************************************************************/
 ...
 *                SPEC-64017, SPEC-63752, SPEC-63709
 **********************************************************************************************************************/
 ...
 *                SPEC-64019, SPEC-63980, SPEC-64017, SPEC-63752, SPEC-63709
 **********************************************************************************************************************/
