...
#if !defined(OS_SIGNALINT_H)                                                                                            /* PRQA S 0883 */ /* MD_Os_0883 */
# define OS_SIGNALINT_H
 ...
 *
 *  \param[in]  SendApp       Sender application
 *  \param[in]  InParameter   Parameters to be passed to the service.
 *  \param[in]  OutParameter  Parameters which
 *
 ...
 *
 *  \param[in,out]  XSignal The task which shall be initialized.
 *
 *  \context        ANY
 *
 ...
 *  \details        --no details--
 *
 *  \param[in]      RecvCore        The receiving caller core.
 *  \param[in]      SendThread      The sender thread of the cross core request.
 *  \param[in]      FunctionIdx     The function to call.
 *  \param[in]      Parameters      The call parameters.
 *
 ...
 *  \param[in]      SendThread      The sender thread of the cross core request.
 *  \param[in]      FunctionIdx     The function to call.
 *  \param[in]      InParameters    The call parameters.
 *  \param[out]     OutParameters   The output parameters of the API call.
 *
 ...
 *  \param[in]      SendThread  The user thread that called the API.
 ...
 *  \param[in]      RecvCore    Pointer to the core configuration of the destination core.
 *  \param[in]      SendThread  The user thread that called the API.
 *  \param[in]      AlarmID     As described for Os_Api_GetAlarm().
 *  \param[out]     Tick        As described for Os_Api_GetAlarm().
 *
 *  \retval         OS_STATUS_OK                        No error.
 *  \retval         OS_STATUS_CALL_NOT_ALLOWED          No communication with that core allowed.
 *  \retval         OS_STATUS_FUNCTION_UNAVAILABLE      Destination ISR does not support this function.
 ...
 *  \param[out]     Result          The stack usage.
 *
 *  \retval         OS_STATUS_OK                        No error.
 *  \retval         OS_STATUS_CALL_NOT_ALLOWED          No communication with that core allowed.
 *  \retval         OS_STATUS_FUNCTION_UNAVAILABLE      Destination ISR does not support this function.
 ...
 *  \details        --no details--
 *
 *  \param[in]      SendApp       The sender application.
 *  \param[in]      InParameter   The API call parameters.
 *  \param[out]     OutParameter  The output data of the call.
 *
