 ...
 *
 *  \param[in,out]  LockList  List of locks where the given element shall be inserted.
 *  \param[in,out]  Lock      Lock to insert.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in,out]  LockList  List of locks where the given element shall be removed from.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in,out]  LockList  List of locks where the given element shall be removed from.
 *  \param[in,out]  Lock      Lock which shall be removed.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *  Os_LockListContains()
 **********************************************************************************************************************/
/*! \brief          Returns whether the given lock list contains the Lock
 *  \details        --no details--
 *
 *  \param[in]      LockList  List of locks which shall be searched.
 *  \param[in]      Lock      The lock to search for.
 *
 *  \retval         !0      The lock is part of the list.
 *  \retval         0       The lock is not part of the list.
...
OS_ALWAYS_INLINE, Os_LockListContains,
(
 ...
 *  \details        --no details--
 *
 *  \param[in]      Lock  Pointer to lock list entry.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *  \details        --no details--
 *
 *  \param[in]      LockList  List of locks which shall be checked.
 *
 *
 ...
 *  \details        --no details--
 *
 *  \param[in]      LockList      The lock list to test.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *  \details        --no details--
 *
 *  \param[in]      LockList    The lock list.
 *
 ...
 *  \details        --no details--
 *
 *  \param[in]      LockList  The list of locks where the given lock is in.
 ...
 *                  resource objects.
 *
 *  \param[in]      Lock      The lock to init.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *  \details        --no details--
 *
 *  \param[in]      Lock  The resource to query.
 *
