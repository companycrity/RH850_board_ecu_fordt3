 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE,                                                 /* COV_OS_SPINLOCKLIBFUNCT *//* PRQA S 3219 */ /* MD_Os_3219 */
OS_ALWAYS_INLINE, Os_SpinlockIsLocked,
(
  P2CONST(Os_SpinlockConfigType, AUTOMATIC, OS_CONST) Spinlock
))                                                                                                                      /* COV_OS_SPINLOCKLIBFUNCT */
{
  P2VAR(Os_SpinlockType, AUTOMATIC, OS_VAR_NOINIT) spinlockDyn;

  spinlockDyn = Os_SpinlockGetDyn(Spinlock);                                                                            /* SBSW_OS_FC_PRECONDITION */

  /* #10 Delegate to the HAL. */
  return Os_Hal_SpinIsLocked(&(spinlockDyn->Spinlock));                                                                 /* SBSW_OS_SL_HAL_SPINISLOCKED_001 */
}
