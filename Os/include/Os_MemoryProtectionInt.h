 ...
 *  \synchronous    TRUE
 *
 *  \pre            Given object pointer(s) are valid if Memory protection is enabled.
 ...
 *
 *
 *  \param[in]      Config    Threads's memory protection configuration.
 *  \param[out]     Settings  Threads current memory protection settings.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in]      Current   Current access rights.
 *  \param[in]      Next      Access rights to switch to.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in]      AccessRights      Access rights to switch to.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *  \trace        SPEC-63706
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(void, OS_CODE, OS_NORETURN, Os_MemFault, (void));
