 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE void, OS_CODE,                                                             /* PRQA S 3219, 3673 */ /* MD_Os_3219, MD_Os_3673_ModifiedArgument */
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE,                                                 /* COV_OS_LOCKLIBFUNCT *//* PRQA S 3219 */ /* MD_Os_3219 */
...
))                                                                                                                      /* COV_OS_LOCKLIBFUNCT */
{
  ...
  /* #10 Iterate over all locks. */
  while(Os_LockListIsEmpty(&it) == 0)                                                                                   /* SBSW_OS_LOCK_LOCKLISTISEMPTY_001 */
  {
    /* #20 If the lock was found, result is non 0. */
    if(Lock == it)
    {
      result = 1;
      break;
    }
    it = Os_LockListNext(it);                                                                                           /* SBSW_OS_LOCK_LOCKLISTNEXT_001 */
  }
 ...
 *  Os_LockListNext()
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE P2CONST(Os_LockConfigType, AUTOMATIC, OS_CONST), OS_CODE,
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE P2VAR(Os_LockListType, AUTOMATIC, OS_VAR_NOINIT) , OS_CODE,
...
))
{
  return (Os_StdReturnType)(    (Lock->Type == OS_LOCKTYPE_RESOURCE_STANDARD)
                            ||  (Lock->Type == OS_LOCKTYPE_RESOURCE_INTERRUPT));
}
