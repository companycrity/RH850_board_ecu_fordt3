...
#if !defined(OS_SIGNAL_H)                                                                                               /* PRQA S 0883 */ /* MD_Os_0883 */
# define OS_SIGNAL_H
 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE Os_StatusType, OS_CODE, OS_ALWAYS_INLINE,                                  /* PRQA S 3219 */ /* MD_Os_3219 */
Os_XSigSend_HookCallCallbackAsync,
(
  P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) RecvCore,
  P2CONST(Os_ThreadConfigType, AUTOMATIC, OS_CONST) SendThread,
