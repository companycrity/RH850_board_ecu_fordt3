...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    /* - #30 Call the Vector timing hook (user code) for scheduling: OS_VTH_SCHEDULE(). */
...
))
{
  ...
  /* - #40 Store the currently running task if Orti task tracing is enabled. */
...
))
{
  ...
  /* - #50 Store the currently running ISR if Orti ISR tracing is enabled. */
  if (Os_TraceIsOrtiTaskIsrTracingEnabled() != 0)
  {
    P2CONST(Os_CoreAsrConfigType, AUTOMATIC, OS_CONST) core;
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    /* - #30 Call the Vector timing hook for killing: OS_VTH_FORCED_TERMINATION(). */
    OS_VTH_FORCED_TERMINATION((KilledIsr->Id), (Os_CoreGetId(Os_CoreGetCurrentCore())))                                 /* SBSW_OS_CORE_COREGETID_001 */
  }
}
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    /* - #30 Call the Vector timing hook for killing OS_VTH_FORCED_TERMINATION() if task is not suspended.  */
    if(IsTaskSuspended == 0) {
      OS_VTH_FORCED_TERMINATION((KilledTask->Id), (Os_CoreGetId(Os_CoreGetCurrentCore())))                              /* SBSW_OS_CORE_COREGETID_001 */
    }
  }
}
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    /* #20 Call the vector timing hook for task activation: OS_VTH_ACTIVATION(). */
    /* variable values are casted in order to assure that they cannot be written in the hook */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    CoreIdType coreId;
    coreId = Os_CoreGetId(Os_CoreGetCurrentCore());                                                                     /* SBSW_OS_TRACE_COREGETID_001 */
    /* #20 Call the vector timing hook for task activation: OS_VTH_SETEVENT(). */
    /* variable values are casted in order to assure that they cannot be written in the hook */
...
))
{
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    /* #10 Call the vector timing hook for resource occupation: OS_VTH_GOT_RES() if timings are enabled */
...
))
{
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    /* #10 Call the vector timing hook for resource occupation: OS_VTH_REL_RES() */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    {
      /* #30 For configured spinlocks call: OS_VTH_REQ_SPINLOCK(). */
    ...
    {
      /* #40 For internal   spinlocks call: OS_VTH_REQ_ISPINLOCK(). */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    if (Spinlock->SpinlockId < Os_TraceGetNumberOfConfiguredSpinlocks())
    {
      /* #30 For configured spinlocks call: OS_VTH_GOT_SPINLOCK(). */
    ...
    {
      /* #40 For internal   spinlocks call: OS_VTH_IGOT_SPINLOCK(). */
...
))
{
  ...
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
    ...
    if (Spinlock->SpinlockId < Os_TraceGetNumberOfConfiguredSpinlocks())
    {
      /* #30 For configured spinlocks call: OS_VTH_REL_SPINLOCK(). */
    ...
    {
      /* #40 For internal   spinlocks call: OS_VTH_REL_ISPINLOCK(). */
...
{
  /* #10 Call the vector timing hook for interrupt locks: OS_VTH_DISABLEDINT() if timings hooks are enabled. */
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
...
{
  /* #10 Call the vector timing hook for interrupt locks: OS_VTH_DISABLEDINT() if timing hooks are enabled. */
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
...
{
  /* #10 Call the vector timing hook for interrupt locks: OS_VTH_ENABLEDINT() if timing hooks are enabled. */
  if(Os_TraceIsTimingHookEnabled() != 0)
  {
