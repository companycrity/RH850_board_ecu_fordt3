 ...
 **********************************************************************************************************************/
/*! \fn           Os_Hal_IntStateType Os_Hal_GetDisableGlobal(void)
 *  \brief        Get the global interrupt flag state.
 *  \details      --no details--
 *
 ...
 *  \pre          -
 **********************************************************************************************************************/
asm Os_Hal_IntStateType Os_Hal_GetDisableGlobal(void)
{
  stsr  PSW, r10
  di
  andi  0x20, r10, r10
