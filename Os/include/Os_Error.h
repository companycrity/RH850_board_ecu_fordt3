 ...
 *
 */
OS_FUNC_ATTRIBUTE_DEFINITION(OS_LOCAL_INLINE StatusType, OS_CODE, OS_ALWAYS_INLINE,                                     /* COV_OS_ERRREPORTLIBFUNCT *//* PRQA S 3219 */ /* MD_Os_3219 */
Os_ErrReportShutdownAllCores,
(
  Os_StatusType Status,
  StatusType Error
))                                                                                                                      /* COV_OS_ERRREPORTLIBFUNCT */
{
  /* #10 If there was an error: */
  if(OS_UNLIKELY(Os_ErrIsPropagationRequired(Status) != 0))
  {
    /* #20 Create error parameter object. */
    Os_ErrorParamsType errorParameters;
    errorParameters.Parameter[OS_ERRORPARAMINDEX_1].ParamStatusType = Error;                                            /* SBSW_OS_ERROR_ERROR_PARAMETER_001 */

    /* #30 Report the error and get the error return code. */
    Os_TrapErrApplicationError(OSServiceId_ShutdownAllCores, Status, &errorParameters);                                 /* SBSW_OS_FC_POINTER2LOCAL */
  }
