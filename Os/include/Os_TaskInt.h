 ...
 *  \details        --no details--
 *
 *  \param[in]      TaskId        The id of the searched task.
 *
 ...
 *
 *  \pre            Given object pointer(s) are valid.
 *  \pre            The given thread is a Task thread.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE P2CONST(Os_TaskConfigType, AUTOMATIC, OS_CONST), OS_CODE,
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  Task    Task to query.
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  Task        Task to modify.
 ...
 *
 *  \pre            Given object pointer(s) are valid.
 *  \pre            Priority < Scheduler->NumberOfPriorities.
 **********************************************************************************************************************/
 ...
 *  Os_TaskIsExtended()
 **********************************************************************************************************************/
/*! \brief          Returns whether the given task is an extended task or not.
 *  \details        --no details--
 *
 *  \param[in]      Task        Task to query.
 *
 *  \retval         TRUE  Task is an extended task.
 *  \retval         FALSE Task is not an extended task.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *  \pre            Given object pointer(s) are valid.
 *
 *  \trace          CREQ-20, CREQ-58
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE boolean, OS_CODE, OS_ALWAYS_INLINE, Os_TaskIsExtended,
(
  P2CONST(Os_TaskConfigType, AUTOMATIC, OS_CONST) Task
));
 ...
 *                  returned.
 *
 *  \param[in]      Task        The task id to test.
 *
 ...
 *                  returned.
 *
 *  \param[in]      Task        The task to test.
 *
 ...
 *
 *  \param[in,out]  Task        The task which shall be activated.
 *
 ...
 *  \details        --no details--
 *
 *  \param[in]      Scheduler     The scheduler to determine the next task.
 *  \param[in]      CallerThread  Reference to the current thread.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *  \details        --no details--
 *
 *  \param[in]      Task     The task to turn into the waiting state.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE for different Tasks
 ...
 *  \details        --no details--
 *
 *  \param[in]      Task     The waiting task.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *  \details        --no details--
 *
 *  \param[in]      InterruptedTask     The interrupted task.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in]      PreStartTask     Pointer to the pre-start task.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in]      Task        Task to query.
 *  \param[out]     State       Current state of a task.
 *
 ...
 *
 *  \param[in,out]  Task    The task which shall be initialized.
 ...
 *
 *  \param[in,out]  Task    The task which shall be terminated.
 *
 ...
 *
 *  \param[in]      Task        Task to query.
 *  \param[out]     State       The state of the task.
 *
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_TaskCallPreTaskHook, (void));
 ...
 *  \details        This function is called by the IdleTask, after OS initialization is done.
 *                  If there is a higher prio task is scheduled, a task switch is performed. Otherwise the function
 *                  returns.
 *
 ...
 *  \synchronous    TRUE
 *
 *  \pre            Called from idle task during StartOS.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE, Os_TaskBeginScheduling, (void));
 ...
 *                SPEC-63752, SPEC-64009, SPEC-63980
 **********************************************************************************************************************/
 ...
 *                SPEC-64349, SPEC-64351, SPEC-64362, SPEC-63804, SPEC-64017, SPEC-63709, SPEC-63752, SPEC-64009,
 *                SPEC-63980
 **********************************************************************************************************************/
