 ...
 *  \synchronous    TRUE
 *
 *  \pre            The given parameter is valid or NULL_PTR, if tracing is enabled.
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The given parameter is valid, if tracing is enabled.
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The given parameters are valid, if tracing is enabled.
 *  \pre            Interrupts disabled.
 *  \pre            Concurrent access to given objects is prevented by caller.
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The given object pointers are valid, if tracing is enabled.
 *  \pre            Interrupts disabled.
 *  \pre            Concurrent access to given objects is prevented by caller.
 *  \pre            Either Os_TraceThreadInitAndStart() or Os_TraceThreadInit() has been called before for both thread
 *                  parameters.
 ...
 *  \synchronous    TRUE
 *
 *  \pre            The given object pointers are valid, if tracing is enabled, if tracing is enabled.
 *  \pre            Interrupts disabled.
 *  \pre            Concurrent access to given objects is prevented by caller.
 *  \pre            Either Os_TraceThreadInitAndStart() or Os_TraceThreadInit() has been called before for both thread
 *                  parameters.
 ...
 *  \synchronous    TRUE
 *
 *  \pre            Given object pointer(s) are valid, if tracing is enabled.
 *  \pre            Interrupts disabled.
 ...
 *  \synchronous    TRUE
 *
 *  \pre            Given object pointer(s) are valid, if tracing is enabled, if tracing is enabled.
 *  \pre            Interrupts disabled.
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE void, OS_CODE, OS_ALWAYS_INLINE,
Os_TraceTaskSetEvent,
