 ...
 *
 *
 * \note Timing Protection: Spinlocks which are configured to acquire RES_SCHEDULER do currently not inform the
 *                          timing protection module. Consider: Introducing timing protection budgets for
 *                          waiting to get a Spinlock and holding a Spinlock.
 *
 *
 * \trace     CREQ-15
 * \trace     SPEC-63619
...
struct Os_SpinlockType_Tag
{
  ...
  /*!\note Change to pointer. On most platforms special alignment is needed for spinlock variables. */
 ...
 *
 *  \param[in]      LockList  The list of locks to init.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in,out]  Spinlock  Spinlock to initialize.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *  \details        --no details--
 *
 *  \param[in]      Spinlock  The spinlock to query.
 *
 ...
 *  \details        --no details--
 *
 *  \param[in]      SpinlockId  The id of the spinlock.
 *
 *  \return         The spinlock.
 *
 *  \context        OS_INTERNAL
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  Spinlock  The object to query.
 *
 *  \context        ANY
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in,out]  Spinlock  Spinlock to lock.
 *
 ...
 *  \pre            Given object pointer(s) are valid.
 *
 *  \note           SPEC-63980 Is not implemented because release sequence check does also detect this error.
 **********************************************************************************************************************/
 ...
 *
 *  \param[in,out]  Spinlock  Spinlock to lock.
 *  \param[out]     Success   The result of the lock attempt.
 *
 *  \retval         OS_STATUS_OK                No error.
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  Thread  Thread to release.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *
 *  \param[in,out]  Spinlock  The spinlock to lock.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *  \details        --no details--
 *
 *  \param[in,out]  Spinlock  The spinlock to be release.
 *
 *  \context        OS_INTERNAL
 *
 *  \reentrant      TRUE
 ...
 *                SPEC-63649, SPEC-63659, SPEC-63665, SPEC-63673, SPEC-63680, SPEC-63682, SPEC-63692, SPEC-63752,
 *                SPEC-63980
 **********************************************************************************************************************/
 ...
 *                SPEC-63683, SPEC-63686, SPEC-63629, SPEC-63642, SPEC-63752
 **********************************************************************************************************************/
 ...
 *                SPEC-63667, SPEC-63672, SPEC-63681, SPEC-63690, SPEC-63693, SPEC-63752, SPEC-63980
 **********************************************************************************************************************/
 ...
 *  Os_SpinlockIsLocked()
 **********************************************************************************************************************/
/*! \brief        Returns whether the given spinlock is locked (!0) or not (0).
 *  \details      --no details--
 *
 *  \param[in]    Spinlock  The spinlock to be release.
 *
 *  \retval       0   The given spinlock is unlocked.
 *  \retval       !0  The given spinlock is locked.
 *
 *  \context      OS_INTERNAL
 *
 *  \reentrant    TRUE
 ...
 **********************************************************************************************************************/
OS_FUNC_ATTRIBUTE_DECLARATION(OS_LOCAL_INLINE Os_StdReturnType, OS_CODE,
OS_ALWAYS_INLINE, Os_SpinlockIsLocked,
(
  P2CONST(Os_SpinlockConfigType, AUTOMATIC, OS_CONST) Spinlock
));
