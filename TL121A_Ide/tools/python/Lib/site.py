...
def addpackage(sitedir, name):
    ...
    while 1:
        ...
        if dir.startswith("import"):
            exec dir
            continue
	# [terry] Tue Nov 11 11:17:18 2008 To strip \r and \n off as Python 2.5
	# does. See MULTI-26884.
        #if dir[-1] == '\n':
        #    dir = dir[:-1]
	dir = dir.strip();
...
if sys.platform == 'win32':
    ...
    # [terry] Tue Mar 14 17:27:55 2006 The following "enc" checking is my
    # change. I saw Python failed to load "site", and the error is here.
