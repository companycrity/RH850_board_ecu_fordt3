...
language {
	...
	# by default.
	# autocomplete = false
	name += {"DebugServerSpecificOptions"}
	name += {"StopOnTaskCreation"}
	name += {"DebugNewlyCreatedTask"}
	name += {"DebugOnTaskExeption"}
	name += {"DebugOnBpHit"}
	name += {"HaltOnAttach"}
	name += {"RunOnDetach"}
	name += {"VisualizeFineGroup"}
    }
