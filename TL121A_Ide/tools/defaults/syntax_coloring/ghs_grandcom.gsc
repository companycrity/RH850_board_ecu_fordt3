...
language {
	...
	name = "GHS-GRANDCOM-FILE"
	description = "GHS Grandcom File"
	...
	# Don't treat "/", "\" and "." be separators, because they may
	# be used in file path.
	# Don't treat "-" as separator, because it is used in the file name for 
	# inclusion as below in val3/c/target/x86/assemble/_grandcm.gc:
	#    @unix-x64.s
	separator = "`\"+*<=>:,;\'\t()[]^%!~|& {}?"
