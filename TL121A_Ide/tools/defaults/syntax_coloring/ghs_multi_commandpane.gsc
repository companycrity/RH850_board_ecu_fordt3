...
language {
	...
	name = "GHS-MULTI-CommandPane"
	description = "MULTI Command Pane"
	...
	1 { lead = "\x01I/O:"; color = "#800000"}
	2 { lead = "\x01Target:"; color = "#008000" }
	3 { lead = "\x01Serial:"; color =  "#000080"}
