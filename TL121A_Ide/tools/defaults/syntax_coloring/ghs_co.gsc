...
# Inherit from GHS Placer language, especially its keywords.
%include "ghs_placer.gsc"
# Include GHS Placer Interpreter's keywords.
%include "ghs_placer_interpreter.gsc"
...
language {
	...
	name = "GHS-Connection-Organizer-GUI-Script"
	...
	# Script reserved word
	name += {"__BEGIN_INCLUDE__"}
	name += {"use"}
	name += {"__END_INCLUDE__"}
	name += {"__BEGIN_SCRIPT__"}
	name += {"sub"}
	name += {"__END_SCRIPT__"}
	name += {"__BEGIN_LEGACY_GUI__"}
	name += {"__END_LEGACY_GUI__"}
