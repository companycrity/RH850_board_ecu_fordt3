...
language {
    ...
    customized {
	pattern = {"EventExecutionDescription*"}
	pattern += {"StatusChangeExecutionDescription*"}
	pattern += {"StatusChangeExecutionDescription*"}
	pattern += {"ContextSwitchDescription*"}
	pattern += {"DomainPointerWriteDescription*"}
