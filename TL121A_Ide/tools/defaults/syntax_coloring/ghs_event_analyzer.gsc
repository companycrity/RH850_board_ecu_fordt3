...
language {
	...
	name = "GHS-Event-Analyzer"
	description = "GHS Event Analyzer"
	...
	#
	# Old keywords: to be depreciated
	# They are here for backward compatibility seak.
	#
	name = {"Task"}
	name += {"Status"}
	name += {"Event"}
	...
	name += {"max refreshed events"}	
	name += {"Max_Refreshed_Events"}
	name += {"Extra"}
	name += {"Overlap"}
	name += {"task prefix"}			
	name += {"Task_Term"}
	name += {"unused extra data warning"}	
	name += {"Unused_Extra_Data_Warning"}
	name += {"extra data warning"}		
	name += {"Extra_Data_Warning"}
	name += {"target timeout"}		
	name += {"Target_Timeout"}
	name += {"Sort_Field"}
	...
	name += {"MEV_OBJECT"}
	name += {"MEV_STATUS"}
	name += {"MEV_CONTEXT_SWITCH"}
	name += {"MEV_EXECUTION"}
	name += {"MEV_CONTEXT_SWITCH_LINK"}
	# Events
	name += {"MEV_EVENT_CATEGORY"}
	name += {"MEV_INTERVAL_SEARCH"}
	name += {"MEV_EVENT"}
	name += {"MEV_EXTRA"}
	name += {"MEV_VISIBLE"}
	name += {"MEV_INVISIBLE"}
	...
	name += {"MEV_DASH"}
	name += {"MEV_DASH_DOT"}
	name += {"MEV_DASH_DOT_DOT"}
	# Misc
	name += {"MEV_MISC"}
	name += {"MEV_REFRESH_INTERVAL"}
	name += {"MEV_SORT_FIELD"}
	name += {"MEV_OBJECT_NAME"}
	name += {"MEV_OBJECT_ID"}
	name += {"MEV_SORT_IN_ASCENDING_ORDER"}
	name += {"MEV_MAX_REFRESHED_EVENTS"}
	name += {"MEV_OVERLAP"}
	name += {"MEV_OBJECT_TERM"}
	name += {"MEV_UNUSED_EXTRA_DATA_WARNING"}
	name += {"MEV_EXTRA_DATA_WARNING"}
	name += {"MEV_TARGET_TIMEOUT"}
	name += {"MEV_ALL_FOR_INTERVAL_SEARCH"}
	name += {"MEV_OBJECT_HIERARCHY_SEPARATOR"}
	name += {"MEV_CENTER_STATUS"}
	name += {"MEV_TICK_PATTERN"}
	name += {"MEV_SHOW_HIDDEN_OBJECT_AGENT"}
	# Special values
	name += {"true"}
	name += {"false"}
