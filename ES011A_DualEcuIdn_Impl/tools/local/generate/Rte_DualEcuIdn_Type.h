 ...
 *
 *   Description:  Application types header file for SW-C <DualEcuIdn> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DUALECUIDN_TYPE_H
# define _RTE_DUALECUIDN_TYPE_H
