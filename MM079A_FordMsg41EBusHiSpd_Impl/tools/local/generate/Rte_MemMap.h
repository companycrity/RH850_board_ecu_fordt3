...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_START_SEC_MM079A_APPL_CODE)  ***********/

#ifdef RTE_START_SEC_MM079A_APPL_CODE
# undef RTE_START_SEC_MM079A_APPL_CODE /* PRQA S 0841 */ /* MD_MSR_19.6 */
# define START_SEC_CODE
#endif
...
#if 0
/***  Start of saved code (symbol: memory mapping implementation:RTE_STOP_SEC_MM079A_APPL_CODE)  ************/

#ifdef RTE_STOP_SEC_MM079A_APPL_CODE
# undef RTE_STOP_SEC_MM079A_APPL_CODE /* PRQA S 0841 */ /* MD_MSR_19.6 */
# define STOP_SEC_CODE
#endif
