 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CDD_GtmCfgAndUse_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <CDD_GtmCfgAndUse> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CDD_GTMCFGANDUSE_TYPE_H
# define _RTE_CDD_GTMCFGANDUSE_TYPE_H
...
#endif /* _RTE_CDD_GTMCFGANDUSE_TYPE_H */
