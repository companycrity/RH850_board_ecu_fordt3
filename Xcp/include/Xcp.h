...
/* Include the Transport Layer for Cdd if available. */
#if defined ( XCP_TRANSPORT_LAYER_TYPE_CDD )
  #include "CddXcp.h"
#endif
...
/* Definition of the API ID */
  ...
  #define XCP_MODIFYPROTECTIONSTATE_SERVICE_ID 20u
...
/* Definition of errors/exceptions */
  ...
  #define XCP_E_INVALID_CHANNEL                 5u
#endif
...
#define CRM_UPLOAD_MAX_SIZE                             ((uint8)(xcp[XCP_CHANNEL_IDX].Daq.xcpMaxCTO-1))
...
#define CRM_SHORT_UPLOAD_MAX_SIZE                       ((uint8)(xcp[XCP_CHANNEL_IDX].Daq.xcpMaxCTO-1))
...
#define CRO_DOWNLOAD_MAX_SIZE                           ((uint8)((xcp[XCP_CHANNEL_IDX].Daq.xcpMaxCTO-2)))
...
#define CRO_DOWNLOAD_NEXT_MAX_SIZE                      ((uint8)((xcp[XCP_CHANNEL_IDX].Daq.xcpMaxCTO-2)))
...
#define CRO_DOWNLOAD_MAX_MAX_SIZE                       ((uint8)(xcp[XCP_CHANNEL_IDX].Daq.xcpMaxCTO-1))
...
#define CRM_SHORT_DOWNLOAD_MAX_SIZE                     ((uint8)((xcp[XCP_CHANNEL_IDX].Daq.xcpMaxCTO-8)))
...
#define CRO_PROGRAM_MAX_SIZE                            ((uint8)((xcp[XCP_CHANNEL_IDX].Daq.xcpMaxCTO-2)))
...
#define CRO_PROGRAM_NEXT_MAX_SIZE                       ((uint8)((xcp[XCP_CHANNEL_IDX].Daq.xcpMaxCTO-2)))
...
#define CRO_PROGRAM_MAX_MAX_SIZE                        ((uint8)((xcp[XCP_CHANNEL_IDX].Daq.xcpMaxCTO-1)))
...
/***************************************************************************************************/
/* Macros for channel abstraction */
#if ( XCP_NUMBER_OF_CHANNELS > 1 )
  /* Definition of channel parameter. */
# define XCP_CHANNEL_SYSTEMTYPE_ONLY        uint8 Xcp_Channel
# define XCP_CHANNEL_SYSTEMTYPE_FIRST       uint8 Xcp_Channel,
# define XCP_CHANNEL_IDX                    Xcp_Channel
#else
/* PRQA S 3460 1 */ /*  MD_MSR_19.4 */
# define XCP_CHANNEL_SYSTEMTYPE_ONLY        void
# define XCP_CHANNEL_SYSTEMTYPE_FIRST
# define XCP_CHANNEL_IDX                    0u
#endif

#if defined ( XCP_ENABLE_SEND_EVENT ) || defined ( XCP_ENABLE_SERV_TEXT )
  #define EV_BYTE(x)            (xcp[XCP_CHANNEL_IDX].Ev.b[x]) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#endif
...
#define CRM_BYTE(x)             (xcp[XCP_CHANNEL_IDX].Crm.b[x]) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#define CRM_WORD(x)             (xcp[XCP_CHANNEL_IDX].Crm.w[x]) /* PRQA S 3453 */ /* MD_MSR_19.7 */
#define CRM_DWORD(x)            (xcp[XCP_CHANNEL_IDX].Crm.dw[x]) /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
*/
      ...
      #define XCP_MAX_ODT_ENTRY_SIZE (xcp[XCP_CHANNEL_IDX].Daq.xcpMaxDTO-2)
    #else
      #define XCP_MAX_ODT_ENTRY_SIZE (xcp[XCP_CHANNEL_IDX].Daq.xcpMaxDTO-1)
    #endif
  #endif
...
typedef uint16 SessionStatusType;
  ...
  #define DaqListOdtEntryCount(j) ((xcp[XCP_CHANNEL_IDX].pOdt[j].lastOdtEntry-xcp[XCP_CHANNEL_IDX].pOdt[j].firstOdtEntry)+1) /* PRQA S 3453 */ /* MD_MSR_19.7 */
  #define DaqListOdtLastEntry(j)  (xcp[XCP_CHANNEL_IDX].pOdt[j].lastOdtEntry) /* PRQA S 3453 */ /* MD_MSR_19.7 */
  #define DaqListOdtFirstEntry(j) (xcp[XCP_CHANNEL_IDX].pOdt[j].firstOdtEntry) /* PRQA S 3453 */ /* MD_MSR_19.7 */
  #define DaqListOdtStimBuffer(j) (xcp[XCP_CHANNEL_IDX].pOdt[j].StimBuffer) /* PRQA S 3453 */ /* MD_MSR_19.7 */

  /* n is absolute odtEntry number */
  #define OdtEntrySize(n)         (xcp[XCP_CHANNEL_IDX].pOdtEntrySize[n]) /* PRQA S 3453 */ /* MD_MSR_19.7 */
  #define OdtEntryAddr(n)         (xcp[XCP_CHANNEL_IDX].pOdtEntryAddr[n]) /* PRQA S 3453 */ /* MD_MSR_19.7 */
  #define OdtEntryExt(n)          (xcp[XCP_CHANNEL_IDX].pOdtEntryExt[n]) /* PRQA S 3453 */ /* MD_MSR_19.7 */

  /* i is daq number */
  #define DaqListOdtCount(i)      ((xcp[XCP_CHANNEL_IDX].Daq.u.DaqList[i].lastOdt-xcp[XCP_CHANNEL_IDX].Daq.u.DaqList[i].firstOdt)+1) /* PRQA S 3453 */ /* MD_MSR_19.7 */
  #define DaqListLastOdt(i)       xcp[XCP_CHANNEL_IDX].Daq.u.DaqList[i].lastOdt /* PRQA S 3453 */ /* MD_MSR_19.7 */
  #define DaqListFirstOdt(i)      xcp[XCP_CHANNEL_IDX].Daq.u.DaqList[i].firstOdt /* PRQA S 3453 */ /* MD_MSR_19.7 */
  #define DaqListFirstPid(i)      xcp[XCP_CHANNEL_IDX].Daq.u.DaqList[i].firstOdt /* PRQA S 3453 */ /* MD_MSR_19.7 */
  #define DaqListFlags(i)         xcp[XCP_CHANNEL_IDX].Daq.u.DaqList[i].flags /* PRQA S 3453 */ /* MD_MSR_19.7 */
  #define DaqListEventChannel(i)  xcp[XCP_CHANNEL_IDX].Daq.u.DaqList[i].eventChannel /* PRQA S 3453 */ /* MD_MSR_19.7 */
  #define DaqListPrescaler(i)     xcp[XCP_CHANNEL_IDX].Daq.u.DaqList[i].prescaler /* PRQA S 3453 */ /* MD_MSR_19.7 */
  #define DaqListCycle(i)         xcp[XCP_CHANNEL_IDX].Daq.u.DaqList[i].cycle /* PRQA S 3453 */ /* MD_MSR_19.7 */
...
typedef struct {
  ...
  uint8 ProtectionStatusInit;            /* Resource Protection Status Initialization Value */
#endif
...
extern FUNC(void, XCP_CODE) Xcp_Command( XCP_CHANNEL_SYSTEMTYPE_FIRST P2CONST(uint32, AUTOMATIC, XCP_APPL_DATA) pCommand );

/* Transmit Notification */
/* Confirmation of the transmit request by ApplXcpSend(). */
/* Returns 0 when the XCP driver is idle */
extern FUNC(uint8, XCP_CODE) Xcp_SendCallBack( uint8 Xcp_Channel );
...
extern FUNC(void, XCP_CODE) Xcp_Disconnect( uint8 Xcp_Channel );

/* Set size of transfer objects */
extern FUNC(void, XCP_CODE) Xcp_SetActiveTl( XCP_CHANNEL_SYSTEMTYPE_FIRST uint8 MaxCto, uint8 MaxDto, uint8 ActiveTl );
extern FUNC(uint8, XCP_CODE) Xcp_GetActiveTl( uint8 Xcp_Channel );

/* Send a pending XCP response packet (RES). */
/* To be used after a XCP_CMD_PENDING from EEPROM or FLASH programming. */
extern FUNC(void, XCP_CODE) Xcp_SendCrm( uint8 Xcp_Channel );

/* Send a XCP event (EV) or service request (SERV) message */ 
#if defined ( XCP_ENABLE_SEND_EVENT )
extern FUNC(void, XCP_CODE) Xcp_SendEvent( XCP_CHANNEL_SYSTEMTYPE_FIRST uint8 evc, ROMBYTEPTR c, uint8 len);
#endif
...
extern FUNC(void, XCP_CODE) Xcp_Putchar( XCP_CHANNEL_SYSTEMTYPE_FIRST CONST(uint8, AUTOMATIC) c );
    #if defined ( XCP_ENABLE_SERV_TEXT_PRINT )
extern FUNC(void, XCP_CODE) Xcp_Print( XCP_CHANNEL_SYSTEMTYPE_FIRST P2CONST(uint8, AUTOMATIC, XCP_APPL_DATA) str );
      #if defined ( XCP_ENABLE_SERV_TEXT_PRINTF )
extern FUNC(void, XCP_CODE) Xcp_Printf( XCP_CHANNEL_SYSTEMTYPE_FIRST P2CONST(uint8, AUTOMATIC, XCP_APPL_DATA) str, ... );
      #endif
    #endif
  #endif
#endif
...
/* Used only, if read protection of memory areas is required */
  ...
  #else
extern FUNC(uint8, XCP_CODE) XcpAppl_CalculateChecksum( XCP_CHANNEL_SYSTEMTYPE_FIRST ROMBYTEPTR pMemArea, BYTEPTR pRes, uint32 length );
  #endif
#endif
...
/* DAQ resume */
#if defined ( XCP_ENABLE_DAQ_RESUME )
  extern FUNC(void, XCP_CODE) XcpAppl_DaqResumeStore( XCP_CHANNEL_SYSTEMTYPE_FIRST P2CONST(tXcpDaq, AUTOMATIC, XCP_APPL_DATA) daq, uint16 size, uint8 measurementStart );
  extern FUNC(void, XCP_CODE) XcpAppl_DaqResumeClear( uint8 Xcp_Channel );
  extern FUNC(uint8, XCP_CODE) XcpAppl_CalResumeStore( uint8 Xcp_Channel );
  extern FUNC(uint8, XCP_CODE) XcpAppl_DaqResume( XCP_CHANNEL_SYSTEMTYPE_FIRST P2VAR(tXcpDaq, AUTOMATIC, XCP_APPL_DATA) daq );
#endif 
...
extern FUNC(uint8, XCP_CODE) XcpAppl_GetCalPage( XCP_CHANNEL_SYSTEMTYPE_FIRST uint8 segment, uint8 mode );
extern FUNC(uint8, XCP_CODE) XcpAppl_SetCalPage( XCP_CHANNEL_SYSTEMTYPE_FIRST uint8 segment, uint8 page, uint8 mode);

  #if defined ( XCP_ENABLE_PAGE_COPY )
extern FUNC(uint8, XCP_CODE) XcpAppl_CopyCalPage( XCP_CHANNEL_SYSTEMTYPE_FIRST uint8 srcSeg, uint8 srcPage, uint8 destSeg, uint8 destPage );
/* Returns:
   XCP_CMD_OK    
   XCP_CMD_PENDING - call Xcp_SendCrm when done
   XCP_CMD_ERROR 
...
/* Seed & Key */
#if defined ( XCP_ENABLE_SEED_KEY )
  extern FUNC(uint8, XCP_CODE) XcpAppl_GetSeed( XCP_CHANNEL_SYSTEMTYPE_FIRST const uint8 resource, P2VAR(uint8, AUTOMATIC, XCP_APPL_DATA) seed );
  extern FUNC(uint8, XCP_CODE) XcpAppl_Unlock( XCP_CHANNEL_SYSTEMTYPE_FIRST P2CONST(uint8, AUTOMATIC, XCP_APPL_DATA) key, const uint8 length );
  extern FUNC(uint8, XCP_CODE) Xcp_ModifyProtectionStatus( XCP_CHANNEL_SYSTEMTYPE_FIRST uint8 andState, uint8 orState );
#endif
...
*/
extern FUNC(uint8, XCP_CODE) XcpAppl_CheckWriteEEPROM( XCP_CHANNEL_SYSTEMTYPE_FIRST MTABYTEPTR addr, uint8 size, ROMBYTEPTR data );
#endif
...
*/
extern FUNC(uint8, XCP_CODE) XcpAppl_UserService( XCP_CHANNEL_SYSTEMTYPE_FIRST ROMBYTEPTR pCmd );
#endif
...
*/
extern FUNC(uint8, XCP_CODE) XcpAppl_OpenCmdIf( XCP_CHANNEL_SYSTEMTYPE_FIRST ROMBYTEPTR pCmd, BYTEPTR pRes, BYTEPTR pLength );
#endif
...
/* Get the session state of the XCP Protocol Layer */
  extern FUNC(SessionStatusType, XCP_CODE) Xcp_GetSessionStatus( uint8 Xcp_Channel );
#endif
...
/* PRQA S 3453 38 */ /* MD_MSR_19.7 */
/* PRQA S 3436 37 */ /* MD_MSR_3436 */
#if ( XCP_NUMBER_OF_CHANNELS > 1 )
#else
# define Xcp_Command( Xcp_Channel, pCommand )      Xcp_Command( pCommand )
# define Xcp_SetActiveTl( Xcp_Channel, MaxCto, MaxDto, ActiveTl ) Xcp_SetActiveTl( MaxCto, MaxDto, ActiveTl )
# define Xcp_SendEvent( Xcp_Channel, evc, c, len)  Xcp_SendEvent( evc, c, len)
# define Xcp_Putchar( Xcp_Channel, c )             Xcp_Putchar( c )
# define Xcp_Print( Xcp_Channel, str )             Xcp_Print( str )
#if defined ( XCP_ENABLE_SERV_TEXT_PRINTF )
/* PRQA S 1030 1 */ /* MD_Xcp_1030 */
# define Xcp_Printf( Xcp_Channel, str, ... )       Xcp_Printf( str, ... )
#endif
# define XcpAppl_CalculateChecksum( Xcp_Channel, pMemArea, pRes, length ) XcpAppl_CalculateChecksum( pMemArea, pRes, length )
# define XcpAppl_DaqResumeStore( Xcp_Channel, daq, size, measurementStart ) XcpAppl_DaqResumeStore( daq, size, measurementStart )
# define XcpAppl_DaqResume( Xcp_Channel, daq )     XcpAppl_DaqResume( daq )
# define XcpAppl_GetCalPage( Xcp_Channel, segment, mode ) XcpAppl_GetCalPage( segment, mode )
# define XcpAppl_SetCalPage( Xcp_Channel, segment, page, mode) XcpAppl_SetCalPage( segment, page, mode)
# define XcpAppl_CopyCalPage( Xcp_Channel, srcSeg, srcPage, destSeg, destPage ) XcpAppl_CopyCalPage( srcSeg, srcPage, destSeg, destPage )
# define XcpAppl_GetSeed( Xcp_Channel, resource, seed ) XcpAppl_GetSeed( resource, seed )
# define XcpAppl_Unlock( Xcp_Channel, key, length )  XcpAppl_Unlock( key, length )
# define Xcp_ModifyProtectionStatus( Xcp_Channel, andState, orState ) Xcp_ModifyProtectionStatus( andState, orState )
# define XcpAppl_CheckWriteEEPROM( Xcp_Channel, addr, size, data ) XcpAppl_CheckWriteEEPROM( addr, size, data )
# define XcpAppl_UserService( Xcp_Channel, pCmd )    XcpAppl_UserService( pCmd )
# define XcpAppl_OpenCmdIf( Xcp_Channel, pCmd, pRes, pLength ) XcpAppl_OpenCmdIf( pCmd, pRes, pLength )
#endif
