...
typedef struct
{
  P2FUNC(void, XCP_CODE, ApplXcpSend)( uint8 Xcp_Channel, uint8 len, P2CONST(uint8, AUTOMATIC, XCP_APPL_DATA) msg );
  P2FUNC(void, XCP_CODE, ApplXcpSendFlush)( uint8 Xcp_Channel, uint8 FlushType );
  #if defined ( XCP_ENABLE_TL_COMMAND )
  P2FUNC(uint8, XCP_CODE, ApplXcpTLService)( uint8 Xcp_Channel, P2CONST(uint8, AUTOMATIC, XCP_APPL_DATA) pCmd );
  #endif
} Xcp_TlApiType;
