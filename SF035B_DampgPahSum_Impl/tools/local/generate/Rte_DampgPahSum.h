 ...
 *
 *   Description:  Application header file for SW-C <DampgPahSum> (Contract Phase)
 *********************************************************************************************************************/
...
extern CONSTP2CONST(struct Rte_CDS_DampgPahSum, RTE_CONST, RTE_CONST) Rte_Inst_DampgPahSum; /* PRQA S 0850 */ /* MD_MSR_19.8 */

# define RTE_STOP_SEC_CONST_UNSPECIFIED
# include "MemMap.h" /* PRQA S 5087 */ /* MD_MSR_19.1 */

typedef P2CONST(struct Rte_CDS_DampgPahSum, TYPEDEF, RTE_CONST) Rte_Instance;
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_DampgPahSum_DampgCmdBas_Val(P2VAR(float32, AUTOMATIC, RTE_DAMPGPAHSUM_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_DampgPahSum_InertiaCmpVelCmd_Val(P2VAR(float32, AUTOMATIC, RTE_DAMPGPAHSUM_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Write_DampgPahSum_DampgCmd_Val(float32 data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
