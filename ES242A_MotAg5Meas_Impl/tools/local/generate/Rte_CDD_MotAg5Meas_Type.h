 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_CDD_MotAg5Meas_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <CDD_MotAg5Meas> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_CDD_MOTAG5MEAS_TYPE_H
# define _RTE_CDD_MOTAG5MEAS_TYPE_H
...
#endif /* _RTE_CDD_MOTAG5MEAS_TYPE_H */
