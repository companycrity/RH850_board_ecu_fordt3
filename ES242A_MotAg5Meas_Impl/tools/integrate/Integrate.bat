...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES242A_MotAg5Meas_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES242A_MotAg5Meas_Impl
...
XCOPY ..\..\autosar\MotAg5Meas_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
