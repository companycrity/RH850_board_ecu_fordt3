...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES224A_HwTq9Meas_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES224A_HwTq9Meas_Impl
...
XCOPY ..\..\autosar\HwTq9Meas_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
