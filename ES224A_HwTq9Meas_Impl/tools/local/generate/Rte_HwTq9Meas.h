...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_HwTq9Meas_GtmGetSent0Data_Oper(P2VAR(uint32, AUTOMATIC, RTE_HWTQ9MEAS_APPL_VAR) BufStrt_Arg); /* PRQA S 0850 */ /* MD_MSR_19.8 */
