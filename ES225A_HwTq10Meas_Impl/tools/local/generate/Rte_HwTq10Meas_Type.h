 ...
 *
 *   Description:  Application types header file for SW-C <HwTq10Meas> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_HWTQ10MEAS_TYPE_H
# define _RTE_HWTQ10MEAS_TYPE_H
