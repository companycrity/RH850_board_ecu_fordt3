...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES225A_HwTq10Meas_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES225A_HwTq10Meas_Impl
...
XCOPY ..\..\autosar\HwTq10Meas_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
