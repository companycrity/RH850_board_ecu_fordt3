...
* 04/17/18   2       TM(ISC)   Updated Diagnostic enabled conditions for missing NTC															EA4#20147
*----------------------------------------------------------------------------------------------------------------------
**********************************************************************************************************************/
...
#define FORDVEHOUTDAIRTMAX_DEGCGRD_F32				(86.5F)
#define FORDVEHOUTDAIRTMIN_DEGCGRD_F32				(-40.0F)
#define FORDVEHOUTDAIRTOFFS_DEGCGRD_F32				(40.0F)
#define FORDVEHOUTDAIRTRAWMAX_CNT_U16 				(255U)
#define FORDVEHOUTDAIRTRAWMIN_CNT_U16 				(0U)
#define FORDVEHOUTDAIRTRAWUNKNOWN_CNT_U16 			(254U)
#define FORDVEHOUTDAIRTSCAGFAC_DEGCGRDPERCNT_F32	(0.5F)
#define FORDVEHOUTDAIRT_DEGCGRD_F32					(86.5F)
#define MODSEL_CNT_U08								(1U)


/******************************************** Local Function Prototypes **********************************************/
static FUNC(boolean, FordMsg41ABusHiSpd_CODE) DiagEna(VAR(boolean,AUTOMATIC)FordCanDtcInhb_Cnt_T_logl,
													  VAR(uint8,AUTOMATIC)ClrDiagcFlgProxy_Cnt_T_u08,
													  P2VAR(boolean, AUTOMATIC, RTE_FORDMSG41ABUSHISPD_APPL_VAR)ClrDiagcFlgProxyEna_Cnt_T_logl
													  );

static FUNC(float32, FordMsg41ABusHiSpd_CODE)  MissMsgDtrm(VAR(boolean,AUTOMATIC)DiagEna_Cnt_T_logl,
                                                          VAR(boolean,AUTOMATIC)ClrDiagcFlgProxyEna_Cnt_T_logl,
														  VAR(uint16,AUTOMATIC)BusHiSpdMissThd_Cnt_T_u16,
                                                          P2VAR(uint16, AUTOMATIC, RTE_FORDMSG41ABUSHISPD_APPL_VAR)FordVehOutdAirTRaw_Cnt_T_u16);
static FUNC(float32, FordMsg41ABusHiSpd_CODE) MsgProcg(VAR(boolean,AUTOMATIC)DiagEna_Cnt_T_logl,
                                          VAR(boolean,AUTOMATIC)ClrDiagcFlgProxyEna_Cnt_T_logl,
                                          P2VAR(uint16, AUTOMATIC, RTE_FORDMSG41ABUSHISPD_APPL_VAR)FordVehOutdAirTRaw_Cnt_T_u16);														  
/**********************************************************************************************************************
 ...
 *********************************************************************************************************************/
*Rte_Pim_FordVehOutdAirTPrev() 		= FORDVEHOUTDAIRT_DEGCGRD_F32;
*Rte_Pim_FordVehOutdAirTRawPrev() 	= FORDVEHOUTDAIRTRAWUNKNOWN_CNT_U16;
 ...
 *********************************************************************************************************************/
 ...
 /* Local Variable Definition*/
	...
	VAR(uint8,AUTOMATIC)ClrDiagcFlgProxy_Cnt_T_u08;
 	...
 	VAR(uint16,AUTOMATIC) BusHiSpdMissThd_Cnt_T_u16;	
 	VAR(uint16,AUTOMATIC) FordVehOutdAirTRaw_Cnt_T_u16;
 		
	
	VAR(float32,AUTOMATIC) 	FordVehOutdAirT_DegCgrd_T_f32;	
...
{
	BusHiSpdMissThd_Cnt_T_u16 = Rte_Prm_FordMsg41ABusHiSpdMissMsgFaildThd_Val();
}				 
/*** End of CalSeln ***/	
 
 if(TRUE == *Rte_Pim_FordVehMsg41AMiss())
 {
	/*** Start of MissMsgDetermination ***/	
	FordVehOutdAirT_DegCgrd_T_f32 = MissMsgDtrm(DiagEna_Cnt_T_logl,ClrDiagcFlgProxyEna_Cnt_T_logl,BusHiSpdMissThd_Cnt_T_u16,&FordVehOutdAirTRaw_Cnt_T_u16);	
...
else
{
	...
	FordVehOutdAirT_DegCgrd_T_f32 =  MsgProcg(DiagEna_Cnt_T_logl,ClrDiagcFlgProxyEna_Cnt_T_logl,&FordVehOutdAirTRaw_Cnt_T_u16);
		
	/*** End of MsgProcessing ***/
}

FordVehOutdAirT_DegCgrd_T_f32 = Lim_f32(FordVehOutdAirT_DegCgrd_T_f32, FORDVEHOUTDAIRTMIN_DEGCGRD_F32, FORDVEHOUTDAIRTMAX_DEGCGRD_F32); 
*Rte_Pim_FordVehOutdAirTPrev() = FordVehOutdAirT_DegCgrd_T_f32;
FordVehOutdAirTRaw_Cnt_T_u16 = Lim_u16(FordVehOutdAirTRaw_Cnt_T_u16, FORDVEHOUTDAIRTRAWMIN_CNT_U16, FORDVEHOUTDAIRTRAWMAX_CNT_U16); 
*Rte_Pim_FordVehOutdAirTRawPrev() = FordVehOutdAirTRaw_Cnt_T_u16;
	
    /*Writing outputs to RTE*/
(void)Rte_Write_FordVehOutdAirT_Val(FordVehOutdAirT_DegCgrd_T_f32);
(void)Rte_Write_FordVehOutdAirTRaw_Val(FordVehOutdAirTRaw_Cnt_T_u16);
													  ...
													  )												  
{
    VAR(boolean,AUTOMATIC) DiagEna_Cnt_T_logl;
/*** Start of DiagEna ***/
    if (FordCanDtcInhb_Cnt_T_logl ==  TRUE)
	{
...
/*** End of DiagEna ***/
 ...
 /*****************************************************************************
  * Name            : MissMsgDtrm
  * Description     : Implementation of "MissMsgDtrm" subsystem in model.
  * Inputs          : DiagEna_Cnt_T_logl,                     
  *				      ClrDiagcFlgProxyEna_Cnt_T_logl. 
  *                   *FordVehOutdAirTRaw_Cnt_T_u16
  * Outputs         : None
  * Returns    	 	: 
  * Usage Notes     : NA.
*****************************************************************************/
...
if(TRUE == DiagEna_Cnt_T_logl)
	{	 
		...
		{
			(void)Rte_Call_SetNtcSts_Oper(NTCNR_0X19A, 0U, NTCSTS_FAILD, DEBSTEP_CNT_U16);
		}			
	}
	else
	{
		(void)Rte_Call_GetRefTmr100MicroSec32bit_Oper(Rte_Pim_MissMsgFaildRefTi());
		(void)Rte_Call_SetNtcSts_Oper(NTCNR_0X19A, 0U, NTCSTS_PASSD, DEBSTEP_CNT_U16);	
	}
	...
	FordVehOutdAirT_DegCgrd_T_f32 = *Rte_Pim_FordVehOutdAirTPrev();
	*FordVehOutdAirTRaw_Cnt_T_u16 = *Rte_Pim_FordVehOutdAirTRawPrev();
	(void)Rte_Call_GetRefTmr100MicroSec32bit_Oper(Rte_Pim_MissMsgPassdRefTi());	
return FordVehOutdAirT_DegCgrd_T_f32;
}		
...
{VAR(uint32,AUTOMATIC) TiSpan_Cnt_T_u32;
VAR(float32,AUTOMATIC) 	FordVehOutdAirT_DegCgrd_T_f32;
VAR(Ford_Outside_Air_Temp_Stat,AUTOMATIC) Ford_Outside_Air_Temp_Stat_Cnt_T_enum;
(void)Rte_Read_FordOutdAirTSts_Ford_Outside_Air_Temp_Stat(&Ford_Outside_Air_Temp_Stat_Cnt_T_enum);
	if(TRUE == DiagEna_Cnt_T_logl)
	{	 
		(void)Rte_Call_GetTiSpan100MicroSec32bit_Oper(*Rte_Pim_MissMsgPassdRefTi(),&TiSpan_Cnt_T_u32);
		if( TiSpan_Cnt_T_u32>((uint32) (Rte_Prm_FordMsg41ABusHiSpdMissMsgPassdThd_Val() *(uint32) CNVMILLISECTOCNT_CNTPERMILLISEC_U16)))
		{
			(void)Rte_Call_SetNtcSts_Oper(NTCNR_0X19A, 0U, NTCSTS_PASSD, DEBSTEP_CNT_U16);
		}			
	}
	...
	FordVehOutdAirT_DegCgrd_T_f32 = ((FixdToFloat_f32_u16(Ford_Outside_Air_Temp_Stat_Cnt_T_enum,NXTRFIXDPT_P0TOFLOAT_ULS_F32) * (FORDVEHOUTDAIRTSCAGFAC_DEGCGRDPERCNT_F32))- (FORDVEHOUTDAIRTOFFS_DEGCGRD_F32));
