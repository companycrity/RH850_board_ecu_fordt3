 ...
 *
 *   Description:  Application types header file for SW-C <ImcArbn> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_IMCARBN_TYPE_H
# define _RTE_IMCARBN_TYPE_H
