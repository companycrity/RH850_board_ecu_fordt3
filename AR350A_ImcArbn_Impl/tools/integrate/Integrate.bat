...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\AR350A_ImcArbn_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\AR350A_ImcArbn_Impl
...
XCOPY ..\..\autosar\ImcArbn_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
