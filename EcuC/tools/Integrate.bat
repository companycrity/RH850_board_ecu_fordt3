...
:CopyCommon
xcopy ..\autosar\EcuC_bswmd.arxml					%INTPJTDIR%\tools\SIP\Generators\Components\_Schemes\%SWC%\bswmd /s
xcopy ..\autosar\EcuC_preo_Rh850_GreenHills.arxml	%INTPJTDIR%\tools\SIP\Generators\Components\_Schemes\%SWC%\bswmd /s
