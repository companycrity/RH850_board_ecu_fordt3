...
SET INT_CONFIG_PATH=%INT_BASE_PATH%\tools\SIP\DaVinciConfigurator\Generators\ES229C_HwTqCorrln_Impl
SET INT_BSWMD_PATH=%INT_BASE_PATH%\tools\SIP\BSWMD\ES229C_HwTqCorrln_Impl
...
XCOPY ..\..\autosar\HwTqCorrln_bswmd.arxml %INT_BSWMD_PATH% /s /q
ECHO.
