 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg3D7BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg3D7BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG3D7BUSHISPD_TYPE_H
# define _RTE_FORDMSG3D7BUSHISPD_TYPE_H
...
# ifndef Cx0_Undetermined
#  define Cx0_Undetermined (0U)
# endif

# ifndef Cx1_Vehicle
#  define Cx1_Vehicle (1U)
# endif

# ifndef Cx2_Motorcycle
#  define Cx2_Motorcycle (2U)
# endif
...
# ifndef Cx6_Unclassified_Vehicle
#  define Cx6_Unclassified_Vehicle (6U)
# endif
...
# ifndef Cx8_NotUsed_2
#  define Cx8_NotUsed_2 (8U)
# endif

# ifndef Cx9_NotUsed_3
#  define Cx9_NotUsed_3 (9U)
# endif

# ifndef CxA_NotUsed_4
#  define CxA_NotUsed_4 (10U)
# endif

# ifndef CxB_NotUsed_5
#  define CxB_NotUsed_5 (11U)
# endif

# ifndef CxC_NotUsed_6
#  define CxC_NotUsed_6 (12U)
# endif

# ifndef CxD_NotUsed_7
#  define CxD_NotUsed_7 (13U)
# endif

# ifndef CxE_NotUsed_8
#  define CxE_NotUsed_8 (14U)
# endif

# ifndef CxF_NotUsed_9
#  define CxF_NotUsed_9 (15U)
# endif

# ifndef Cx7E_NoDataExists
#  define Cx7E_NoDataExists (126U)
# endif

# ifndef Cx7F_Faulty
#  define Cx7F_Faulty (127U)
# endif

# ifndef Cx0_NotDetermined
#  define Cx0_NotDetermined (0U)
# endif
...
# ifndef Cx1FE_NoDataExists
#  define Cx1FE_NoDataExists (510U)
# endif

# ifndef Cx1FF_Faulty
#  define Cx1FF_Faulty (511U)
# endif

# ifndef Cx3FE_NoDataExists
#  define Cx3FE_NoDataExists (1022U)
# endif
...
# ifndef Cx3_NotConfigured
#  define Cx3_NotConfigured (3U)
# endif
...
#endif /* _RTE_FORDMSG3D7BUSHISPD_TYPE_H */
