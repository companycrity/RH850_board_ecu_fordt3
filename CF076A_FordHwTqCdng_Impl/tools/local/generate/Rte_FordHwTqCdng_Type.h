 ...
 *
 *   Description:  Application types header file for SW-C <FordHwTqCdng> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDHWTQCDNG_TYPE_H
# define _RTE_FORDHWTQCDNG_TYPE_H
...
#endif /* _RTE_FORDHWTQCDNG_TYPE_H */
