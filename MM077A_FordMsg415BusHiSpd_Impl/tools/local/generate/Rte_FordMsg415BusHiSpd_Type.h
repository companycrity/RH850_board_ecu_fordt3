 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg415BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg415BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG415BUSHISPD_TYPE_H
# define _RTE_FORDMSG415BUSHISPD_TYPE_H
...
# ifndef Cx2_FaultExt
#  define Cx2_FaultExt (2U)
# endif

# ifndef Cx3_FaultDegraded
#  define Cx3_FaultDegraded (3U)
# endif
...
#endif /* _RTE_FORDMSG415BUSHISPD_TYPE_H */
