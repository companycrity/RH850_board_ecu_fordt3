...
#    error "The magic number of the generated file <C:/component/ES228C_HwTqArbn_Impl/tools/contract/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
