 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg213BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg213BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG213BUSHISPD_TYPE_H
# define _RTE_FORDMSG213BUSHISPD_TYPE_H
...
#endif /* _RTE_FORDMSG213BUSHISPD_TYPE_H */
