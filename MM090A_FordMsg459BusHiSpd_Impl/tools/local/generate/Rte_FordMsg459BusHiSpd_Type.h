 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg459BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg459BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG459BUSHISPD_TYPE_H
# define _RTE_FORDMSG459BUSHISPD_TYPE_H
...
# ifndef CxFF_Faulty
#  define CxFF_Faulty (255U)
# endif

# ifndef Cx7FF_Faulty
#  define Cx7FF_Faulty (2047U)
# endif

# ifndef Cx3FF_Faulty
#  define Cx3FF_Faulty (1023U)
# endif

# ifndef Cx0_NotTracking
#  define Cx0_NotTracking (0U)
# endif

# ifndef Cx1_Initializing
#  define Cx1_Initializing (1U)
# endif

# ifndef Cx2_DriveStraighRequested
#  define Cx2_DriveStraighRequested (2U)
# endif

# ifndef Cx3_TurnRequested
#  define Cx3_TurnRequested (3U)
# endif

# ifndef Cx4_TrackingLowConfidence
#  define Cx4_TrackingLowConfidence (4U)
# endif

# ifndef Cx5_TrackingMediumConfidence
#  define Cx5_TrackingMediumConfidence (5U)
# endif

# ifndef Cx6_TrackingHighConfidence
#  define Cx6_TrackingHighConfidence (6U)
# endif

# ifndef Cx7_TrackingUnknownConfidence
#  define Cx7_TrackingUnknownConfidence (7U)
# endif

# ifndef Cx8_TrackingLost
#  define Cx8_TrackingLost (8U)
# endif

# ifndef Cx9_IncorrectLighting
#  define Cx9_IncorrectLighting (9U)
# endif

# ifndef CxA_DirtyCamera
#  define CxA_DirtyCamera (10U)
# endif

# ifndef CxB_NotUsed_1
#  define CxB_NotUsed_1 (11U)
# endif

# ifndef CxC_NotUsed_2
#  define CxC_NotUsed_2 (12U)
# endif

# ifndef CxD_NotUsed_3
#  define CxD_NotUsed_3 (13U)
# endif

# ifndef CxE_NotUsed_4
#  define CxE_NotUsed_4 (14U)
# endif

# ifndef CxF_Faulty
#  define CxF_Faulty (15U)
# endif
...
# ifndef Cx2_TrailerReverseGuidanceLite
#  define Cx2_TrailerReverseGuidanceLite (2U)
# endif
...
# ifndef Cx1_TargetAcquired
#  define Cx1_TargetAcquired (1U)
# endif

# ifndef Cx2_TargetNotAcquired
#  define Cx2_TargetNotAcquired (2U)
# endif

# ifndef Cx3_Processing
#  define Cx3_Processing (3U)
# endif

# ifndef Cx4_RVCforTBA_Activated
#  define Cx4_RVCforTBA_Activated (4U)
# endif
...
#endif /* _RTE_FORDMSG459BUSHISPD_TYPE_H */
