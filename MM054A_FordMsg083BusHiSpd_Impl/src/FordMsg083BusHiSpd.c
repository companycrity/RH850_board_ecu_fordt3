 ...
 *
 *   Description:  C-Code implementation template for SW-C <FordMsg083BusHiSpd>
 *********************************************************************************************************************/
...
*
* Module File Name  : FordMsg083BusHiSpd.c
* Module Description: FordMsg083BusHiSpd.c - MM054A
* Project           : CBD
...
* 05/04/18   2       AJM       Changed FordVehTurnSigSwtStsRaw to uint8 type                                 EA4#23309
*----------------------------------------------------------------------------------------------------------------------
**********************************************************************************************************************/
 ...
 *
 * FordVehTurnSigSwtStsRaw
 *   Processed value of Vehcile Turn Signal Switch Status Raw which is used by EPS
 *
 * FordVehTurnSigVld
 *   This signal Check the validity of Ford Vehicle Turn Signal
 *
 * Ford_TurnLghtSwtch_D_Stat
 *   It is a message signal which is received from CAN bus which will be pocessed. Datatype: Ford_TurnLghtSwtch_D_Stat.Elements are: 0 - "Cx0_Off", 1 - "Cx1_Left", 2 - "Cx2_Right", 3 - "Cx3_Unused_Treat_As_Off'
 *
 ...
 *
 * FordVehTurnSigSwtStsRawPrev
 *   Previous value of Ford Vehicle Turn Signal Switch Status Raw
 *
 * FordVehTurnSigVldMissMsgRefTi
 *   Timer for misisng message will increment or reset based on the conditions
 *
 * FordVehTurnSigVldPrev
 *   Used to hold previous value of Ford Vehicle Turn Signal Valid
 *
 * FordVehTurnSigVldRefTi
 *   Timer to update Ford Vehicle Turn Signal Valid as true or false based on calibration threshold
 *
 * MissMsgFaildRefTi
 *   Timer for misisng message will increment or reset based on the message availabilty
 *
 * MissMsgPassdRefTi
 *   Timer for misisng message will increment or reset based on the message availabilty
 *
...
static FUNC(void, FordMsg083BusHiSpd_CODE) DiagEna(VAR(boolean, AUTOMATIC) FordLaneDetnWarnEnad_Cnt_T_logl,
                                                   VAR(boolean, AUTOMATIC) FordCanDtcInhb_Cnt_T_logl,
												   VAR(uint8, AUTOMATIC) ClrDiagcFlgProxy_Cnt_T_u08,
                                                   P2VAR(boolean, AUTOMATIC, RTE_FORDMSG083BUSHISPD_APPL_VAR) DiagEna_Cnt_T_logl,
                                                   P2VAR(boolean, AUTOMATIC, RTE_FORDMSG083BUSHISPD_APPL_VAR) ClrDiagcFlgProxyEna_Cnt_T_logl);
static FUNC(uint16, FordMsg083BusHiSpd_CODE) CalSeln(VAR(uint8, AUTOMATIC) FordEpsLifeCycMod_Cnt_T_u08);	
 
static FUNC(void, FordMsg083BusHiSpd_CODE) MsgMiss(VAR(uint16, AUTOMATIC) BusHiSpdMissThd_Cnt_T_u16,
												   VAR(boolean, AUTOMATIC) DiagEna_Cnt_T_logl,
                                                   VAR(boolean, AUTOMATIC) ClrDiagcFlgProxyEna_Cnt_T_logl,
                                                   P2VAR(boolean, AUTOMATIC, RTE_FORDMSG083BUSHISPD_APPL_VAR) FordVehTurnSigVld_Cnt_T_logl,
                                                   P2VAR(Ford_TurnLghtSwtch_D_Stat, AUTOMATIC, RTE_FORDMSG083BUSHISPD_APPL_VAR) FordVehTurnSigSwtStsRaw_Cnt_T_enum);
													
static FUNC(void, FordMsg083BusHiSpd_CODE) MsgPrsnt(VAR(boolean, AUTOMATIC) DiagEna_Cnt_T_logl,
                                                    VAR(boolean, AUTOMATIC) ClrDiagcFlgProxyEna_Cnt_T_logl);
													 
static FUNC(void, FordMsg083BusHiSpd_CODE) OutpProcg(VAR(Ford_TurnLghtSwtch_D_Stat, AUTOMATIC) Ford_TurnLghtSwtch_D_Stat_Cnt_T_enum,
												     P2VAR(boolean, AUTOMATIC, RTE_FORDMSG083BUSHISPD_APPL_VAR) FordVehTurnSigVld_Cnt_T_logl,
                                                     P2VAR(Ford_TurnLghtSwtch_D_Stat, AUTOMATIC, RTE_FORDMSG083BUSHISPD_APPL_VAR) FordVehTurnSigSwtStsRaw_Cnt_T_enum);													 
 ...
 * Enumeration Types:
 * ==================
 * Ford_TurnLghtSwtch_D_Stat: Enumeration of integer in interval [0...3] with enumerators
 *   Cx0_Off (0U)
 *   Cx1_Left (1U)
 *   Cx2_Right (2U)
 *   Cx3_Unused_Treat_As_Off (3U)
 ...
 * Symbol: FordMsg083BusHiSpdInit1_doc
 *********************************************************************************************************************/
 ...
 * Symbol: FordMsg083BusHiSpdInit1
 *********************************************************************************************************************/
...
*Rte_Pim_FordVehTurnSigVldRefTi() = GetRefTmr_Cnt_T_u32;
*Rte_Pim_FordVehTurnSigVldMissMsgRefTi() = GetRefTmr_Cnt_T_u32;
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of documentation area >>                  DO NOT CHANGE THIS COMMENT!
 * Symbol: FordMsg083BusHiSpdPer1_doc
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: FordMsg083BusHiSpdPer1
 *********************************************************************************************************************/
	VAR(boolean, AUTOMATIC) FordLaneDetnWarnEnad_Cnt_T_logl;
	VAR(boolean, AUTOMATIC) FordCanDtcInhb_Cnt_T_logl;
	VAR(boolean, AUTOMATIC) FordVehTurnSigVld_Cnt_T_logl;
	VAR(boolean, AUTOMATIC) DiagEna_Cnt_T_logl;
	VAR(boolean, AUTOMATIC) ClrDiagcFlgProxyEna_Cnt_T_logl;
	...
	VAR(Ford_TurnLghtSwtch_D_Stat, AUTOMATIC) Ford_TurnLghtSwtch_D_Stat_Cnt_T_enum;
	VAR(Ford_TurnLghtSwtch_D_Stat, AUTOMATIC) FordVehTurnSigSwtStsRaw_Cnt_T_enum;
	...
	(void) Rte_Read_Ford_TurnLghtSwtch_D_Stat_Ford_TurnLghtSwtch_D_Stat(&Ford_TurnLghtSwtch_D_Stat_Cnt_T_enum);
	...
	if(TRUE == *Rte_Pim_FordVehMsg083Miss())
	{
			/** Start of FordMsg083MsgMiss **/ 
				/** start of CalSeln **/ 
		BusHiSpdMissThd_Cnt_T_u16 = CalSeln(FordEpsLifeCycMod_Cnt_T_u08);
				/** End of CalSeln **/ 
		MsgMiss(BusHiSpdMissThd_Cnt_T_u16,
				DiagEna_Cnt_T_logl,
				ClrDiagcFlgProxyEna_Cnt_T_logl,
				&FordVehTurnSigVld_Cnt_T_logl,
				&FordVehTurnSigSwtStsRaw_Cnt_T_enum);	
			/** End of FordMsg083MsgMiss **/ 		
	}
	else
	{
			/** Start of FordMsg083MsgPrsnt **/ 
		MsgPrsnt(DiagEna_Cnt_T_logl,
				 ClrDiagcFlgProxyEna_Cnt_T_logl);
			/** Start of OutpProcg **/ 	
		OutpProcg(Ford_TurnLghtSwtch_D_Stat_Cnt_T_enum,
				  &FordVehTurnSigVld_Cnt_T_logl,
				  &FordVehTurnSigSwtStsRaw_Cnt_T_enum);	
			/** End of OutpProcg **/ 
			
			/** End of FordMsg083MsgPrsnt **/ 
	}
	 
	*Rte_Pim_FordVehTurnSigSwtStsRawPrev() =  FordVehTurnSigSwtStsRaw_Cnt_T_enum;
	*Rte_Pim_FordVehTurnSigVldPrev() =  FordVehTurnSigVld_Cnt_T_logl;
	  /*Writing outputs to RTE*/
	(void) Rte_Write_FordVehTurnSigSwtStsRaw_Val((uint8)FordVehTurnSigSwtStsRaw_Cnt_T_enum);
	(void) Rte_Write_FordVehTurnSigVld_Logl(FordVehTurnSigVld_Cnt_T_logl);
...
{
	if((TRUE == FordLaneDetnWarnEnad_Cnt_T_logl) &&
...
static FUNC(uint16, FordMsg083BusHiSpd_CODE) CalSeln(VAR(uint8, AUTOMATIC) FordEpsLifeCycMod_Cnt_T_u08)
{
	...
	{
		BusHiSpdMissThd_Cnt_T_u16 = Rte_Prm_FordMsg083BusHiSpdMissMsgFaildThd_Val();
	}
	return BusHiSpdMissThd_Cnt_T_u16;
}
/*****************************************************************************
  * Name            : MsgMiss
  * Description     : Implementation of MsgMiss subsystem in the model.
  * Inputs          : BusHiSpdMissThd_Cnt_T_u16,
  *                   DiagEna_Cnt_T_logl,
  *                   ClrDiagcFlgProxyEna_Cnt_T_logl,
  * Outputs         : *FordVehTurnSigVld_Cnt_T_logl, *FordVehTurnSigSwtStsRaw_Cnt_T_enum
  * Usage Notes     : NA.
*****************************************************************************/
static FUNC(void, FordMsg083BusHiSpd_CODE) MsgMiss(VAR(uint16, AUTOMATIC) BusHiSpdMissThd_Cnt_T_u16,
												   VAR(boolean, AUTOMATIC) DiagEna_Cnt_T_logl,
                                                   ...
                                                   P2VAR(Ford_TurnLghtSwtch_D_Stat, AUTOMATIC, RTE_FORDMSG083BUSHISPD_APPL_VAR) FordVehTurnSigSwtStsRaw_Cnt_T_enum)
{
	...
	*Rte_Pim_MissMsgPassdRefTi() = GetRefTmr_Cnt_T_u32;
	if(TRUE == DiagEna_Cnt_T_logl)
	{
        ...
        {
            (void) Rte_Call_SetNtcSts_Oper(NTCNR_0X116, 0U, NTCSTS_FAILD, DEBSTEP_CNT_U16);
	 	}
		else 
		{
			/* Do Nothing */ 
	...
	{
		/** Start of ResetTimers **/ 	
		(void) Rte_Call_GetRefTmr100MicroSec32bit_Oper(Rte_Pim_MissMsgFaildRefTi());
		(void) Rte_Call_SetNtcSts_Oper(NTCNR_0X116, 0U, NTCSTS_PASSD, DEBSTEP_CNT_U16);	
		/** End of ResetTimers **/ 					
	}
	...
	(void)Rte_Call_GetTiSpan100MicroSec32bit_Oper(*Rte_Pim_FordVehTurnSigVldMissMsgRefTi(),&TiSpan_Cnt_T_u32);
    if(TiSpan_Cnt_T_u32 > ((uint32)Rte_Prm_FordMsg083BusHiSpdVehTurnSigVldMissMsgThd_Val() * (uint32)CNVMILLISECTOCNT_CNTPERMILLISEC_U16))
    {
		/** Start of SetFail **/ 
		*FordVehTurnSigVld_Cnt_T_logl = FALSE;
		/** end of SetFail **/ 
	}
	else
	{
		/** Start of PreviousValue **/ 
		*FordVehTurnSigVld_Cnt_T_logl = *Rte_Pim_FordVehTurnSigVldPrev();
		/** End of PreviousValue **/ 
	}
	*FordVehTurnSigSwtStsRaw_Cnt_T_enum = *Rte_Pim_FordVehTurnSigSwtStsRawPrev();
}
/*****************************************************************************
  * Name            : MsgPrsnt
  * Description     : Implementation of MsgPrsnt subsystem in the model.
                                                    ...
                                                    VAR(boolean, AUTOMATIC) ClrDiagcFlgProxyEna_Cnt_T_logl)
{
	...
	*Rte_Pim_MissMsgFaildRefTi() = GetRefTmr_Cnt_T_u32;
	if(TRUE == DiagEna_Cnt_T_logl)
	{
        ...
        if(TiSpan_Cnt_T_u32 > ((uint32) Rte_Prm_FordMsg083BusHiSpdMissMsgPassdThd_Val() * (uint32)CNVMILLISECTOCNT_CNTPERMILLISEC_U16))
        {
            (void) Rte_Call_SetNtcSts_Oper(NTCNR_0X116, 0U, NTCSTS_PASSD, DEBSTEP_CNT_U16);
	 	}
		else
...
/*****************************************************************************
  * Name            : OutpProcg
  * Description     : Implementation of OutpProcg subsystem in the model.
  * Inputs          : Ford_TurnLghtSwtch_D_Stat_Cnt_T_enum
  * Outputs         : *FordVehTurnSigVld_Cnt_T_logl, FordVehTurnSigSwtStsRaw_Cnt_T_enum
  * Usage Notes     : NA.
*****************************************************************************/
...
{
	VAR(uint32, AUTOMATIC)  TiSpan_Cnt_T_u32;
	VAR(boolean, AUTOMATIC) VehTurnSigVld_Cnt_T_logl;

	/** Start of FordVehTurnSigSwtStsRawProcessing **/ 		
	*FordVehTurnSigSwtStsRaw_Cnt_T_enum = Ford_TurnLghtSwtch_D_Stat_Cnt_T_enum;
	/** End of FordVehTurnSigSwtStsRawProcessing **/ 
	
	/** Start of ElpdTi **/ 
	(void)Rte_Call_GetTiSpan100MicroSec32bit_Oper(*Rte_Pim_FordVehTurnSigVldRefTi(),&TiSpan_Cnt_T_u32);
	if(TiSpan_Cnt_T_u32 > ((uint32) Rte_Prm_FordMsg083BusHiSpdFordVehTurnSigVldThd_Val() * (uint32)CNVMILLISECTOCNT_CNTPERMILLISEC_U16))
	{
		VehTurnSigVld_Cnt_T_logl = TRUE;
	}
	else 	
	{
		VehTurnSigVld_Cnt_T_logl = FALSE;
	}
	/** End of ElpdTi **/
	...
	{
		/** Start of FrstTrans **/ 
		*FordVehTurnSigVld_Cnt_T_logl = TRUE;
		*Rte_Pim_FirstTranVldFlg() = FALSE;
		/** End of FrstTrans **/ 				
	}
	else
	{ 	
		if(TRUE == VehTurnSigVld_Cnt_T_logl)
		{
			/** Start of Vld **/ 	
			*FordVehTurnSigVld_Cnt_T_logl = TRUE;
			(void) Rte_Call_GetRefTmr100MicroSec32bit_Oper(Rte_Pim_FordVehTurnSigVldRefTi());
			/** End of Vld **/
		}
		else
		{
