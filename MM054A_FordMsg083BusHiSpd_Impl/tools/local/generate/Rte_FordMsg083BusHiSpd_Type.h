 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg083BusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg083BusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG083BUSHISPD_TYPE_H
# define _RTE_FORDMSG083BUSHISPD_TYPE_H
...
# ifndef Cx3_Unused_Treat_As_Off
#  define Cx3_Unused_Treat_As_Off (3U)
# endif
...
#endif /* _RTE_FORDMSG083BUSHISPD_TYPE_H */
