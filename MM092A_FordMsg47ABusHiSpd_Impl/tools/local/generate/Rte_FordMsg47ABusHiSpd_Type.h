 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_FordMsg47ABusHiSpd_Type.h
 ...
 *
 *   Description:  Application types header file for SW-C <FordMsg47ABusHiSpd> (Contract Phase)
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_FORDMSG47ABUSHISPD_TYPE_H
# define _RTE_FORDMSG47ABUSHISPD_TYPE_H
...
#endif /* _RTE_FORDMSG47ABUSHISPD_TYPE_H */
